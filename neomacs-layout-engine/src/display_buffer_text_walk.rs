...
use crate::display_buffer_text_render::{
    ...
    BufferInvisibleTextRenderRequestState, BufferSelectiveDisplayTailRenderOutcome,
    ...
    BufferTextWindowLoopRequestContext, BufferTextWindowRowPreludeRequestContext,
};
...
pub(crate) struct BufferTextWindowFinishInstallState<'a> {
    finish_state: BufferTextWindowFinishState<'a>,

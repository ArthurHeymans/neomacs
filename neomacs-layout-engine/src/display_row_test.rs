...
fn display_row_active_face_groups_resolved_measurement_metrics_and_colors() {
    ...
    assert_eq!(active.char_width(), 7.0);
    assert_eq!(active.row_height(), 15.0);
    assert_eq!(active.ascent(), 10.0);
    assert_eq!(active.space_width(), 7.0);
...
fn display_row_measured_face_exposes_face_identity() {
    ...
    assert_eq!(active.measurement_face().face_id(), 42);
}

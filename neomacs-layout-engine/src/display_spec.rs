...
use neovm_core::emacs_core::image_catalog::{
    AxisSize, ImageFaceColors, ImageResolveRequest, ImageResolveSource, ImageRotation,
...
impl DisplayImageLayout {
    pub(crate) fn into_resolve_request(
        ...
        ImageResolveRequest {
            ...
            face_colors: self.request.face_colors,
...
pub(crate) fn parse_display_image_layout(
    ...
    Some(DisplayImageLayout {
        request: UnresolvedDisplayImageRequest {
            ...
            rotation,
            face_colors: ImageFaceColors::new(fg_color, bg_color),
        },
        scale,
        ascent,
        margin,

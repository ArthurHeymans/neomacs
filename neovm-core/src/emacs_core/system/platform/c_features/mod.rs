...
pub(crate) fn gnu_c_features() -> [GnuCFeature; 30] {
    ...
    [
        GnuCFeature {
            ...
            here: Implemented {
                by: "neovm-core/src/emacs_core/runtime/threads/mod.rs -- real OS threads, \
        ...
        GnuCFeature {
            ...
            here: if cfg!(target_os = "linux") {
                Implemented {
                    by: "neovm-core/src/emacs_core/lisp/native/builtins/file_notify/notify_rs.rs -- \
        ...
        GnuCFeature {
            ...
            here: Implemented {
                by: "neovm-core/src/emacs_core/system/process/mod.rs -- real sockets, and \

...
/// `neovm-core/src/emacs_core/runtime/eval/mod.rs:5680-5699` and
...
/// here at `neovm-core/src/emacs_core/runtime/eval/mod.rs:5755` -- and
...
/// wearing a new hat: `neovm-core/src/emacs_core/lisp/load/mod.rs:4627-4637` derives it

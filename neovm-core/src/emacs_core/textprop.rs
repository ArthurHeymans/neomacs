...
/// Register this module's subrs. GNU: `syms_of_textprop` in `src/textprop.c`.
/// Extracted verbatim from the former flat `builtins::init_builtins`.
pub(crate) fn syms_of_textprop(ctx: &mut crate::emacs_core::eval::Context) {
    ctx.defsubr(
        "put-text-property",
    ...
    ctx.defsubr(
        ...
        crate::emacs_core::builtins::misc_eval::builtin_next_single_char_property_change,
        2,
        Some(4),
    );
    ctx.defsubr(
        "previous-single-char-property-change",
        crate::emacs_core::builtins::misc_eval::builtin_previous_single_char_property_change,
        0,
        None,
    );
    ctx.defsubr(
    ...
    ctx.defsubr(
        ...
        crate::emacs_core::builtins::misc_eval::builtin_next_char_property_change,
        1,
        Some(2),
    );
    ctx.defsubr(
        "previous-property-change",
        crate::emacs_core::builtins::misc_eval::builtin_previous_property_change,
        1,
        Some(3),
    );
    ctx.defsubr(
        "previous-char-property-change",
        crate::emacs_core::builtins::misc_eval::builtin_previous_char_property_change,
        1,
        Some(2),
    );
    ctx.defsubr(

...
/// Register this module's subrs. GNU: `syms_of_minibuf` in `src/minibuf.c`.
/// Extracted verbatim from the former flat `builtins::init_builtins`.
pub(crate) fn syms_of_minibuf(ctx: &mut crate::emacs_core::eval::Context) {
    ctx.defsubr(
    ...
    ctx.defsubr(
        ...
        |ctx, args| {
            crate::emacs_core::builtins::symbols::builtin_internal_complete_buffer(ctx, args)
        },
        3,
        Some(3),
    );
    ctx.defsubr(
        ...
        |ctx, args| crate::emacs_core::builtins::symbols::builtin_set_minibuffer_window(ctx, args),
        1,
        Some(1),
    );
    ctx.defsubr(

...
/// Register this module's subrs. GNU: `syms_of_fileio` in `src/fileio.c`.
/// Extracted verbatim from the former flat `builtins::init_builtins`.
pub(crate) fn syms_of_fileio(ctx: &mut crate::emacs_core::eval::Context) {
    ctx.defsubr(
        "insert-file-contents",
    ...
    ctx.defsubr(
        ...
        crate::emacs_core::builtins::symbols::builtin_make_temp_file_internal,
        4,
        Some(4),
    );
    ctx.defsubr(
        "recent-auto-save-p",
        crate::emacs_core::builtins::buffers::builtin_recent_auto_save_p,
        0,
        Some(0),
    );
    ctx.defsubr(
        "set-buffer-auto-saved",
        crate::emacs_core::builtins::buffers::builtin_set_buffer_auto_saved,
        0,
        Some(0),
    );
    ctx.defsubr(
        "unix-sync",
        |_ctx, args| crate::emacs_core::builtins::symbols::builtin_unix_sync(args),
        0,
        Some(0),
    );
    ctx.defsubr(
    ...
    ctx.defsubr(
        ...
        |_ctx, args| {
            crate::emacs_core::builtins::strings::builtin_clear_buffer_auto_save_failure(args)
        },
        0,
        None,
    );

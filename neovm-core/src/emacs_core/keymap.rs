...
/// Register this module's subrs. GNU: `syms_of_keymap` in `src/keymap.c`.
/// Extracted verbatim from the former flat `builtins::init_builtins`.
pub(crate) fn syms_of_keymap(ctx: &mut crate::emacs_core::eval::Context) {
    ctx.defsubr(
        "make-keymap",
        crate::emacs_core::builtins::keymaps::builtin_make_keymap,
        0,
        Some(1),
    );
    ctx.defsubr(
        "make-sparse-keymap",
        crate::emacs_core::builtins::keymaps::builtin_make_sparse_keymap,
        0,
        Some(1),
    );
    ctx.defsubr(
        "copy-keymap",
        crate::emacs_core::builtins::keymaps::builtin_copy_keymap,
        1,
        Some(1),
    );
    ctx.defsubr(
        "define-key",
        crate::emacs_core::builtins::keymaps::builtin_define_key,
        3,
        Some(4),
    );
    ctx.defsubr(
        "lookup-key",
        crate::emacs_core::builtins::keymaps::builtin_lookup_key,
        2,
        Some(3),
    );
    ctx.defsubr(
        "use-local-map",
        crate::emacs_core::builtins::keymaps::builtin_use_local_map,
        1,
        Some(1),
    );
    ctx.defsubr(
        "use-global-map",
        crate::emacs_core::builtins::keymaps::builtin_use_global_map,
        1,
        Some(1),
    );
    ctx.defsubr(
        "current-local-map",
        crate::emacs_core::builtins::keymaps::builtin_current_local_map,
        0,
        Some(0),
    );
    ctx.defsubr(
        "current-global-map",
        crate::emacs_core::builtins::keymaps::builtin_current_global_map,
        0,
        Some(0),
    );
    ctx.defsubr(
        "current-active-maps",
        crate::emacs_core::builtins::keymaps::builtin_current_active_maps,
        0,
        Some(2),
    );
    ctx.defsubr(
        "current-minor-mode-maps",
        crate::emacs_core::builtins::keymaps::builtin_current_minor_mode_maps,
        0,
        Some(0),
    );
    ctx.defsubr(
        "keymap-parent",
        crate::emacs_core::builtins::keymaps::builtin_keymap_parent,
        1,
        Some(1),
    );
    ctx.defsubr(
        "set-keymap-parent",
        crate::emacs_core::builtins::keymaps::builtin_set_keymap_parent,
        2,
        Some(2),
    );
    ctx.defsubr(
        "keymapp",
        crate::emacs_core::builtins::keymaps::builtin_keymapp,
        1,
        Some(1),
    );
    ctx.defsubr(
        "accessible-keymaps",
        crate::emacs_core::builtins::keymaps::builtin_accessible_keymaps,
        1,
        Some(2),
    );
    crate::emacs_core::builtins::register_builtin(
        ...
        crate::emacs_core::builtins::BuiltinRegistration::requires_eval_state(
            "map-keymap",
            crate::emacs_core::builtins::keymaps::builtin_map_keymap,
            2,
            Some(3),
        ),
    );
    crate::emacs_core::builtins::register_builtin(
        ...
        crate::emacs_core::builtins::BuiltinRegistration::requires_eval_state(
            "map-keymap-internal",
            crate::emacs_core::builtins::keymaps::builtin_map_keymap_internal,
            2,
            Some(2),
        ),
    );
    ...
    ctx.defsubr(
        ...
        |_ctx, args| crate::emacs_core::builtins::keymaps::builtin_single_key_description(args),
        1,
        Some(2),
    );
    ctx.defsubr(
        "key-description",
        |_ctx, args| crate::emacs_core::builtins::keymaps::builtin_key_description(args),
        1,
        Some(2),
    );
    ctx.defsubr(
        "text-char-description",
        |_ctx, args| crate::emacs_core::builtins::keymaps::builtin_text_char_description(args),
        1,
        Some(1),
    );
    crate::emacs_core::builtins::register_builtin(
        ...
        crate::emacs_core::builtins::BuiltinRegistration::requires_eval_state(
            ...
            crate::emacs_core::builtins::keymaps::builtin_describe_buffer_bindings,
            1,
            Some(3),
        ),
    );
    ctx.defsubr(
        "describe-vector",
        |ctx, args| crate::emacs_core::builtins::stubs::builtin_describe_vector(ctx, args),
        1,
        Some(2),
    );
    ctx.defsubr(
        "help--describe-vector",
        |_ctx, args| crate::emacs_core::builtins::stubs::builtin_help_describe_vector(args),
        7,
        Some(7),
    );
    ctx.defsubr(
        "keymap--get-keyelt",
        |_ctx, args| crate::emacs_core::builtins::symbols::builtin_keymap_get_keyelt(args),
        2,
        Some(2),
    );
    ctx.defsubr(
        "keymap-prompt",
        |_ctx, args| crate::emacs_core::builtins::symbols::builtin_keymap_prompt(args),
        1,
        Some(1),
    );
    ctx.defsubr(

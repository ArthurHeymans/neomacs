...
fn documentation_property_plan(
    ...
    match property_value {
        ...
        //
        // Apply the same `startup_doc_quote_style_*' conversion as
        // the legacy STUBS path so the result is correct in
        // contexts where `substitute-command-keys' (lisp/help.el)
        // isn't reachable. The legacy STUBS dispatch did the
        // grave/curly conversion inline for exactly this reason.
        //

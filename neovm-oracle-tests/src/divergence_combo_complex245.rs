//! Complex combo batch 245 — `fill-region` / `auto-fill-mode` /
//! `justify-region` / `center-line` / `center-region` / `fill-individual-
//! paragraphs` / `fill-column` / `fill-prefix` interactions.

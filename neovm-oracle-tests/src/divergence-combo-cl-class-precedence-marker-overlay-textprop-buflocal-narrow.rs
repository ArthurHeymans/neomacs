//! Combo: cl-class-precedence + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests class-precedence with buffer state.

use super::common::assert_oracle_parity;
use super::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_class_precedence_marker_overlay_textprop_buflocal_narrow_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    assert_oracle_parity(
        r#"(progn
  (let ((buf (generate-new-buffer "cpb")))
...
#[test]
fn combo_cl_class_precedence_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_class_precedence_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_class_precedence_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_class_precedence_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

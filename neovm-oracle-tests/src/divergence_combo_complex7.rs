...
"##,
        expect_test::expect![[r#""OK (225 226 227)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((228 184 173 230 150 135) (32 32) 2)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((99 97 102 233 164) t 5)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (6 (97 98 4194243 65 99 100) 7)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (t 16 16)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((226 130 172) (8364) (226 130 172) t)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (t (233) (233))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (5 6 6 11)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (bold underline underline nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (2 2 \"abcdXef\")""#]],
    );
}

//! Combo: cl-reinitialize-instance + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests reinitialize-instance with buffer state.

use super::common::assert_oracle_parity;
use super::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_reinitialize_instance_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_reinitialize_instance_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    crate::common::assert_oracle_parity_expect(
        r#"(progn
  (let ((buf (generate-new-buffer "ric")))
    (with-current-buffer buf
      (insert "AAAA-BBBB-CCCC-DDDD")
      (put-text-property 1 5 'z 'a)
      (put-text-property 6 10 'z 'b)
...
#[test]
fn combo_cl_reinitialize_instance_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_reinitialize_instance_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_reinitialize_instance_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

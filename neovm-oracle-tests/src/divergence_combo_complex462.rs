...
fn div_cx462_make_mutex_condvar() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (fboundp 'condition-wait))"##,
        expect_test::expect![[r#""OK (#<mutex test-mutex> void-function t t)""#]],
    );
}
...
fn div_cx462_thread_basic() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (condition-case e (thread-alive-p) (error (car e))))"##,
        expect_test::expect![[
            r#""OK (#<thread 0x555555ea5938> nil wrong-number-of-arguments void-function)""#
        ]],
    );
}
...
fn div_cx462_atomic_compare_and_swap() {
  ...
  (list (atomic-compare-and-swap x 0 42)
        ...
        x))"##,
        expect_test::expect![[r#""ERR (void-function atomic-compare-and-swap)""#]],
    );
}

...
"##,
        expect_test::expect![[r#""OK (\"1.1\" \"1.2\" \"1.10\" \"1.20\" \"2.0\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"def\" \"abcdef\" \"abc\")""#]],
    );
}
...
fn div_cx513_string_chop_newline_deep() {
  ...
  (list (string-chop-newline "hello\n")
        ...
        (string-chop-newline "hello")))
"##,
        expect_test::expect![[r#""OK (\"hello\" \"hello\\r\" \"hello\")""#]],
    );
}
...
fn div_cx513_string_limit_deep() {
  ...
  (list (string-limit "hello world" 5)
        ...
        (string-limit "abc" 10)))
"##,
        expect_test::expect![[r#""OK (\"hello\" \"world\" \"abc\")""#]],
    );
}

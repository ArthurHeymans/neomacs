...
"##,
        expect_test::expect![[r#""OK (2 -3 -3 2 3 -2 -2 3 2 -2 -2 2 2 -2 -2 2)""#]],
    )
}
...
(list (% 7 3) (% -7 3) (% 7 -3) (% -7 -3)
      ...
      (% 0 5) (mod 0 5))
"##,
        expect_test::expect![[r#""OK (1 -1 1 -1 1 2 -2 -1 0 0)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (4.0 1.4142135623730951 0.0 -0.0e+NaN -0.0e+NaN)""#]],
    )
}

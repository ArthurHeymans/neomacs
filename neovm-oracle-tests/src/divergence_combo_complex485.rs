...
"##,
        expect_test::expect![[r#""OK (\"aabbcc\" \"abc\" \"\\\\?bc\" \"xabc\")""#]],
    );
}
...
fn div_cx485_unicode_combining() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (length "a\u0301bc"))
"##,
        expect_test::expect![[r#""OK (3 4 0 4)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (2 2 1 4)""#]],
    );
}
...
fn div_cx485_unicode_control() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (string-width "\t\n\r"))
"##,
        expect_test::expect![[r#""OK (8 2 10)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"he…\" \"hello\" \"世\" \"abc\")""#]],
    );
}
...
fn div_cx485_assoc_deep() {
  ...
  (list (assoc 'b al)
        ...
        (rassoc 1 al)))
"##,
        expect_test::expect![[r#""OK ((b . 2) 2 2 (a . 1))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (wrong-type-argument sequencep #s(hash-table))""#]],
    );
}
...
fn div_cx485_cl_subseq() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (cl-subseq "hello" 1 4))
"##,
        expect_test::expect![[r#""OK ((2 3) [3 4] \"ell\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function map-vector)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (1 2 2 4 3 6)""#]],
    );
}

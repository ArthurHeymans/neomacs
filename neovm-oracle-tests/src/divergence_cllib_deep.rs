...
(list
  ...
  (cl-remove-duplicates '(1 2 3 2 1 4)))"#,
        expect_test::expect![[r#""OK ((1 3 5) (2 4 6) (3 2 1 4))""#]],
    );
}
...
(list
  ...
  (cl-position 'z '(a b c)))"#,
        expect_test::expect![[r#""OK (1 3 nil)""#]],
    );
}
...
(list
  ...
  (cl-replace (copy-sequence "abcdef") "XYZ" :start1 2))"#,
        expect_test::expect![[r#""OK (20 24 \"abXYZf\")""#]],
    );
}
...
(list
  ...
  (cl-destructuring-bind (&key x y) '(:x 10 :y 20)
    (list x y)))"#,
        expect_test::expect![[r#""OK ((1 2 (3 4 5)) (10 20))""#]],
    );
}
...
(list
  ...
  (cl-typep 42 'string))"#,
        expect_test::expect![[r#""OK (42 \"hello\" t t nil)""#]],
    );
}
...
(let ((alist '((a . 1) (b . 2) (c . 3))))
  (list (cl-assoc 'b alist)
        ...
        (cl-member 'b '(a b c))
        (cl-adjoin 'd '(a b c))))"#,
        expect_test::expect![[r#""OK ((b . 2) (c . 3) (b c) (d a b c))""#]],
    );
}

...
"##,
        expect_test::expect![[r#""OK (3 4 5 10)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (10 30 10)""#]],
    );
}
...
fn div_cx523_elt_vector() {
    ...
    crate::common::assert_oracle_parity_expect(
        r##"(list (elt [10 20 30] 0) (elt [10 20 30] 2) (elt [10 20 30] -1))
"##,
        expect_test::expect![[r#""ERR (args-out-of-range [10 20 30] -1)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (args-out-of-range \"abc\" -1)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"olleh\" \"a\" \"\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((3 2 1) (a) nil)""#]],
    );
}
...
fn div_cx523_sort_list() {
    ...
    crate::common::assert_oracle_parity_expect(
        r##"(sort '(3 1 4 1 5 9) #'<)
"##,
        expect_test::expect![[r#""OK (1 1 3 4 5 9)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((3 4) nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((1 2 3 4) (a b))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((b . 2) nil)""#]],
    );
}

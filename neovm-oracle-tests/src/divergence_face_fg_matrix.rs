...
fn div_face_fg_bold_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'bold-italic :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'border :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_button() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'button :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_defun() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defun :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_face() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-face :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_group() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-group :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_icon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-icon :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_macro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-macro :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_major_mode_name() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r##""OK \"#4ade80\"""##]],
    );
}
...
fn div_face_fg_elisp_rx() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-rx :foreground)",
        expect_test::expect![[r##""OK \"#5c9cff\"""##]],
    );
}
...
fn div_face_fg_elisp_slot() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-slot :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_theme() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-theme :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_thing() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-thing :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_type() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-type :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_elisp_unknown_call() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r##""OK \"#7fa9a9\"""##]],
    );
}
...
fn div_face_fg_fixed_pitch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'fixed-pitch :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_fringe() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'fringe :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_header_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'header-line :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_homoglyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'homoglyph :foreground)",
        expect_test::expect![[r#""OK \"cyan\"""#]],
    );
}
...
fn div_face_fg_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'italic :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_margin() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'margin :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'match :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_menu() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'menu :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_minibuffer_nonselected() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"dark red\"""#]],
    );
}
...
fn div_face_fg_mouse() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'mouse :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_next_error() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'next-error :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_region() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'region :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_separator_line() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"ForestGreen\"""#]],
    );
}
...
fn div_face_fg_tab_bar_tab() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-bar-tab :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_tab_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_underline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'underline :foreground)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_fg_window_divider() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"gray60\"""#]],
    );
}
...
fn div_face_fg_window_divider_first_pixel() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"gray80\"""#]],
    );
}
...
fn div_face_fg_window_divider_last_pixel() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"gray40\"""#]],
    );
}

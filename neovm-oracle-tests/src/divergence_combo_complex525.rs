...
"##,
        expect_test::expect![[r#""OK (#&3\"\u{5}\" #&3\"\u{2}\")""#]],
    );
}
...
fn div_cx525_bool_vector_difference() {
  ...
  c)
"##,
        expect_test::expect![[r#""ERR (void-function bool-vector-difference)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (#&5\"\u{1f}\" #&3\"\\0\" #&3\"\u{3}\")""#]],
    );
}
...
fn div_cx525_bool_vector_different_lengths() {
  ...
  (error (car e)))
"##,
        expect_test::expect![[r#""OK wrong-length-argument""#]],
    );
}

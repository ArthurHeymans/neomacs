...
fn bd_bidi_class_chars() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (L AL EN WS)""#]],
    );
}
...
fn divergence_bidi_paragraph_direction_rtl() {
  ...
  (list (current-bidi-paragraph-direction)
        ...
        expect_test::expect![[r#""OK (left-to-right right-to-left)""#]],
    );
}
...
fn bd_char_mirror() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (41 93 nil)""#]],
    );
}
...
fn bd_compose_region_auto() {
  ...
  (list (buffer-size) (char-after 1) (char-after 2)))"##,
        expect_test::expect![[r#""OK (2 101 769)""#]],
    );
}
...
fn bd_string_reverse_bidi() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"cba\" \"olléh\" \"dcba\" [3 2 1])""#]],
    );
}

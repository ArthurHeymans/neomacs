...
fn number_predicates() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (t nil t t t t nil t t t)""#]],
    );
}
...
fn round_truncate_modes() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (2 4 -2 2 -3 3 4 3 1 2)""#]],
    );
}
...
fn format_message_pct() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"50%\" \"A\" \"HI\" \"  5|5  |\" \"03.10\")""#]],
    );
}
...
fn read_float_syntax() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1.5 0.5 10000000000.0 -0.0015 1.0e+INF 2.5)""#]],
    );
}
...
fn read_radix_escapes() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (31 15 10 35 65 65 233)""#]],
    );
}
...
fn read_special_forms() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ('(1 . 2) `(a ,b) [1 2 3] #'car (1 2))""#]],
    );
}
...
fn read_symbols_odd() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"foo bar\" \\+1 t 1500.0 -0.0)""#]],
    );
}
...
fn divergence_read_trailing_dot_integer() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (eq (read "100.") 100))"##,
        expect_test::expect![[r#""OK (1 42 -7 t integer t)""#]],
    );
}

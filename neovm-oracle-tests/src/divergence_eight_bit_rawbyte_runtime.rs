...
fn byte_char_roundtrip() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (200 65 65 \"\\310\" 1)""#]],
    );
}
...
fn char_to_byte_edge() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (-1 unicode-bmp ascii unicode-bmp 65 4194248)""#]],
    );
}
...
fn decode_eightbit_keep() {
  ...
  (list (length d) (multibyte-string-p d)
        ...
        expect_test::expect![[r#""OK (3 t (ascii eight-bit ascii))""#]],
    );
}
...
fn eight_bit_in_buffer() {
  ...
  (list (buffer-size) (char-after 1) (char-charset (char-after 1))
        ...
        expect_test::expect![[r#""OK (2 4194248 eight-bit 4)""#]],
    );
}
...
fn max_char_min_char() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (4194303 1114111 t eight-bit unicode)""#]],
    );
}
...
fn string_to_unibyte_eightbit() {
  ...
  (list (length u) (append u nil) (string= u (unibyte-string 130 240))))"##,
        expect_test::expect![[r#""OK (2 (130 240) t)""#]],
    );
}

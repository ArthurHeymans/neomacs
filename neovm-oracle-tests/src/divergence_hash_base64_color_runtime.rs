...
fn hex_string_ops() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"ff\" 255 10 \"255\")""#]],
    );
}
...
fn char_displayable_props() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (t nil 4194303 t 65 4)""#]],
    );
}
...
fn subst_translate() {
  ...
  (list (subst-char-in-string ?l ?L "hello")
        ...
        expect_test::expect![[r#""OK (\"heLLo\" \"XYcXYc\")""#]],
    );
}
...
fn text_quoting() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"itXs\" \"<a><b><c>\" \"a_b_c\")""#]],
    );
}

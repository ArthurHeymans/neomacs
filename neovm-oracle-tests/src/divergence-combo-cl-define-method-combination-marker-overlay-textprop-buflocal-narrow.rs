//! Combo: cl-define-method-combination + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests define-method-combination with buffer state.

use super::common::assert_oracle_parity;
use super::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_define_method_combination_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_define_method_combination_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_define_method_combination_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_define_method_combination_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_define_method_combination_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

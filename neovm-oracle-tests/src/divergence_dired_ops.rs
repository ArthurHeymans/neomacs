...
macro_rules! diredt {
    ($name:ident, $body:expr) => {
        ...
        fn $name() {
            ...
            assert_oracle_parity($body);
        }
    };
}

diredt!(div_dired_open_bufname, r##"
(progn (require 'dired)
...
diredt!(div_dired_get_filename_at_point, r##"
(progn (require 'dired)
...
diredt!(div_dired_mark_get_marked_files, r##"
(progn (require 'dired)
...
diredt!(div_dired_mark_files_regexp, r##"
(progn (require 'dired)
...
diredt!(div_dired_toggle_marks, r##"
(progn (require 'dired)
...
diredt!(div_dired_map_over_marks, r##"
(progn (require 'dired)
...
diredt!(div_dired_rename_file, r##"
(progn (require 'dired)
...
diredt!(div_dired_listing_line_count, r##"
(progn (require 'dired)
...
diredt!(div_dired_buffers_for_dir, r##"
(progn (require 'dired)
...
diredt!(div_dired_subdir_alist, r##"
(progn (require 'dired)

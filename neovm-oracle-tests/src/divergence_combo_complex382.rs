...
"##,
        expect_test::expect![[r#""OK (nil neo-cx382-new nil)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (t t inner-a inner-b inner-c nil)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (nil neo-cx382-prefix neo-cx382-action-a)""#]],
    )
}

...
fn org_block_drawer_comment_structure_deep_state_combo() {
    ...
    let expect = expect_test::expect![[r##""OK ((org-data section keyword headline plain-text section planning property-drawer node-property node-property node-property drawer clock comment paragraph plain-text quote-block paragraph plain-text bold plain-text plain-text src-block example-block headline plain-text section planning paragraph plain-text latex-fragment plain-text center-block paragraph plain-text) ((quote-block nil nil 253) (src-block \"emacs-lisp\" \"(+ 1 2)\n\" 307) (example-block nil \"Example block.\n\" 364) (center-block nil nil 482)) ((property-drawer nil 75) (drawer \"LOGBOOK\" 141)) ((\"Effort\" \"2:00\") (\"CUSTOM_ID\" \"alpha-id\") (\"Owner\" \"Ada\")) ((\"<2026-05-27 Wed>\" nil nil) (nil nil \"[FIXED-ORG-TIME]\")) ((\"1:00\" closed)) (\"# This is a comment\n\") \"#+TITLE: Structure Probe\n\n* TODO Alpha :work:\nSCHEDULED: <2026-05-27 Wed>\n:PROPERTIES:\n:Effort: 2:00\n:CUSTOM_ID: alpha-id\n:Owner: Ada\n:END:\n:LOGBOOK:\nCLOCK: [FIXED-CLOCK] =>  1:00\n:END:\n# This is a comment\nAlpha body.\n\n#+begin_quote\nQuoted text with *markup*.\n#+end_quote\n\n#+begin_src emacs-lisp :results value\n(+ 1 2)\n#+end_src\n\n#+begin_example\nExample block.\n#+end_example\n\n** DONE Beta\nCLOSED: [FIXED-ORG-TIME]\nBeta body with $x^2$ math.\n\n#+begin_center\nCentered content.\n#+end_center\n\")""##]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (with-temp-buffer

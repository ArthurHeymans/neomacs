...
fn combo69_element_set_element_deep() {
  ...
  (let ((r '()))
    ...
    (nreverse r)))"##,
        expect_test::expect![[r#""ERR (void-variable tree)""#]],
    );
}
...
fn combo69_agenda_column_view() {
  ...
  (list
   ...
   :colview-fbound (fboundp 'org-agenda-colview-compute)
        ...
        expect_test::expect![[r#""OK (:column-view-fbound t :colview-fbound t)""#]],
    );
}
...
fn combo69_babel_prologue_epilogue_lisp() {
  ...
  (let ((org-confirm-babel-evaluate nil))
    ...
    (let ((r '()))
      ...
      (push (org-babel-execute-src-block) r)
      (nreverse r))))"##,
        expect_test::expect![[r#""ERR (void-variable test69-var)""#]],
    );
}
...
fn combo69_element_with_empty_post_blank() {
  ...
  (let ((r '()))
    ...
    (nreverse r)))"##,
        expect_test::expect![[r#""OK ((:post-blanks (0 0 0)) (:count 3))""#]],
    );
}

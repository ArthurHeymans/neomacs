//! Strong divergence-hunt-13 oracle tests — targeted at specific bugs.
//!
...
#[test]
fn dh13_parent_nesting_export_title() {
...
#[test]
fn dh13_parent_nesting_caption() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn dh13_drawer_parse_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
#[test]
fn dh13_minibuffer_insert_link() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn dh13_element_map_first_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn dh13_element_map_no_recurse() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
#[test]
fn dh13_headline_inline_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
#[test]
fn dh13_element_deferred_chain() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
#[test]
fn dh13_agenda_custom_keywords() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer

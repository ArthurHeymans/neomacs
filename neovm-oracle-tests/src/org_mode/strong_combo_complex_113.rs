...
fn combo113_org_latex_preview_toggle() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:preview-fbound)""#]],
    );
}
#[test]
fn combo113_org_list_indent_generic() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:indent-fbound)""#]],
    );
}
#[test]
...
fn combo113_org_plot_gnuplot_script() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:gnuplot-fbound)""#]],
    );
}
#[test]
...
fn combo113_org_refile_verify() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:verify-fbound)""#]],
    );
}
#[test]
fn combo113_org_src_preserve_indent() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:preserve-bound)""#]],
    );
}
#[test]
fn combo113_org_table_calc_formula_with_prefix() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:to-lisp)""#]],
    );
}
#[test]
fn combo113_org_timer_set_timer_time() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:set-fbound)""#]],
    );
}
#[test]

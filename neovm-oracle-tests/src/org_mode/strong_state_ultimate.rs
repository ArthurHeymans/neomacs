//! Strong state-ultimate oracle tests — ultimate mutable state capture.
//!
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: headline + todo + tags + priority after edit
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_headline_edit_all() {
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: property cycle
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_property_cycle() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: property inheritance
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_property_inherit() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: checkbox stats
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_checkbox_stats() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: element parse modify
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: export environment
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: link attributes
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: planning repeaters
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: timestamp repeater
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: block switches
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_block_switches() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: footnote markup
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_footnote_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: hierarchy contents
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: agenda entries
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_agenda_entries() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: colview format
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_colview_format() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: macro expansion
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_macro_expansion() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: entity replacement
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: structure template
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State ultimate: refile targets
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn su_refile_targets() {
    return_if_neovm_enable_oracle_proptest_not_set!();

...
fn combo109_org_protocol_client() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:loaded)""#]],
    );
}
#[test]
fn combo109_org_face_levels_check() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:l1)""#]],
    );
}
#[test]
fn combo109_org_bookmark_set() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:bm-fbound)""#]],
    );
}
#[test]
...
fn combo109_org_babel_shell_stdin() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:stdin-fbound)""#]],
    );
}
#[test]
fn combo109_org_todo_archive_done() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:done-heads)""#]],
    );
}
#[test]
fn combo109_org_agenda_file_list_check() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:files-bound)""#]],
    );
}
#[test]
fn combo109_org_babel_var_with_default() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (setting-constant nil)""#]],
    );
}
#[test]
fn combo109_org_align_tags_column() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:tags)""#]],
    );
}
#[test]

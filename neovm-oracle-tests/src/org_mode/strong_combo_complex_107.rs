...
fn combo107_org_entities_replace_in_string() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (:alpha-utf8 \"alpha\" :beta-utf8 \"beta\")""#]],
    );
}
#[test]
fn combo107_org_todo_cycle_with_region() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:all-done)""#]],
    );
}
#[test]
fn combo107_org_agenda_batch_entries() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:todos)""#]],
    );
}
#[test]
...
fn combo107_org_enum_list_positions() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:item-2-type)""#]],
    );
}
#[test]
fn combo107_org_indent_line() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:col)""#]],
    );
}
#[test]
fn combo107_org_footnote_normalize_flat() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:refs)""#]],
    );
}

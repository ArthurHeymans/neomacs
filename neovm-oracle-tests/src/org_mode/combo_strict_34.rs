...
fn strict_babel_ob_calc_comint() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (:calc ob-calc :comint ob-comint)""#]],
    );
}
#[test]
fn strict_toggle_fixed_width() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:fw-bound)""#]],
    );
}
#[test]
...
fn strict_property_empty_value_and_key() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:empty)""#]],
    );
}
#[test]
fn strict_timestamp_end_of_month() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function org-element-property:day-start)""#]],
    );
}
#[test]
...
fn strict_occur_by_todo() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:visible)""#]],
    );
}
#[test]
fn strict_export_latex_packages_list() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:packages-bound)""#]],
    );
}
#[test]

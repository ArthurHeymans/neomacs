...
fn strict_org_key_sequence() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:keys-fbound)""#]],
    );
}
#[test]
fn strict_org_latex_to_html() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:latex-fragment-fbound)""#]],
    );
}
#[test]
...
fn strict_org_refile_goto() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:goto-fbound)""#]],
    );
}
#[test]
fn strict_org_src_get_lang_mode() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:lang-mode-fbound)""#]],
    );
}
#[test]

...
fn combo111_org_archive_subtree_confirm() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:archive-fbound)""#]],
    );
}
#[test]
fn combo111_org_babel_strip_blank() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:trimmed)""#]],
    );
}
#[test]
fn combo111_org_capture_template_annotation() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:annot-fbound)""#]],
    );
}
#[test]
...
fn combo111_org_dblock_clocktable_compact() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:dblock-fbound)""#]],
    );
}
#[test]
...
fn combo111_org_export_include_file_minlevel() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:include-fbound)""#]],
    );
}
#[test]
...
fn combo111_org_habit_consistency_graph() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:graph-fbound)""#]],
    );
}
#[test]
fn combo111_org_id_locations_file() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:file-bound)""#]],
    );
}

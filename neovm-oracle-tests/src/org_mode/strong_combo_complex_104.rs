...
fn combo104_org_agenda_skip_timestamp() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:skip-fbound)""#]],
    );
}
#[test]
fn combo104_org_babel_insert_result_inline() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:insert-fbound)""#]],
    );
}
#[test]
...
fn combo104_org_babel_evaluate_lisp_params() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:result)""#]],
    );
}
#[test]
...
fn combo104_org_timestamp_extract_components() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:y)""#]],
    );
}

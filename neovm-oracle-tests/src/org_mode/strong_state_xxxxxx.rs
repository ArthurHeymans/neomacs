//! Strong state-xxxxxx oracle tests — extreme mutable state capture.
//!
...
#[test]
fn sxxxxxx_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)

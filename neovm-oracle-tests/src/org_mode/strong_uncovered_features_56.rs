...
fn uf56_formula_user() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function org-table-formula-to-user)""#]],
    );
}
...
fn uf56_formula_internal() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function org-table-formula-to-internal)""#]],
    );
}
...
fn uf56_table_range() {
  ...
  (list (org-table-get-range "1" "2")
        ...
        expect_test::expect![[r#""ERR (wrong-type-argument integer-or-marker-p \"2\")""#]],
    );
}
...
fn uf56_table_get() {
  ...
  (list (org-table-get "1" "2")
        (org-table-get "2" "3")))"##,
        expect_test::expect![[r#""ERR (wrong-type-argument number-or-marker-p \"1\")""#]],
    );
}
...
fn uf56_table_elem() {
  ...
  (list (org-table-get-elem 1 1)
        ...
        expect_test::expect![[r#""ERR (void-function org-table-get-elem)""#]],
    );
}

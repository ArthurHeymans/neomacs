...
fn org_id_cross_file_folded_context_store_open_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (((store-from-hidden nil) (store-from-visible nil) (link-type nil nil) (store-from-b \"[[file:<root>/b.org::*Refs][Refs]]\") (find-task-ccc t 162 \"<root>/a.org\") (find-proj t 1 \"<root>/a.org\")) \"\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (require 'org-id)
...
fn org_link_store_region_file_context_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (\"[[file:<file>::*Beta][Beta]]\" \"[[file:<file>::*Beta][Beta]]\" nil nil \"* Alpha\nBody one\n** Beta\nBody two\n\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (require 'ol)

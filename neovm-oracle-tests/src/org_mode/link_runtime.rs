...
fn org_id_cross_file_folded_context_store_open_combo() {
    ...
    let expect = expect_test::expect![[
        r##""OK (((store-from-hidden nil) (store-from-visible nil) (link-type nil nil) (store-from-b #(\"[[file:<root>/b.org::*Refs][Refs]]\" 22 26 (fontified nil) 28 32 (fontified nil))) (find-task-ccc t 162 \"<root>/a.org\") (find-proj t 1 \"<root>/a.org\")) \"\")""##
    ]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
...
fn org_link_id_custom_fuzzy_radio_runtime_combo() {
    ...
    let expect = expect_test::expect![[
        r##""OK (#(\"[[id:alpha-id][Alpha Target]]\" 15 27 (fontified nil)) (:link \"id:alpha-id\" :description #(\"Alpha Target\" 0 12 (fontified nil)) :type \"id\") ((link-0 206 link \"id\" \"alpha-id\" \"id:alpha-id\" org-link nil org-link) (link-1 232 link \"custom-id\" \"custom-beta\" \"#custom-beta\" org-link nil org-link) (link-2 262 link \"fuzzy\" \"*Plain Target\" \"*Plain Target\" org-link nil org-link) (link-3 293 link \"fuzzy\" \"radio target\" \"radio target\" org-link nil org-link) (raw-0 206 link \"id\" \"alpha-id\" \"id:alpha-id\" nil nil org-link) (raw-1 232 link \"custom-id\" \"custom-beta\" \"#custom-beta\" nil nil org-link) (raw-2 262 link \"fuzzy\" \"*Plain Target\" \"*Plain Target\" nil nil org-link) (raw-3 293 link \"fuzzy\" \"radio target\" \"radio target\" nil nil org-link)) ((\"Alpha ID\" #(\"Alpha Target\" 0 12 (fontified nil face org-level-1)) 21 \"* Alpha Target\") (\"Beta Custom\" #(\"Beta Target\" 0 11 (fontified nil face org-level-1)) 103 \"* Beta Target\") (\"Plain Fuzzy\" #(\"Plain Target\" 0 12 (fontified nil face org-level-1)) 171 \"* Plain Target\") (\"Radio Target\" #(\"Alpha Target\" 0 12 (fontified nil face org-level-1)) 99 \"Alpha body with <<radio target>>.\")) ((\"id\" \"alpha-id\" \"id:alpha-id\" \"Alpha ID\") (\"custom-id\" \"custom-beta\" \"#custom-beta\" \"Beta Custom\") (\"fuzzy\" \"*Plain Target\" \"*Plain Target\" \"Plain Fuzzy\") (\"fuzzy\" \"radio target\" \"radio target\" \"Radio Target\")) \"#+TITLE: Mixed Links\\n* Alpha Target\\n:PROPERTIES:\\n:ID: alpha-id\\n:END:\\nAlpha body with <<radio target>>.\\n* Beta Target\\n:PROPERTIES:\\n:CUSTOM_ID: custom-beta\\n:END:\\nBeta body.\\n* Plain Target\\nPlain body.\\n* Links\\n[[id:alpha-id][Alpha ID]] [[#custom-beta][Beta Custom]] [[*Plain Target][Plain Fuzzy]] [[radio target][Radio Target]]\\n\\n\" \"1 Alpha Target\\n==============\\n\\n  Alpha body with .\\n\\n\\n2 Beta Target\\n=============\\n\\n  Beta body.\\n\\n\\n3 Plain Target\\n==============\\n\\n  Plain body.\\n\\n\\n4 Links\\n=======\\n\\n  [Alpha ID] [Beta Custom] [Plain Fuzzy] [Radio Target]\\n\\n\\n[Alpha ID] See section 1\\n\\n[Beta Custom] See section 2\\n\\n[Plain Fuzzy] See section 3\\n\\n[Radio Target] See figure (1)\\n\")""##
    ]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
...
fn org_link_store_region_file_context_combo() {
    ...
    let expect = expect_test::expect![[
        r##""OK (#(\"[[file:<file>::*Beta][Beta]]\" 16 20 (fontified nil) 22 26 (fontified nil)) #(\"[[file:<file>::*Beta][Beta]]\" 16 20 (fontified nil) 22 26 (fontified nil)) nil nil \"* Alpha\\nBody one\\n** Beta\\nBody two\\n\")""##
    ]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
...
fn org_link_open_store_move_visibility_combo() {
    ...
    let expect = expect_test::expect![[
        r##""OK (#(\"[[id:alpha-id][Alpha]]\" 15 20 (fontified nil)) (:link \"id:alpha-id\" :description #(\"Alpha\" 0 5 (fontified nil)) :type \"id\") ((\"Alpha ID\" \"main.org\" #(\"Alpha\" 0 5 (fontified nil face org-level-1)) 2 nil \"* TODO Alpha :work:\") (\"Beta Custom\" \"main.org\" #(\"Beta\" 0 4 (fontified nil face org-level-1)) 13 nil \"* TODO Beta\") (\"Alpha Grand\" \"main.org\" #(\"Alpha grand\" 0 11 (fontified nil face org-level-3)) 10 t \"*** TODO Alpha grand\") (\"Radio\" \"main.org\" #(\"Alpha\" 0 5 (fontified nil face org-level-1)) 7 t \"Alpha body with <<radio-alpha>>.\") (\"Stored Alpha\" \"main.org\" #(\"Alpha\" 0 5 (fontified nil face org-level-1)) 2 nil \"* TODO Alpha :work:\") (\"External Heading\" \"other.org\" #(\"External\" 0 8 (fontified nil)) 1 nil \"* External\")) (#(\"Beta child\" 0 10 (fontified nil face org-level-2)) 19 2) (#(\"Beta child\" 0 10 (fontified nil face org-level-2)) 11 5 dedicated #(\"Beta child\" 0 10 (fontified nil face org-level-2))) ((\"Alpha\" 2 nil org-level-1) (\"Alpha child\" 8 t org-level-2) (\"Alpha grand\" 10 nil org-level-3) (\"Alpha L4\" 13 t org-level-4) (\"Beta child\" 11 nil org-level-2) (\"beta child body\" 12 nil nil) (\"Beta\" 11 nil org-level-2) (\"Links\" 21 t org-level-1)) ((\"id\" \"alpha-id\" \"id:alpha-id\" \"Stored Alpha\") (\"file\" \"other.org\" \"file:other.org::*External\" \"External Heading\") (\"id\" \"alpha-id\" \"id:alpha-id\" \"Alpha ID\") (\"custom-id\" \"beta-custom\" \"#beta-custom\" \"Beta Custom\") (\"fuzzy\" \"*Alpha grand\" \"*Alpha grand\" \"Alpha Grand\") (\"fuzzy\" \"radio-alpha\" \"radio-alpha\" \"Radio\")) \"#+TITLE: Link Move\\n* TODO Alpha :work:\\n:PROPERTIES:\\n:ID: alpha-id\\n:CUSTOM_ID: alpha-custom\\n:END:\\nAlpha body with <<radio-alpha>>.\\n** WAIT Alpha child\\nchild body\\n*** TODO Alpha grand\\n***** TODO Beta child\\nbeta child body\\n**** TODO Alpha L4\\nlevel four body\\n* TODO Beta\\n:PROPERTIES:\\n:ID: beta-id\\n:CUSTOM_ID: beta-custom\\n:END:\\nBeta body.\\n* Links\\n[[id:alpha-id][Stored Alpha]] [[file:other.org::*External][External Heading]]\\n[[id:alpha-id][Alpha ID]] [[#beta-custom][Beta Custom]]\\n[[*Alpha grand][Alpha Grand]] [[radio-alpha][Radio]]\\n\")""##
    ]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)

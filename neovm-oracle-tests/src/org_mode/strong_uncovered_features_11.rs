//! Strong uncovered-features-11 oracle tests — test features not yet tested.
//!
...
fn uf11_sparse() {
  ...
  (let ((v '()) (h '()))
    ...
    (list (nreverse v) (nreverse h))))"##,
        expect_test::expect![[r#""OK ((\"TODO A\" \"B\" \"TODO C\") nil)""#]],
    );
}

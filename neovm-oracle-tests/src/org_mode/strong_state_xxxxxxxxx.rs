//! Strong state-xxxxxxxxx oracle tests — extreme mutable state capture.
//!
...
#[test]
fn sxxxxxxxxx_headline_edit_all() {
...
#[test]
fn sxxxxxxxxx_property_inherit() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn sxxxxxxxxx_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn sxxxxxxxxx_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn sxxxxxxxxx_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn sxxxxxxxxx_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn sxxxxxxxxx_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn sxxxxxxxxx_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)

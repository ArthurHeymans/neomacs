//! Strong edge-deep-7 oracle tests — boundary conditions.
//!
...
#[test]
fn ed7_empty_buffer_meta_return() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed7_deep_nesting_promote_demote() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed7_timestamp_inactive_time() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed7_block_multiple_languages() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
#[test]
fn ed7_drawer_multiple_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed7_visibility_single_heading() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ed7_structure_template_various() {
    return_if_neovm_enable_oracle_proptest_not_set!();

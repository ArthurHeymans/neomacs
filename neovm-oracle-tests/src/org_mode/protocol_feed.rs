...
fn org_feed_raw_inbox_headers_error_combo() {
    ...
    let expect = expect_test::expect![[
        r##""OK ((\"feeds.org\" #(\"Incoming\" 0 8 (fontified nil)) 6) (\" *raw-feed*\" 1 \"<?xml version=\\\"1.0\\\"?><rss><channel><item><guid>raw-1</g\" nil 2) (\" *raw-feed*\" 1 t 2) (error \"mock missing feed\") (error \"No such feed in ‘org-feed-alist\") 2 (((\"raw-1\" t \"ff0cfc66f33d573c9755c0a31137d02487b4ffbd\") (\"raw-2\" t \"a4c1b482714c008187093767e9057736f899cdc1\")) ((headline \"Existing\" nil nil 20 38) (headline \"Incoming\" nil nil 38 365) (drawer nil nil nil 51 186) (headline \"Raw Two\" nil nil 186 276) (node-property nil \"GUID\" \"raw-2\" 215 228) (link nil nil nil 264 273) (headline \"Raw One\" nil nil 276 365) (node-property nil \"GUID\" \"raw-1\" 305 318) (link nil nil nil 354 363)) \"#+TITLE: Raw Feeds\n* Existing\nBody\n\n\n* Incoming\n\n\n  :RAWSTATUS:\n((\\\"raw-1\\\" t \\\"ff0cfc66f33d573c9755c0a31137d02487b4ffbd\\\")\n (\\\"raw-2\\\" t \\\"a4c1b482714c008187093767e9057736f899cdc1\\\"))\n  :END:\n** TODO Raw Two\n:PROPERTIES:\n:GUID: raw-2\n:END:\n[2026-06-15 Mon]\nRaw body two\n[[raw-2]]\n\n\n** TODO Raw One\n:PROPERTIES:\n:GUID: raw-1\n:END:\n[2026-06-15 Mon]\nRaw body one\n[[raw-1]]\n\n\") ((retrieve \"mock://raw\") (retrieve \"mock://raw\") (retrieve \"mock://missing\") (retrieve \"mock://raw\")) (\"Clipboard pasted as level 2 subtree\" \"Clipboard pasted as level 2 subtree\" #(\"Position saved to mark ring, go back with ‘C-c &’.\" 43 48 (font-lock-face help-key-binding face help-key-binding)) \"Added 2 new items from feed Raw to file feeds.org, heading Incoming\"))""##
    ]];
    crate::common::assert_oracle_parity_frozen_time_expect(
        r##"(progn
  (require 'org)

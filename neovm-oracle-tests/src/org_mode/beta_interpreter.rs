...
fn beta_interpret_babel_call() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      (insert "#+CALL: test()")
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r##""OK \"#+call: test()\n\"""##]],
    );
}
...
fn beta_interpret_comment() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      (insert "# Comment")
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r##""OK \"# Comment\n\"""##]],
    );
}
...
fn beta_interpret_keyword() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r##""OK \"#+keyword: value\n\"""##]],
    );
}
...
fn beta_interpret_citation() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      (insert "[cite:@key]")
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"[cite:@key]\n\"""#]],
    );
}
...
fn beta_interpret_export_snippet() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"@@backend:contents@@\n\"""#]],
    );
}
...
fn beta_interpret_inline_babel_call() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      (insert "call_test()")
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"call_test()\n\"""#]],
    );
}
...
fn beta_interpret_inline_babel_call_args() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"call_test(x=2)\n\"""#]],
    );
}
...
fn beta_interpret_inline_src_block() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"src_emacs-lisp{(+ 1 1)}\n\"""#]],
    );
}
...
fn beta_interpret_latex_fragment_command() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      (insert "\\command{}")
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"\\\\command{}\n\"""#]],
    );
}
...
fn beta_interpret_link_file() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"[[file:todo.org::*task]]\n\"""#]],
    );
}
...
fn beta_interpret_link_id() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      (insert "[[id:aaaa]]")
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"[[id:aaaa]]\n\"""#]],
    );
}
...
fn beta_interpret_macro_with_args() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"{{{test(arg1,arg2)}}}\n\"""#]],
    );
}
...
fn beta_interpret_timestamp_active() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"<2012-03-29 Thu 16:40>\n\"""#]],
    );
}
...
fn beta_interpret_timestamp_active_timerange() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"<2012-03-29 Thu 16:40-16:41>\n\"""#]],
    );
}
...
fn beta_interpret_timestamp_diary() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"<%%(diary-float t 4 2)>\n\"""#]],
    );
}
...
fn beta_interpret_timestamp_diary_time() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"<%%(diary-float t 4 2) 12:00>\n\"""#]],
    );
}
...
fn beta_interpret_timestamp_repeater() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"<2012-03-29 Thu +1y>\n\"""#]],
    );
}
...
fn beta_interpret_timestamp_repeater_warning() {
  ...
  (let ((org-mode-hook nil))
    (with-temp-buffer (org-mode)
      ...
      (org-element-interpret-data (org-element-parse-buffer)))))"##,
        expect_test::expect![[r#""OK \"<2012-03-29 Thu +1y -1y>\n\"""#]],
    );
}

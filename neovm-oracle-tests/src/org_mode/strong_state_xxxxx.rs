//! Strong state-xxxxx oracle tests — extreme mutable state capture.
//!
...
#[test]
fn sxxxxx_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();

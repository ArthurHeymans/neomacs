//! Strong edge-combos-3 oracle tests — edge case combinations.
//!
...
#[test]
fn ec3_empty_buffer_meta_return() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ec3_deep_nesting_promote_demote() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ec3_timestamp_active_inactive() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn ec3_structure_template_various() {
    return_if_neovm_enable_oracle_proptest_not_set!();

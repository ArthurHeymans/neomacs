...
fn strict_org_entities_help_format() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (:help-fbound t :total 436)""#]],
    );
}
#[test]
...
fn strict_org_plot_script_generation() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:script-fbound)""#]],
    );
}
#[test]
fn strict_org_table_tab_first_hook() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:tab-first-hook-bound)""#]],
    );
}
#[test]
fn strict_org_list_search_text() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:at-item)""#]],
    );
}
#[test]
fn strict_org_export_title_date_author() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:title)""#]],
    );
}
#[test]
fn strict_org_babel_execute_results_wrap() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:result-count)""#]],
    );
}
#[test]
fn strict_org_block_indent_mode() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:indent-bound)""#]],
    );
}

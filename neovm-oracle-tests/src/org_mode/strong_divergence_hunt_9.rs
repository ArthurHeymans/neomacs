//! Strong divergence-hunt-9 oracle tests — targeted at specific bugs.
//!
...
#[test]
fn dh9_parent_nesting_export_title() {
...
#[test]
fn dh9_drawer_parse_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
  (org-mode)
  ...
  (let ((c0 (org-clocking-p)))
    ...
    (let ((c1 (org-clocking-p)))
      ...
      (let ((c2 (org-clocking-p)))
        (list c0 c1 c2)))))"##,
        expect_test::expect![[r#""ERR (void-function org-clocking-p)""#]],
    );
}
...
#[test]
fn dh9_element_map_first_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
  (org-mode)

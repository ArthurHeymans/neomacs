//! Strong edge-case combo oracle tests — boundary conditions.
//!
...
#[test]
fn strong_empty_buffer_insert_heading() {
...
#[test]
fn strong_deeply_nested_headlines() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
        r#""OK ((1 \"L1\") (2 \"L2\") (3 \"L3\") (4 \"L4\") (5 \"L5\") (6 \"L6\") (7 \"L7\") (8 \"L8\"))""#
    ]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
  (org-mode)
  ...
  (let ((levels '()))
    (while (not (eobp))
      (when (org-at-heading-p)
        (push (list (org-current-level) (org-get-heading t t t t)) levels))
      (forward-line))
    (nreverse levels)))"##,
        expect,
    );
...
#[test]
fn strong_deeply_nested_promote_demote() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_special_chars_in_headline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_special_chars_in_link() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
#[test]
fn strong_unicode_in_headlines() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
#[test]
fn strong_unicode_in_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK (\"值\" \"名前\" \"新しい値\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
  (org-mode)
  (insert "* Test\n:PROPERTIES:\n:VAR: 值\n:NAME: 名前\n:END:")
...
#[test]
fn strong_list_mixed_types_inline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_footnote_inline_definition() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_footnote_empty_definition() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_timestamp_inactive_with_time() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_link_with_angle_brackets() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_element_at_buffer_start() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn strong_element_at_buffer_end() {
    return_if_neovm_enable_oracle_proptest_not_set!();

//! Strong state-advanced oracle tests — advanced mutable state capture.
//!
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: headline + todo + tags + priority after edit
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_headline_edit_all() {
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: property cycle
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_property_cycle() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: property inheritance
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_property_inherit() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: checkbox stats
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_checkbox_stats() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: element parse modify
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: export environment
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: link attributes
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: planning repeaters
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: timestamp repeater
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: block switches
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_block_switches() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: footnote markup
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_footnote_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: hierarchy contents
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: agenda entries
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_agenda_entries() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: colview format
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_colview_format() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: macro expansion
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_macro_expansion() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: entity replacement
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: structure template
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State advanced: refile targets
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sa_refile_targets() {
    return_if_neovm_enable_oracle_proptest_not_set!();

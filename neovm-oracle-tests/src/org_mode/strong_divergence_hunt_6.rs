//! Strong divergence-hunt-6 oracle tests — targeted at specific bugs.
//!
...
#[test]
fn dh6_parent_nesting_export_title() {
...
#[test]
fn dh6_drawer_parse_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn dh6_element_map_first_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    assert_oracle_parity(
        r##"(with-temp-buffer
  (org-mode)

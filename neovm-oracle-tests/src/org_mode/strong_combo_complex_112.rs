...
fn combo112_org_agenda_remove_restriction() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:remove-fbound)""#]],
    );
}
#[test]
fn combo112_org_babel_local_file() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:local-fbound)""#]],
    );
}
#[test]
fn combo112_org_capture_clock() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:clock-fbound)""#]],
    );
}
#[test]
fn combo112_org_clock_resolve_idle() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:resolve-fbound)""#]],
    );
}
#[test]
fn combo112_org_dblock_update_clocktable_full() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:ok)""#]],
    );
}
#[test]
fn combo112_org_element_interpret_link() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"[[/tmp/test.org]]\")""#]],
    );
}
#[test]
...
fn combo112_org_footnote_normalize_inline() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function org-element-property:label)""#]],
    );
}
#[test]
fn combo112_org_habit_momentum() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:build-fbound)""#]],
    );
}
#[test]
fn combo112_org_id_update_location() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:add-fbound)""#]],
    );
}

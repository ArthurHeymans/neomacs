//! Strong divergence-hunt-4 oracle tests — targeted at specific bugs.
//!
...
#[test]
fn dh4_parent_nesting_export_title() {
...
#[test]
fn dh4_drawer_parse_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
  (org-mode)
...
#[test]
fn dh4_element_map_first_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
  (org-mode)

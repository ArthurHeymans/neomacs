//! Strong divergence-hunt-7 oracle tests — targeted at specific bugs.
//!
...
#[test]
fn dh7_parent_nesting_export_title() {
...
#[test]
fn dh7_drawer_parse_properties() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
#[test]
fn dh7_element_map_first_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();

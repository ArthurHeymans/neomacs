...
fn org_timestamp_time_range_eval_parse_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (\"2 hours 30 minutes \" \"Reverse <FIXED-ORG-TIME>--<FIXED-ORG-TIME> - 01:30\" \"| A    | <FIXED-ORG-TIME>--<FIXED-ORG-TIME> | 2d 02:30 |\" (\"09:15\" \"09:15+2:30\" \"23:50+-24:20\" nil) ((\"<2026-05-27 Wed>\" 739763 \"2026-05-27 00:00\" 1779854400.0) (\"<FIXED-ORG-TIME>\" 739763 \"2026-05-27 09:15\" 1779887700.0)) (org-diary-sexp-no-match \"%%(diary-date 5 27 2026)\") (\"2 hours 30 minutes \" \"Time difference inserted\" \"Time difference inserted\") \"* Ranges\nInline <FIXED-ORG-TIME>--<FIXED-ORG-TIME>\nReverse <FIXED-ORG-TIME>--<FIXED-ORG-TIME> - 01:30\n| Task | Range                                          | Diff     |\n| A    | <FIXED-ORG-TIME>--<FIXED-ORG-TIME> | 2d 02:30 |\n\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (with-temp-buffer
...
fn org_planning_agenda_repeat_logbook_cookie_combo() {
    ...
    let expect = expect_test::expect![[r#""OK ((#(\"TODO\" 0 4 (org-todo-head \"TODO\")) \"<2026-07-14 Tue 08:30 .+2d>\" \"<2026-06-06 Sat +1w -2d>\" \"[FIXED-ORG-TIME]\" \"Ada\" \"+1w\") (#(\"DONE\" 0 4 (org-todo-head \"TODO\")) #(\"Checklist [2/2]\" 0 15 (org-todo-head \"TODO\")) nil) ((t nil nil t) \"3 days-agenda (W22):\nWednesday  27 May 2026\n  Plan:       11:00-12:15 TODO Repeat                                   :work::\n\") nil \"3 days-agenda (W22):\nWednesday  27 May 2026\n  Plan:       11:00-12:15 TODO Repeat                                   :work::\n\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (require 'org-agenda)

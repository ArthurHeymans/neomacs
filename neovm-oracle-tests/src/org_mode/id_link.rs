...
fn org_id_create_save_reload_find_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (t \"org\" 2 t \"B\" \"* A\n:PROPERTIES:\n:ID: a-id\n:END:\nBody\n* B\n:PROPERTIES:\n:ID:       <generated-id>\n:END:\n\")""#]];
...
fn org_id_store_parent_context_and_open_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (\"id:parent-id::*Child\" (:link \"id:parent-id::*Child\" :description \"Child\" :type \"id\") \"Child\" nil \"* Parent\n:PROPERTIES:\n:ID: parent-id\n:END:\n** Child\nBody\n** Sibling\n\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (require 'org-id)
...
fn org_id_open_option_and_colon_id_fallback_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (\"id:<generated>\" (:link \"id:<generated>\" :description \"Child Beta\" :type \"id\") (\"a.org\" \"Child Beta\" 7) (\"a.org\" \"Child Beta\" \"<<beta-target>>\n\") (\"b.org\" \"Literal Colon ID\" 1) nil (\"a.org\" \"b.org\"))""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (require 'org-id)
...
fn org_id_get_force_copy_marker_override_combo() {
    ...
    let expect = expect_test::expect![[r#""OK (\"parent-id\" \"parent-id\" nil \"parent-id\" t t t 0 \"Child\" \"Child\" t \"override.org\" (\"ids.org\" \"override.org\") \"* Parent\n:PROPERTIES:\n:ID: parent-id\n:END:\n** Child\n:PROPERTIES:\n:ID:       <forced-id>\n:END:\nBody\n* Numeric\n:PROPERTIES:\n:ID: 123\n:END:\n\")""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(progn
  (require 'org)
  (require 'org-id)

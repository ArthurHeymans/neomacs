//! Strong state-complex oracle tests — complex mutable state capture.
//!
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: headline + todo + tags + priority after edit
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_headline_edit_all() {
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: property cycle
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_property_cycle() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: property inheritance
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_property_inherit() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: table formula
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_table_formula() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: checkbox stats
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_checkbox_stats() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: element parse modify
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_element_parse_modify() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: export environment
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: planning repeaters
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_planning_repeaters() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: timestamp repeater
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_timestamp_repeater() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: block switches
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_block_switches() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: footnote markup
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_footnote_markup() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: hierarchy contents
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_hierarchy_contents() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: agenda entries
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_agenda_entries() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[r#""OK nil""#]];
    crate::common::assert_oracle_parity_expect(
        r##"(with-temp-buffer
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: colview format
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_colview_format() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: macro expansion
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_macro_expansion() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect =
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: dynamic block
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_dynamic_block() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: entity replacement
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_entity_replacement() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    let expect = expect_test::expect![[
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: radio targets
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_radio_targets() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: structure template
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_structure_template() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: comment fixed
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_comment_fixed() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
// ═══════════════════════════════════════════════════════════════════════
// State complex: refile targets
// ═══════════════════════════════════════════════════════════════════════

#[test]
fn sc2_refile_targets() {
    return_if_neovm_enable_oracle_proptest_not_set!();

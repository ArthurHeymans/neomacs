...
fn combo110_org_agenda_deadline_warning() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:warn-bound)""#]],
    );
}
#[test]
...
fn combo110_org_table_hide_body() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:at-table)""#]],
    );
}
#[test]
...
fn combo110_org_check_list_off() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:checkboxes)""#]],
    );
}
#[test]
fn combo110_org_backward_forward_paragraph() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""ERR (void-function list:at-para2)""#]],
    );
}
#[test]

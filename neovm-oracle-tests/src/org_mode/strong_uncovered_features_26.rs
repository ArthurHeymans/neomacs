...
fn uf26_export_html() {
  ...
  (org-export-as-html nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-as-html)""#]],
    );
}
...
fn uf26_export_latex() {
  ...
  (org-export-as-latex nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-as-latex)""#]],
    );
}
...
fn uf26_export_ascii() {
  ...
  (org-export-as-ascii nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-as-ascii)""#]],
    );
}
...
fn uf26_export_utf8() {
  ...
  (org-export-as-utf8 nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-as-utf8)""#]],
    );
}
...
fn uf26_export_html_buf() {
  ...
  (org-export-as-html-to-buffer nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-as-html-to-buffer)""#]],
    );
}
...
fn uf26_export_latex_buf() {
  ...
  (org-export-as-latex-to-buffer nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-as-latex-to-buffer)""#]],
    );
}
...
fn uf26_export_region() {
  ...
  (org-export-region-as-html (point) (point-max) nil))"##,
        expect_test::expect![[r#""ERR (void-function org-export-region-as-html)""#]],
    );
}
...
fn uf26_export_contents() {
  ...
  (let ((info (org-export-get-environment nil)))
    (org-export-get-contents (current-buffer) info)))"##,
        expect_test::expect![[r#""ERR (void-function org-export-get-contents)""#]],
    );
}

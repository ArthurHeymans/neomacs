...
"##,
        expect_test::expect![[r#""OK (t (:height 2.0))""#]],
    );
}
...
(let ((probe-history nil))
  ...
  probe-history)
"##,
        expect_test::expect![[r#""ERR (void-variable probe-history)""#]],
    );
}
...
"##,
        &["net/mailcap.el"],
        expect_test::expect![[r#""OK (\"text/plain\" \"text/html\" nil)""#]],
    );
}

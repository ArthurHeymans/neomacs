...
"##,
        expect_test::expect![[r#""OK (val-1 val-2)""#]],
    );
}
...
fn div_cx492_window_side() {
  ...
  (window-side w))
"##,
        expect_test::expect![[r#""ERR (void-function window-side)""#]],
    );
}
...
fn div_cx492_window_atom() {
  ...
  (window-atom w))
"##,
        expect_test::expect![[r#""ERR (void-function window-atom)""#]],
    );
}
...
fn div_cx492_window_nest() {
  ...
  (window-nest w))
"##,
        expect_test::expect![[r#""ERR (void-function window-nest)""#]],
    );
}
...
fn div_cx492_window_factor() {
  ...
  (window-factor w))
"##,
        expect_test::expect![[r#""ERR (void-function window-factor)""#]],
    );
}

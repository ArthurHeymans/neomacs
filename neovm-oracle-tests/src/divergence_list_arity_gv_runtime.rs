...
fn func_arity() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((1 . 1) (0 . many) (2 . 3) (1 . many) (2 . 2))""#]],
    );
}
...
(let ((pl (list :a 1 :b 2)))
  ...
  pl)"##,
        expect_test::expect![[r#""OK (:a 100 :b 7)""#]],
    );
}
...
(let ((l (list 1 2 3)) (al (list (cons 'a 1))) (v (vector 0 0)))
  ...
  (list l al v))"##,
        expect_test::expect![[r#""OK ((2 99 3 x) ((a . 42)) [7 0])""#]],
    );
}
...
fn list_alist_plist() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        (rassq 2 '((a . 1) (b . 2))))"##,
        expect_test::expect![[r#""OK (2 2 (:b 2) ((b . 2)) (b . 2))""#]],
    );
}
...
fn list_flatten_ensure() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((1 2 3 4 5 6) (5) (1 2) nil 3 nil)""#]],
    );
}
...
fn list_take_ntake() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((1 2) nil (1 2) (1 2) (3 4) (1 2))""#]],
    );
}

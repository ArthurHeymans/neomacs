...
fn div_face_slant_bold_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'bold-italic :slant)",
...
fn div_face_slant_elisp_ampersand() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-ampersand :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_charset() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-charset :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_coding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-coding :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_condition() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-condition :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_constant() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-constant :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_defcharset() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defcharset :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_defcoding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defcoding :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_defface() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defface :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_deficon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-deficon :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_defmacro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defmacro :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_defun() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defun :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_defvar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defvar :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_face() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-face :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_feature() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-feature :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_function() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-function :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_group() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-group :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_icon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-icon :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_macro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-macro :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_oclosure() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-oclosure :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_slot() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-slot :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_theme() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-theme :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_thing() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-thing :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_throw_tag() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-throw-tag :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_elisp_type() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-type :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_escape_glyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'escape-glyph :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_file_name_shadow() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'file-name-shadow :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_fixed_pitch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'fixed-pitch :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_glyphless_char() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'glyphless-char :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_header_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'header-line :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_help_key_binding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'help-key-binding :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_highlight() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'highlight :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_homoglyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'homoglyph :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_internal_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'internal-border :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_isearch_fail() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-fail :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_isearch_group_1() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-group-1 :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_isearch_group_2() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-group-2 :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_lazy_highlight() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'lazy-highlight :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_line_number() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'line-number :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_link_visited() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'link-visited :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_mode_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'mode-line :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_mode_line_active() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'mode-line-active :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_next_error() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'next-error :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_nobreak_hyphen() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'nobreak-hyphen :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_nobreak_space() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'nobreak-space :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_query_replace() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'query-replace :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_scroll_bar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'scroll-bar :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_separator_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'separator-line :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_show_paren_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'show-paren-match :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_tab_bar_tab() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-bar-tab :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_tab_line_active() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line-active :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_underline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'underline :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_variable_pitch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'variable-pitch :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vc_edited_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-edited-state :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vc_ignored_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-ignored-state :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vc_locked_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-locked-state :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vc_missing_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-missing-state :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vc_removed_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-removed-state :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vc_state_base() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-state-base :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_vertical_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vertical-border :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_slant_window_divider() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'window-divider :slant)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}

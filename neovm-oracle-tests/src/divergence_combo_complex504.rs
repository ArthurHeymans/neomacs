...
fn div_cx504_bom_utf8_with_sig() {
  ...
  (prog1 (with-temp-buffer
    ...
    (delete-file f)))
"##,
        expect_test::expect![[r#""OK (4 239 187 191)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((no-conversion) (no-conversion))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (utf-8 charset raw-text)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (coding-category-utf-8 t)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"hello\" \"cafe\" 4)""#]],
    );
}

...
"##,
        expect_test::expect![[r#""OK (1 1 1 2 2 2)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (57472 57504 57599 58112 58367)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (nil (run open listen connect stop) run)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (3 2 1 1)""#]],
    );
}
...
(progn
  ...
  (let ((b (make-neo-cx33-box :val 42 :name "test")))
    (list (neo-cx33-box-val b)
          ...
          (neo-cx33-read-box b))))
"##,
        expect_test::expect![[r#""ERR (void-function neo-cx33-read-box)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"café\" (face bold) 4)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (22 11 t)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (wrong-type-argument listp [0 2 0 1 1 2])""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"\\\"\\\\310\\\\311A\\\"\" 6)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (args-out-of-range 2 2)""#]],
    );
}
...
(let* ((c1 (format "%c" #x3042))
  ...
  (list (length c1) (string-bytes c1)
        ...
        (append cat nil)))
"##,
        expect_test::expect![[r#""OK (1 3 1 4 2 7 (12354 128512))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (:local :shadowed :set-in-shadow :local :global)""#]],
    );
}

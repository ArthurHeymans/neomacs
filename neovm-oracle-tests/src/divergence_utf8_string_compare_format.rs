...
(list (string-width "café")
      ...
      (string-width "héllo"))
"#,
        expect_test::expect![[r#""OK (4 4 4 0 5)""#]],
    );
}
...
(list (format "%10s" "abc")
      ...
      (format "%5c" 65))
"#,
        expect_test::expect![[r#""OK (\"       abc\" 10 \"abc       |\" \"    A\")""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"      世界\" 8 \"café    |\" 9)""#]],
    );
}
...
(list (length (format "%-10s|" "中"))
      ...
      (format "%4c" #x3042))
"#,
        expect_test::expect![[r#""OK (10 6 \"  あ\")""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (t -3 -4 -1)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"XéX\" \"XXXXX\" \"XXX\")""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"cafÉ rÉsumÉ\" \"你好WORLD\" \"cafE Elite\")""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"\\\\(?:café\\\\|thé\\\\|世界\\\\)\" 20)""#]],
    );
}

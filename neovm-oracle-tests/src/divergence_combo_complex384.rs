...
(condition-case e
  ...
  (error (list :errored (car e))))
"##,
        expect_test::expect![[r#""OK (:elisp :text :default)""#]],
    )
}
...
(condition-case e
  ...
  (error (list :errored (car e))))
"##,
        expect_test::expect![[r#""OK (:caught-no-applicable :caught-no-applicable)""#]],
    )
}
...
(condition-case e
  ...
  (error (list :errored (car e))))
"##,
        expect_test::expect![[r#""OK (:both-str :str-int :int-str :both-int)""#]],
    )
}

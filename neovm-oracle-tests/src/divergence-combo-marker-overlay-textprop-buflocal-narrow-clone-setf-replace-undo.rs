//! Combo: marker + overlay + textprop + buflocal + narrow + clone + setf + replace + undo.
...
#[test]
fn combo_marker_overlay_textprop_buflocal_narrow_clone_setf_replace_undo() {
...
#[test]
fn combo_marker_overlay_textprop_buflocal_narrow_clone_replace_setf_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_marker_overlay_textprop_buflocal_narrow_clone_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_marker_overlay_textprop_buflocal_narrow_clone_textprop_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_marker_overlay_textprop_buflocal_narrow_clone_setf_replace_undo_2() {
    return_if_neovm_enable_oracle_proptest_not_set!();

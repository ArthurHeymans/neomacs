...
fn encode_time_month_overflow() {
  ...
  (list (nth 4 d) (nth 5 d))) (error (cons (quote ERR) (car e))))"##,
        expect_test::expect![[r#""OK (1 2025)""#]],
    );
}
...
fn string_clean_fill() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"a b c\" \"one two\nthree four\nfive\")""#]],
    );
}
...
fn string_limit() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"hello\" \"hi\" \"llo\")""#]],
    );
}
...
fn string_pad_edge() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"abc\" \"xxx\" \"---ab\" \"x\n\")""#]],
    );
}
...
fn string_search_edge() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (0 nil nil 1 nil)""#]],
    );
}

//! Combo: marker + overlay + textprop + buflocal + clone + narrow + setf + replace + undo + multi-buffer.
//! Tests all 10 subsystems together.

use super::common::assert_oracle_parity;
use super::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_ten_marker_overlay_textprop_buflocal_clone_narrow_setf_replace_undo_multi() {
...
#[test]
fn combo_ten_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_ten_textprop_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_ten_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_ten_replace_setf_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

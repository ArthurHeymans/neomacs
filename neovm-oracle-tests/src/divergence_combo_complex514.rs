...
"##,
        expect_test::expect![[r#""ERR (void-function current-language-environment)""#]],
    );
}
...
fn div_cx514_charset_description() {
  ...
  (error (car e)))
"##,
        expect_test::expect![[r#""OK \"ASCII (ISO646 IRV)\"""#]],
    );
}
...
fn div_cx514_charset_plist_complete() {
  ...
  (error (car e)))
"##,
        expect_test::expect![[r#""OK (ascii [0 127 0 0 0 0 0 0])""#]],
    );
}

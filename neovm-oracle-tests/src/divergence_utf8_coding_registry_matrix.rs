...
fn div_utf8_csreg_adobe_standard_encoding() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 39 8224 168 4194288 4194301)""#]],
    );
}
...
fn div_utf8_csreg_chinese_big5() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (12317 31534 36453)""#]],
    );
}
...
fn div_utf8_csreg_chinese_gb18030() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (12293 36393 30229)""#]],
    );
}
...
fn div_utf8_csreg_compound_text() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 169 178 200 240 253)""#]],
    );
}
...
fn div_utf8_csreg_cp1125() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1073 1081 9619 9562 1025 164)""#]],
    );
}
...
fn div_utf8_csreg_cp437() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (237 8976 9619 9562 8801 178)""#]],
    );
}
...
fn div_utf8_csreg_cp737() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (954 963 9619 9562 911 178)""#]],
    );
}
...
fn div_utf8_csreg_cp775() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (298 174 9619 9562 173 178)""#]],
    );
}
...
fn div_utf8_csreg_cp850() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (237 174 9619 9562 173 178)""#]],
    );
}
...
fn div_utf8_csreg_cp851() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (912 918 9619 9562 173 974)""#]],
    );
}
...
fn div_utf8_csreg_cp852() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (237 281 9619 9562 173 345)""#]],
    );
}
...
fn div_utf8_csreg_cp855() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1040 1045 9619 9562 173 167)""#]],
    );
}
...
fn div_utf8_csreg_cp860() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (237 210 9619 9562 8801 178)""#]],
    );
}
...
fn div_utf8_csreg_cp863() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (180 8976 9619 9562 8801 178)""#]],
    );
}
...
fn div_utf8_csreg_cp874() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (3585 3593 3602 3624 3664 4194301)""#]],
    );
}
...
fn div_utf8_csreg_cyrillic_iso_8bit() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1025 1033 1042 1064 8470 167)""#]],
    );
}
...
fn div_utf8_csreg_cyrillic_koi8() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (9553 9560 9569 1093 1055 1065)""#]],
    );
}
...
fn div_utf8_csreg_ebcdic_uk() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (8254 122 4194226 72 48 4194301)""#]],
    );
}
...
fn div_utf8_csreg_ebcdic_us() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (126 122 4194226 72 48 4194301)""#]],
    );
}
...
fn div_utf8_csreg_euc_jis_2004() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (65311 23478 39023)""#]],
    );
}
...
fn div_utf8_csreg_euc_tw() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (65311 1132133 27211)""#]],
    );
}
...
fn div_utf8_csreg_georgian_academy() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 169 178 4312 240 253)""#]],
    );
}
...
fn div_utf8_csreg_georgian_ps() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 169 178 4311 240 253)""#]],
    );
}
...
fn div_utf8_csreg_greek_iso_8bit() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (8216 169 178 920 960 973)""#]],
    );
}
...
fn div_utf8_csreg_hebrew_iso_8bit() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (4194209 169 178 4194248 1504 8206)""#]],
    );
}
...
fn div_utf8_csreg_hp_roman8() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (192 715 253 224 222 187)""#]],
    );
}
...
fn div_utf8_csreg_ibm1047() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (126 122 165 72 48 217)""#]],
    );
}
...
fn div_utf8_csreg_ibm273() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (223 122 165 72 48 217)""#]],
    );
}
...
fn div_utf8_csreg_ibm274() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (168 122 4194226 72 48 4194301)""#]],
    );
}
...
fn div_utf8_csreg_ibm277() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (252 122 165 72 48 217)""#]],
    );
}
...
fn div_utf8_csreg_ibm280() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (236 122 165 72 48 217)""#]],
    );
}
...
fn div_utf8_csreg_ibm284() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (168 122 165 72 48 217)""#]],
    );
}
...
fn div_utf8_csreg_ibm285() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (8254 122 165 72 48 217)""#]],
    );
}
...
fn div_utf8_csreg_ibm290() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (8254 12516 4194226 72 48 4194301)""#]],
    );
}
...
fn div_utf8_csreg_in_is13194_devanagari() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (2305 2314 2317 2346 1572943 1572956)""#]],
    );
}
...
fn div_utf8_csreg_iso_8859_6() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (4194209 4194217 4194226 1576 1616 4194301)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_10() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (260 169 268 200 273 281)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_2() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (260 352 731 268 273 253)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_3() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (294 304 178 200 4194288 365)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_4() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (260 352 731 268 273 361)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_5() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 169 178 200 287 305)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_6() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (260 272 275 268 240 253)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_7() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (8221 169 178 268 353 380)""#]],
    );
}
...
fn div_utf8_csreg_iso_latin_8() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (7682 169 288 200 373 253)""#]],
    );
}
...
fn div_utf8_csreg_japanese_cp932() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (65377 65385 65394 65416 4194288 4194301)""#]],
    );
}
...
fn div_utf8_csreg_koi8_t() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1263 4194217 178 1093 1055 1065)""#]],
    );
}
...
fn div_utf8_csreg_korean_cp949() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (173 44866 32305)""#]],
    );
}
...
fn div_utf8_csreg_mac_roman() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (176 169 8804 187 57374 733)""#]],
    );
}
...
fn div_utf8_csreg_mik() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1073 1081 1090 9562 8801 178)""#]],
    );
}
...
fn div_utf8_csreg_next() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 8217 8224 168 246 255)""#]],
    );
}
...
fn div_utf8_csreg_pt154() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1038 169 1030 1048 1088 1101)""#]],
    );
}
...
fn div_utf8_csreg_thai_tis620() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (3585 3593 3602 3624 3664 3677)""#]],
    );
}
...
fn div_utf8_csreg_tibetan_iso_8bit() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1638408 4194226 4194248 4194288 4194301)""#]],
    );
}
...
fn div_utf8_csreg_utf_16() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (41385 45768 61693)""#]],
    );
}
...
fn div_utf8_csreg_utf_16le() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (43425 51378 65008)""#]],
    );
}
...
fn div_utf8_csreg_vietnamese_viscii() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (7855 7865 7895 200 273 253)""#]],
    );
}
...
fn div_utf8_csreg_vietnamese_vscii() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (258 226 771 7849 7894 253)""#]],
    );
}
...
fn div_utf8_csreg_windows_1250() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (711 169 731 268 273 253)""#]],
    );
}
...
fn div_utf8_csreg_windows_1253() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (901 169 178 920 960 973)""#]],
    );
}
...
fn div_utf8_csreg_windows_1255() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 169 178 1464 1504 8206)""#]],
    );
}
...
fn div_utf8_csreg_windows_1256() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1548 169 178 1576 1611 8206)""#]],
    );
}
...
fn div_utf8_csreg_windows_1257() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (4194209 169 178 268 353 380)""#]],
    );
}
...
fn div_utf8_csreg_windows_1258() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (161 169 178 200 273 432)""#]],
    );
}

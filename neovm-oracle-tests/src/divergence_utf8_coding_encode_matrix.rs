...
fn div_utf8_csenc_adobe_standard_encoding() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 32 32)""#]],
    );
}
...
fn div_utf8_csenc_chinese_big5() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 165 64 172 201)""#]],
    );
}
...
fn div_utf8_csenc_chinese_gb18030() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 168 166 202 192 189 231)""#]],
    );
}
...
fn div_utf8_csenc_chinese_hz() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 126 123 40 38 74 64 61 103 126 125)""#]],
    );
}
...
fn div_utf8_csenc_cp437() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 130 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ctext_no_compositions() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 233 27 36 65 74 64 61 103 27 40 66)""#]],
    );
}
...
fn div_utf8_csenc_ebcdic_uk() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (131 129 134 32 32 32)""#]],
    );
}
...
fn div_utf8_csenc_emacs_mule() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 129 233 145 202 192 145 189 231)""#]],
    );
}
...
fn div_utf8_csenc_euc_jis_2004() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 169 223 192 164 179 166)""#]],
    );
}
...
fn div_utf8_csenc_euc_tw() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 197 224 210 204)""#]],
    );
}
...
fn div_utf8_csenc_eucjp_ms() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 143 171 177 192 164 179 166)""#]],
    );
}
...
fn div_utf8_csenc_georgian_academy() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 233 32 32)""#]],
    );
}
...
fn div_utf8_csenc_hp_roman8() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 197 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ibm1047() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (131 129 134 81 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ibm274() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (131 129 134 192 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ibm275() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (131 129 134 208 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ibm278() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (131 129 134 121 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ibm280() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (131 129 134 90 32 32)""#]],
    );
}
...
fn div_utf8_csenc_ibm290() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (32 32 32 32 32 32)""#]],
    );
}
...
fn div_utf8_csenc_iso_2022_cn() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 27 36 65 40 38 74 64 61 103 27 40 66)""#]],
    );
}
...
fn div_utf8_csenc_iso_2022_jp() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 27 36 66 64 36 51 38 27 40 66)""#]],
    );
}
...
fn div_utf8_csenc_iso_2022_kr() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 27 36 40 67 97 38 77 35 27 40 66)""#]],
    );
}
...
fn div_utf8_csenc_japanese_cp932() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 144 162 138 69)""#]],
    );
}
...
fn div_utf8_csenc_japanese_shift_jis_2004() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 133 126 144 162 138 69)""#]],
    );
}
...
fn div_utf8_csenc_korean_cp949() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 32 225 166 205 163)""#]],
    );
}
...
fn div_utf8_csenc_mac_roman() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 142 32 32)""#]],
    );
}
...
fn div_utf8_csenc_next() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 221 32 32)""#]],
    );
}
...
fn div_utf8_csenc_no_conversion() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 195 169 228 184 150 231 149 140)""#]],
    );
}
...
fn div_utf8_csenc_us_ascii() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 63 63 63)""#]],
    );
}
...
fn div_utf8_csenc_utf_16() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (254 255 0 99 0 97 0 102 0 233 78 22 117 76)""#]],
    );
}
...
fn div_utf8_csenc_utf_16be() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (0 99 0 97 0 102 0 233 78 22 117 76)""#]],
    );
}
...
fn div_utf8_csenc_utf_16le() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 0 97 0 102 0 233 0 22 78 76 117)""#]],
    );
}
...
fn div_utf8_csenc_utf_16le_with_signature() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (255 254 99 0 97 0 102 0 233 0 22 78 76 117)""#]],
    );
}
...
fn div_utf8_csenc_utf_7() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 43 65 79 108 79 70 110 86 77)""#]],
    );
}
...
fn div_utf8_csenc_utf_7_imap() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 38 65 79 108 79 70 110 86 77 45)""#]],
    );
}
...
fn div_utf8_csenc_vietnamese_viqr() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 101 39 228 184 150 231 149 140)""#]],
    );
}
...
fn div_utf8_csenc_vietnamese_vscii() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (99 97 102 208 32 32)""#]],
    );
}

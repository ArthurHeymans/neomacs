...
(let ((s "name:世界 value:42"))
  (list (string-match "\\(\\w+\\):\\(\\w+\\)" s)
        ...
        (match-data)))
"##,
        expect_test::expect![[r#""OK (0 \"name\" \"世界\" 0 4 5 7 (0 7 0 4 5 7))""#]],
    );
}
...
(with-temp-buffer
  ...
  (list (looking-at "Hello")
        ...
        (looking-at-p "Hello")))
"##,
        expect_test::expect![[r#""OK (t \"Hello\" nil t)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (6 \"hello\" 12 \"world\" 18 \"!\")""#]],
    );
}
...
(let ((s "alpha-123-beta-456"))
  ...
  (list (match-string 0 s)
        ...
        (match-beginning 1) (match-end 1)))
"##,
        expect_test::expect![[r#""OK (\"alpha-123\" \"123\" 0 9 6 9)""#]],
    );
}

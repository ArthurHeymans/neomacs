...
fn oracle_prop_apply_basics() {
    ...
    let (oracle_sum, neovm_sum) = crate::common::eval_oracle_and_neovm_expect(
        "(apply '+ '(1 2 3 4))",
    ...
    let (oracle_vec, neovm_vec) = crate::common::eval_oracle_and_neovm_expect(
        "(apply 'vector 1 '(2 3))",
...
fn oracle_prop_apply_empty_tail_and_runtime_function_objects() {
    ...
    let (oracle_car, neovm_car) = crate::common::eval_oracle_and_neovm_expect(
        "(apply #'car '((1 2)))",
...
fn oracle_prop_apply_lambda_optional_and_rest_binding() {
    ...
    let (oracle_full, neovm_full) = crate::common::eval_oracle_and_neovm_expect(
        form_full,
        expect_test::expect![[r#""OK (1 2 (3 4))""#]],
    );
    ...
    let (oracle_short, neovm_short) = crate::common::eval_oracle_and_neovm_expect(
        form_short,
...
fn oracle_prop_apply_improper_tail_error_shape() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![r#""OK (wrong-type-argument listp 2)""#],
    );
}
...
fn oracle_prop_apply_nil_t_and_special_form_call_targets() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![r#""OK (void-function t)""#],
    );
    crate::common::assert_oracle_parity_expect(
        "(condition-case err (apply 'if '(t 1 2)) (error err))",
        expect_test::expect![r#""OK (invalid-function #<subr if>)""#],
    );
}
...
fn oracle_prop_apply_autoload_object_error_payload_shape() {
    ...
    let (oracle, neovm) = crate::common::eval_oracle_and_neovm_expect(
        form,
        expect_test::expect![[r#""OK (wrong-type-argument symbolp t)""#]],
    );
...
fn oracle_prop_apply_keyword_function_cell_controls_behavior() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![r#""OK (invalid-function :k)""#],
    );
}
...
fn oracle_prop_apply_zero_args_error_shape() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![r#""OK (wrong-number-of-arguments apply 0)""#],
    );
}
...
fn oracle_prop_apply_single_arg_error_shape() {
    ...
    crate::common::assert_oracle_parity_expect(
        "(condition-case err (apply '+) (error err))",
        expect_test::expect![r#""OK (wrong-type-argument listp +)""#],
    );
}
...
fn oracle_prop_apply_non_list_tail_error_shape() {
    ...
    crate::common::assert_oracle_parity_expect(
        "(condition-case err (apply 'list [1 2]) (error err))",
        expect_test::expect![r#""OK (wrong-type-argument listp [1 2])""#],
    );
}
...
fn oracle_prop_apply_argument_evaluation_order_and_single_eval() {
    ...
    let (oracle, neovm) = crate::common::eval_oracle_and_neovm_expect(
        form,
        expect_test::expect![[r#""OK ((a b c d) 3)""#]],
    );
...
fn oracle_prop_apply_subr_object_ignores_symbol_rebinding() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK 1""#]]);
...
fn oracle_prop_apply_symbol_uses_current_function_cell() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK (6 3)""#]]);
...
fn oracle_prop_apply_non_callable_list_error_shape() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![r#""OK (invalid-function (1 2 3))""#],
    );
}
...
fn oracle_prop_apply_unfbound_symbol_error_shape() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![r#""OK (void-function neovm-apply-unbound)""#],
    );
}

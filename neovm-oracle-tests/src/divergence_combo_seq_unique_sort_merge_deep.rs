...
fn deficiency_delete_dups_basic() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((1 2 3 4 5) (a b c d))""#]],
    );
}
...
fn deficiency_seq_group_by() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((nil 1 3 5 7 9) (t 2 4 6 8 10))""#]],
    );
}
...
fn deficiency_seq_mapcat_with_index() {
    ...
    crate::common::assert_oracle_parity_expect(
        "(progn\n\
         ...
         '(1 2 3 4 5)))",
        expect_test::expect![[r#""OK (1 1 2 4 3 9 4 16 5 25)""#]],
    );
}
...
fn deficiency_seq_reduce_with_initial() {
    ...
    crate::common::assert_oracle_parity_expect(
        "(progn\n\
         ...
         '(a b c d) nil)))",
        expect_test::expect![[r#""OK (15 120 (d c b a))""#]],
    );
}
...
fn deficiency_seq_filter_remove_combined() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((2 4 6 8 10) (1 3 5 7 9) (6 7 8 9 10) 5)""#]],
    );
}

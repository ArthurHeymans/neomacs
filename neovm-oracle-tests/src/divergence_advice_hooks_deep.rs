...
fn divergence_hooks_add_remove() {
  ...
  (list test-hook-var-xxx
        (progn
          ...
          test-hook-var-xxx))) "#,
        expect_test::expect![[r#""OK (((closure (t) nil 'hook-called)) nil)""#]],
    );
}
...
fn divergence_hook_depth() {
  ...
  (list (listp test-hook-depth-xxx)
        ...
        test-hook-depth-xxx)) "#,
        expect_test::expect![[r#""OK (t t nil (append-fn-xxx t))""#]],
    );
}

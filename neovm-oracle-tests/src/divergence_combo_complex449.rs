...
fn div_cx449_string_to_multibyte_idempotent() {
  ...
  (list (string-multibyte-p s)
        ...
        expect_test::expect![[r#""ERR (void-function string-multibyte-p)""#]],
    );
}
...
fn div_cx449_fillarray_ops() {
  ...
  (fillarray s ?x)
  (list v s))"##,
        expect_test::expect![[r#""OK ([0 0 0] \"xxx\")""#]],
    );
}
...
fn div_cx449_copy_alist_nested() {
  ...
  (let ((copy (copy-alist al)))
    ...
    (list (cdr (assq 'a al)) (cdr (assq 'a copy))))))"##,
        expect_test::expect![[r#""ERR (invalid-read-syntax \")\" 4 53)""#]],
    );
}
...
fn div_cx449_file_absolute_relative() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (file-relative-name "/tmp/test.el" "/tmp"))"##,
        expect_test::expect![[r#""OK (t \"test.el\")""#]],
    );
}
...
fn div_cx449_encode_decoded_time() {
  ...
  (error (car e)))"##,
        expect_test::expect![[r#""OK (2024 6 16)""#]],
    );
}
...
fn div_cx449_string_trim_clean() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (string-blank-p "  ")
      (string-blank-p "abc"))"##,
        expect_test::expect![[r#""OK (\"hello\" \"hello\" \"hello\" 0 nil)""#]],
    );
}
...
fn div_cx449_interactive_lambda_specs() {
  ...
  (interactive-form f))"##,
        expect_test::expect![[r#""OK (interactive \"P\")""#]],
    );
}
...
fn div_cx449_function_alias_p() {
  ...
  (list (fboundp sym)
        ...
        expect_test::expect![[r#""OK (t forward-char #<subr forward-char>)""#]],
    );
}

...
fn astro_julian_day() {
  ...
  (list (calendar-astro-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK (2460476.5 2460476)""#]],
    );
}
...
fn bahai() {
  ...
  (list (calendar-bahai-from-absolute 739052))) (error (cons (quote ERR) (car e))))"##,
        expect_test::expect![[r#""OK ((5 12 181))""#]],
    );
}
...
fn chinese() {
  ...
  (list (calendar-chinese-from-absolute 739052))) (error (cons (quote ERR) (car e))))"##,
        expect_test::expect![[r#""OK ((78 41 5 10))""#]],
    );
}
...
fn coptic_ethiopic() {
  ...
  (list (calendar-coptic-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK ((10 8 1740) (10 8 2016))""#]],
    );
}
...
fn french() {
  ...
  (list (calendar-french-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK ((9 28 232) 739151)""#]],
    );
}
...
fn hebrew() {
  ...
  (list (calendar-hebrew-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK ((3 9 5784) 739162)""#]],
    );
}
...
fn islamic() {
  ...
  (list (calendar-islamic-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK ((12 8 1445) 739075)""#]],
    );
}
...
fn iso_calendar() {
  ...
  (list (calendar-iso-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK ((24 6 2024) 739059)""#]],
    );
}
...
fn mayan() {
  ...
  (list (calendar-mayan-long-count-from-absolute 739052))) (error (cons (quote ERR) (car e))))"##,
        expect_test::expect![[r#""OK ((13 0 11 11 14))""#]],
    );
}
...
fn persian() {
  ...
  (list (calendar-persian-from-absolute 739052)
        ...
        expect_test::expect![[r#""OK ((3 26 1403) 738965)""#]],
    );
}

...
"#,
        expect_test::expect![[r#""OK (8 16 t)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (104 233 108 111)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"aé\" \"ébç\" \"bçd\" \"bçd\")""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"é\" 1 2 1 3)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"é\" \"あ\" \"😀\" 1 1 1 2 3 4)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"café\" \"café4\" \"\\\"café\\\"\")""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (\"a-é-b\" \"61,E9,7A\")""#]],
    );
}

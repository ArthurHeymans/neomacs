...
fn current_time_zone_forms() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (0 3600 -18000)""#]],
    );
}
...
fn decode_time_zone_forms() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (14 15 13 7200)""#]],
    );
}
...
fn encode_time_utc_zone() {
  ...
  (list (nth 0 back) (nth 1 back) (nth 2 back) (nth 3 back) (nth 4 back) (nth 5 back)))"##,
        expect_test::expect![[r#""OK (0 30 14 15 3 2024)""#]],
    );
}
...
fn fts_integer_zone() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"15:32+0100\" \"09:32-0500\" \"14:32+0000\")""#]],
    );
}
...
fn fts_named_zone() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"14:32 UTC\" \"14:32\" \"+0100\")""#]],
    );
}
...
fn divergence_fts_minimal_colon_zone() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (format-time-string "%::z" '(26150 29968) 3661))"##,
        expect_test::expect![[r#""OK (\"+01\" \"+00\" \"+01:01:01\")""#]],
    );
}

//! Combo: buflocal + marker + overlay + textprop + clone + narrow + setf + replace.
...
#[test]
fn combo_buflocal_marker_overlay_textprop_clone_narrow_setf_replace() {
...
#[test]
fn combo_buflocal_marker_overlay_textprop_clone_narrow_replace_setf() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_buflocal_marker_overlay_textprop_clone_narrow_multi_overlay() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_buflocal_marker_overlay_textprop_clone_narrow_textprop_replace() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_buflocal_marker_overlay_textprop_clone_narrow_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

...
"##,
        expect_test::expect![[r#""OK \"cx543-name\"""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK #<buffer  *cx543-pb*>""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK my-val""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function process-connection)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"echo\" \"cmd\")""#]],
    );
}

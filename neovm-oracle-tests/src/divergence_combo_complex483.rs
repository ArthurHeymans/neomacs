...
"##,
        expect_test::expect![[r#""OK #s(neo-cx483-print 1)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (neo-cx483-boac x y)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (1 0 fixed)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function neo-cx483-doc)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK neo-cx483-nt2""#]],
    );
}

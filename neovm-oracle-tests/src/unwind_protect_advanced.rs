...
fn oracle_prop_unwind_protect_multiple_cleanup_forms() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (body clean1 clean2 clean3)""#]],
    );
}
...
fn oracle_prop_unwind_protect_cleanup_on_throw() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (before-throw cleanup-ran cleanup-2-ran)""#]],
    );
}
...
fn oracle_prop_unwind_protect_throw_preserves_value_through_cleanup() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK ((complex data 42) t)""#]],
    );
}
...
fn oracle_prop_unwind_protect_cleanup_on_signal() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (body cleanup-1 cleanup-2 (caught arith-error))""#]],
    );
}
...
fn oracle_prop_unwind_protect_nested_lifo_ordering() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (body inner middle outer)""#]],
    );
}
...
fn oracle_prop_unwind_protect_nested_lifo_with_throw() {
    ...
    let (o, n) = crate::common::eval_oracle_and_neovm_expect(
        form,
        expect_test::expect![[r#""OK (deepest cleanup-3 cleanup-2 cleanup-1)""#]],
    );
...
fn oracle_prop_unwind_protect_error_in_cleanup() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (caught \"cleanup exploded\")""#]],
    );
}
...
fn oracle_prop_unwind_protect_error_in_cleanup_overrides_body_error() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK \"cleanup error\"""#]],
    );
}
...
fn oracle_prop_unwind_protect_partial_cleanup_on_cleanup_error() {
    ...
    let form = r#"(let ((log nil))
                    (condition-case nil
                      ...
                      (error nil))
                    (nreverse log))"#;
    crate::common::assert_oracle_parity_expect(form, expect_test::expect![[r#""OK (c1)""#]]);
}
...
fn oracle_prop_unwind_protect_preserves_body_return_value() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK ((computed 2) 999)""#]],
    );
}
...
fn oracle_prop_unwind_protect_preserves_nil_body_value() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (nil cleaned)""#]],
    );
}

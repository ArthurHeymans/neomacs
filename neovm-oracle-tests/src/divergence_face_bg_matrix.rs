...
fn div_face_bg_bold() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'bold :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_bold_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'bold-italic :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_button() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'button :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_default() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"unspecified-bg\"""#]],
    );
}
...
fn div_face_bg_elisp_defun() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defun :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_face() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-face :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_group() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-group :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_icon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-icon :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_macro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-macro :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_rx() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-rx :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_slot() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-slot :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_symbol_at_mouse() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r##""OK \"#00422a\"""##]],
    );
}
...
fn div_face_bg_elisp_theme() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-theme :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_thing() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-thing :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_elisp_type() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-type :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_fixed_pitch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'fixed-pitch :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_help_key_binding() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"grey90\"""#]],
    );
}
...
fn div_face_bg_homoglyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'homoglyph :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_isearch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'italic :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_link() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'link :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_margin() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'margin :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_match() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'match :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_minibuffer_nonselected() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK \"yellow\"""#]],
    );
}
...
fn div_face_bg_mouse() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'mouse :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_scroll_bar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'scroll-bar :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_shadow() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'shadow :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_success() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'success :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_tab_bar_tab() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-bar-tab :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_tab_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line :background)",
        expect_test::expect![[r#""OK \"grey\"""#]],
    );
}
...
fn div_face_bg_underline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'underline :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_bg_warning() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'warning :background)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}

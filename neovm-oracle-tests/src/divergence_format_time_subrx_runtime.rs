...
fn fts_12h_pm() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"02:32:48 PM\" \" 2:32pm\" \"2\")""#]],
    );
}
...
fn fts_caret_upper_various() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"MONDAY APRIL\" \"PM\")""#]],
    );
}
...
fn fts_dash_flag_various() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"4/22/2024\" \"14:32\" \"113\")""#]],
    );
}
...
fn fts_day_names_all() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"Mon/Monday/Apr/April\" \"Wed/Wednesday\")""#]],
    );
}
...
fn fts_iso_week_year_combos() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"2024-W17-1\" \"2024113\" \"24\")""#]],
    );
}
...
fn fts_seconds_since_epoch() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"1713796368\" 1713796368)""#]],
    );
}
...
fn fts_zero_pad_default() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"143248\" \"04/22\" \"24\" \"20\")""#]],
    );
}
...
fn and_or_let_star() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (10 nil)""#]],
    );
}
...
(list (if-let ((x 5) (y 10)) (+ x y) 'no)
      ...
      (when-let ((a nil)) 'never))"##,
        expect_test::expect![[r#""OK (15 no 3 nil)""#]],
    );
}
...
(list (string-trim "  hi  ") (string-empty-p "") (string-empty-p "x")
      (string-blank-p "  ") (string-join '("a" "b") ",") (string-pad "x" 3))"##,
        expect_test::expect![[r#""OK (\"hi\" t nil 0 \"a,b\" \"x  \")""#]],
    );
}
...
(list (thread-first 5 (+ 3) (* 2)) (thread-last 5 (+ 3) (* 2))
      (thread-first '(1 2 3) (car) (number-to-string)))"##,
        expect_test::expect![[r#""OK (16 16 \"1\")""#]],
    );
}

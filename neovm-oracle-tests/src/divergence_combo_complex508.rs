...
"##,
        expect_test::expect![[r#""OK (wrong-number-of-arguments car)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (void-function nonexistent-fn-12345)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (void-variable nonexistent-var-12345)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (args-out-of-range [1])""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (end-of-buffer nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (text-read-only nil)""#]],
    );
}
...
fn div_cx508_error_coding_system() {
  ...
  (error (list (car e) (cadr e))))
"##,
        expect_test::expect![[r#""OK (coding-system-error nonexistent-coding)""#]],
    );
}
...
fn div_cx508_error_file_error() {
  ...
  (error (list (car e) (cadr e))))
"##,
        expect_test::expect![[r#""OK (file-missing \"Opening input file\")""#]],
    );
}
...
fn div_cx508_error_process_error() {
  ...
  (error (list (car e) (cadr e))))
"##,
        expect_test::expect![[r#""OK (file-missing \"Searching for program\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (void-function scan-error)""#]],
    );
}
...
fn div_cx508_error_user_signal() {
  ...
  (error (list (car e) (cadr e))))
"##,
        expect_test::expect![[r#""OK (error \"Invalid error symbol\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK 2305843009213693952""#]],
    );
}

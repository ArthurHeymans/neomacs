...
"##,
        expect_test::expect![[r#""OK \"((1 2 3 ...) (6 7 8 ...) (11 12 13) ...)\"""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (6 6 3 3 2 5)""#]],
    );
}
...
(let (fired)
  ...
  fired)
"##,
        expect_test::expect![[r#""OK :timer-fired""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (my-forward nil nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (:caught-parent :caught-exact)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (5 6 4194248 4194249 4194250 65)""#]],
    );
}
...
(let (log)
  ...
  (reverse log))
"##,
        expect_test::expect![[r#""OK (:change :change)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK \"x y % literal\"""#]],
    );
}

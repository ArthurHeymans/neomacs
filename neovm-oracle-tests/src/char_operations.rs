...
fn oracle_prop_char_syntax_basic() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![r#""OK (119 119 32 40 41 95 95)""#],
    );
}
...
fn oracle_prop_char_syntax_classify_string() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK \"(wwwww www (w) (_ w w))\"""#]],
    );
}
...
fn oracle_prop_insert_char_basic() {
    ...
    let form = r#"(with-temp-buffer
                    (insert-char ?a 5)
                    (buffer-string))"#;
    crate::common::assert_oracle_parity_expect(form, expect_test::expect![[r#""OK \"aaaaa\"""#]]);
}
...
fn oracle_prop_insert_char_multibyte() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (\"ééé 日日\" 6 6)""#]],
    );
}
...
fn oracle_prop_char_equal_case_sensitive() {
    ...
    let form = r#"(list (char-equal ?a ?a)
                        ...
                        (char-equal ?a ?b)
                        (char-equal ?0 ?0))"#;
    crate::common::assert_oracle_parity_expect(form, expect_test::expect![r#""OK (t t nil t)""#]);
}
...
fn oracle_prop_char_width_basic() {
    ...
    let form = r#"(list (char-width ?a)
                        ...
                        (char-width ?日)
                        (char-width ?é))"#;
    crate::common::assert_oracle_parity_expect(form, expect_test::expect![r#""OK (1 1 8 2 1)""#]);
}
...
fn oracle_prop_char_operations_rot13() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (\"Uryyb, Jbeyq! 42\" t)""#]],
    );
}

...
fn insert_inherit() {
  ...
  (list (get-text-property 3 'face) (get-text-property 1 'face)))"##,
        expect_test::expect![[r#""OK (bold bold)""#]],
    );
}
...
fn prop_field_ops() {
  ...
  (list (field-beginning) (field-end) (field-string)))"##,
        expect_test::expect![[r#""OK (1 4 #(\"aaa\" 0 3 (field f1)))""#]],
    );
}
...
fn propertize_multiple() {
  ...
  (list (get-text-property 0 'face s) (get-text-property 0 'x s)
        ...
        expect_test::expect![[r#""OK (bold 1 (face bold help-echo \"hi\" x 1))""#]],
    );
}
...
fn time_far_future() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (\"2100-01-01\" \"001\" 2100)""#]],
    );
}

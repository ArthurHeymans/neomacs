//! Combo: overlay + marker + textprop + buflocal + narrow + clone + setf + replace + undo + multi-buffer + undo.
...
#[test]
fn combo_overlay_marker_textprop_buflocal_narrow_clone_setf_replace_undo_multi_undo() {
...
#[test]
fn combo_overlay_marker_textprop_buflocal_narrow_clone_replace_setf_undo_multi_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_overlay_marker_textprop_buflocal_narrow_clone_multi_overlay_undo_multi_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_overlay_marker_textprop_buflocal_narrow_clone_textprop_replace_undo_multi_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_overlay_marker_textprop_buflocal_narrow_clone_setf_replace_undo_multi_undo_2() {
    return_if_neovm_enable_oracle_proptest_not_set!();

//! Combo: cl-class-precedence-setf + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests class-precedence-setf with buffer state.

use super::common::assert_oracle_parity;
use super::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_class_precedence_setf_marker_overlay_textprop_buflocal_narrow_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    assert_oracle_parity(
        r#"(progn
  (let ((buf (generate-new-buffer "cps")))
...
#[test]
fn combo_cl_class_precedence_setf_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_class_precedence_setf_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    assert_oracle_parity(
        r#"(progn
  (let ((b1 (generate-new-buffer "cp1"))
        (b2 (generate-new-buffer "cp2")))
...
#[test]
fn combo_cl_class_precedence_setf_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_class_precedence_setf_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

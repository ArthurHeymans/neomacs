//! Combo: cl-add-method-setf + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests add-method-setf with buffer state.

use crate::common::assert_oracle_parity;
use crate::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_add_method_setf_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_add_method_setf_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_add_method_setf_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_add_method_setf_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_add_method_setf_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

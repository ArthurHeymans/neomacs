...
fn divergence_expand_file_name_edge() {
    ...
    let expect = expect_test::expect![[r#""OK (\"[ORACLE-PROJECT-ROOT]/neovm-oracle-tests/foo/baz\" \"/home/exec/test\" \"[ORACLE-PROJECT-ROOT]/neovm-oracle-tests/test\" \"/absolute/path\" t nil)""#]];
    crate::common::assert_oracle_parity_expect(
        r#"(list

//! Combo: cl-typecase + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests type dispatch with buffer state.

use crate::common::assert_oracle_parity;
use crate::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_typecase_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_typecase_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_typecase_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

    let expect = expect_test::expect![[r#""OK t""#]];
    crate::common::assert_oracle_parity_expect(
        r#"(progn
  (let ((b1 (generate-new-buffer "tc1"))
        (b2 (generate-new-buffer "tc2")))
...
#[test]
fn combo_cl_typecase_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_typecase_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

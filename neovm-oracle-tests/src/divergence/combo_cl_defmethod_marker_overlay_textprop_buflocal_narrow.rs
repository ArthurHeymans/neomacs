//! Combo: cl-defmethod + marker + overlay + textprop + buflocal + narrow + undo.
//! Tests defmethod with buffer state.

use crate::common::assert_oracle_parity;
use crate::common::return_if_neovm_enable_oracle_proptest_not_set;

#[test]
fn combo_cl_defmethod_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_defmethod_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_defmethod_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_defmethod_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_defmethod_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

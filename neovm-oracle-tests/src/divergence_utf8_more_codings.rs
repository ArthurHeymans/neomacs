...
"#,
        expect_test::expect![[r#""OK ((164) t 1 1)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK ((146) (147))""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK ((931 932 933) 3)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK ((1072 1073 1094) 3)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK ((164 164 164 229 180 250 184 213) t 8 8)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK ((214 208 206 196 178 226 202 212) t 8)""#]],
    );
}
...
(let* ((s "こんにちは")
  ...
  (list (append e nil) (equal s d) (length e)))
"#,
        expect_test::expect![[r#""OK ((130 177 130 241 130 201 130 191 130 205) t 10)""#]],
    );
}

...
fn oracle_prop_progn_observes_left_to_right_side_effect_order() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK (a b)""#]]);
...
fn oracle_prop_progn_nested_blocks_return_outer_last() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK 40""#]]);
...
fn oracle_prop_progn_macroexpand_shape_from_builder_macro() {
    ...
    let (oracle, neovm) = crate::common::eval_oracle_and_neovm_expect(
        form,
        expect_test::expect![[r#""OK (progn 1 (funcall + 2 3) 4)""#]],
    );
...
fn oracle_prop_progn_nested_progn_inside_macro_then_funcalls() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK (2 12)""#]]);
...
fn oracle_prop_progn_unwind_cleanup_happens_on_throw() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK (7 11)""#]]);
...
fn oracle_prop_progn_nested_error_not_overwritten_by_later_forms() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK caught""#]]);
...
fn oracle_prop_progn_macro_and_defun_multiple_funcall_flow() {
    ...
    let (oracle, neovm) =
        crate::common::eval_oracle_and_neovm_expect(form, expect_test::expect![[r#""OK (3 3)""#]]);
...
fn oracle_prop_progn_macroexpand_nested_progn_shape() {
    ...
    let (oracle, neovm) = crate::common::eval_oracle_and_neovm_expect(
        form,
        expect_test::expect![[r#""OK (progn (setq x 1) (progn (setq x 2)))""#]],
    );
...
fn oracle_prop_progn_nonlocal_exit_with_cleanup_and_post_state() {
    ...
    crate::common::assert_oracle_parity_expect(
        form,
        expect_test::expect![[r#""OK (boom cleaned)""#]],
    );
}

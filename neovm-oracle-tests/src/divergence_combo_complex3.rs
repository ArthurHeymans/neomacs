...
"##,
        expect_test::expect![[r#""OK (5 (4194243 4194217 4194274 4194178 4194220))""#]],
    );
}
...
(let (log)
  ...
  (list log (catch 'inner
              ...
              :not-reached)))
"##,
        expect_test::expect![[r#""OK ((:outer-clean :caught :inner-clean) :inner2)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"hello world\" \"3 + 3 = 6\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (t t 42)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function char-fold-table)""#]],
    );
}
...
(with-temp-buffer
  ...
  (let ((o1 (make-overlay 3 6)) (o2 (make-overlay 8 12)))
    ...
    (list (overlay-start o1) (overlay-end o1)
          ...
          (buffer-string))))
"##,
        expect_test::expect![[r#""ERR (args-out-of-range #<killed buffer> 5 3)""#]],
    );
}
...
(with-temp-buffer
  ...
  (buffer-hash))
"##,
        expect_test::expect![[r#""OK \"fd5a5c98b79d0a4eeebce6933dd52d4f6400611f\"""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((face bold) (face italic))""#]],
    );
}
...
(let ((tbl (make-abbrev-table)))
  ...
  (with-temp-buffer
    ...
    (buffer-string)))
"##,
        expect_test::expect![[r#""OK \"dynamic \"""#]],
    );
}

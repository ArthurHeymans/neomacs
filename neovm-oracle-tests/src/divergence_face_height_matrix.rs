...
fn div_face_height_bold_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'bold-italic :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_ampersand() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-ampersand :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_charset() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-charset :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_coding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-coding :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_condition() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-condition :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_constant() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-constant :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_defcoding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defcoding :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_defface() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defface :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_deficon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-deficon :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_defmacro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defmacro :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_defun() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defun :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_defvar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defvar :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_face() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-face :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_feature() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-feature :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_function() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-function :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_group() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-group :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_icon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-icon :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_macro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-macro :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_oclosure() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-oclosure :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_rx() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-rx :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_slot() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-slot :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_theme() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-theme :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_thing() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-thing :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_throw_tag() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-throw-tag :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_elisp_type() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-type :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_escape_glyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'escape-glyph :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_glyphless_char() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'glyphless-char :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_header_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'header-line :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_highlight() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'highlight :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_homoglyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'homoglyph :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_internal_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'internal-border :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_isearch_fail() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-fail :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_isearch_group_1() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-group-1 :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_isearch_group_2() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-group-2 :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_lazy_highlight() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'lazy-highlight :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_line_number() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'line-number :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_link_visited() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'link-visited :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_next_error() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'next-error :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_nobreak_hyphen() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'nobreak-hyphen :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_nobreak_space() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'nobreak-space :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_query_replace() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'query-replace :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_scroll_bar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'scroll-bar :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_separator_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'separator-line :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_tab_bar_tab() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-bar-tab :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_tab_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_tab_line_active() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line-active :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_tool_bar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tool-bar :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_underline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'underline :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_vc_edited_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-edited-state :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_vc_locked_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-locked-state :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_vc_state_base() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-state-base :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_vertical_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vertical-border :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_height_window_divider() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'window-divider :height)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}

...
"##,
        expect_test::expect![[r#""OK (\"F1\" 80 25)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function frame-iconified-p)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function frame-display)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (void-function frame-parameters-keys)""#]],
    );
}

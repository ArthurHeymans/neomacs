...
"##,
        expect_test::expect![[r#""OK (3 8 12 18 nil 18 18 12 8 3)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (5 15 nil nil 5 5 nil 1)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (nil nil nil 13 17 :y)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (bold bold bold italic italic nil)""#]],
    )
}

...
(let ((lst (list 1 2 3)))
  ...
  lst)
"##,
        expect_test::expect![[r#""ERR (wrong-number-of-arguments (3 . 3) 2)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (wrong-type-argument nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (error nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ([1 2 3] (1 2 3) (97 98) \"ab\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (1 nil :default)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((2 4 6) 6 15)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((1 2) ((1 2) (2 4) (3 6)))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((1 1 2 3 3) ((1 . :a) (1 . :b) (2 . :c)))""#]],
    );
}
...
(list (cl-subseq '(1 2 3 4 5) 1 3)
      ...
      (cl-subseq [1 2 3 4] 2))
"##,
        expect_test::expect![[r#""OK ((2 3) \"ell\" [3 4])""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (10 (1 2 3 . 0))""#]],
    );
}

...
#[test]
fn combo_cl_no_applicable_marker_overlay_textprop_buflocal_narrow_undo() {
...
#[test]
fn combo_cl_no_applicable_clone_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_no_applicable_multi_buffer_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_no_applicable_setf_replace_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();
...
#[test]
fn combo_cl_no_applicable_multi_overlay_undo() {
    return_if_neovm_enable_oracle_proptest_not_set!();

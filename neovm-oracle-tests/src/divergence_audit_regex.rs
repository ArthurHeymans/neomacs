...
(progn (string-match "\(?:a\)\\(b\\)\1" "abb")
       (match-beginning 1)))
"##,
        expect_test::expect![[r#""ERR (invalid-read-syntax \")\" 3 28)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (invalid-read-syntax \")\" 3 49)""#]],
    );
}
...
(progn (string-match "a\\{2\\}" "aaaa")
       (match-end 0)))
"##,
        expect_test::expect![[r#""ERR (invalid-read-syntax \")\" 3 22)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (0 nil 2)""#]],
    );
}
...
(progn (string-match "\\(a\\)\\(b\\)\\(c\\)" "xabc")
       (match-data))
"##,
        expect_test::expect![[r#""OK (1 4 1 2 2 3 3 4)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK \"ba cd ba\"""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK \"[aaa] bb [aaa]\"""#]],
    );
}
...
(replace-regexp-in-string "[0-9]+"
  ...
  "a1b22c333")
"##,
        expect_test::expect![[r#""OK \"a2b23c334\"""#]],
    );
}

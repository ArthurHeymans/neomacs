...
"##,
        expect_test::expect![[r#""OK ((65038 0) (65039 0) (8205 0) (8419 0))""#]],
    )
}
...
(list (string-width "😀")
      ...
      (string-width ""))
"##,
        expect_test::expect![[r#""OK (2 4 14 12 0)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (4 4 4 5)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (8 10 16 17)""#]],
    )
}
...
"##,
        expect_test::expect![[r#""OK (\"hello\" \"café\" \"café世…\" \"😀\")""#]],
    )
}

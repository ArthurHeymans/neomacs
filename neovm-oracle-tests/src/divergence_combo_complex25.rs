...
"##,
        expect_test::expect![[r#""OK (t t 1 0)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (:timer 0)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (wrong-number-of-arguments decode-char 3)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((5 6 10) 11 nil italic)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (t neo-cx25-typed \"café\" 42 t)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (bold italic t underline underline nil)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (t (99 97 102 233 164))""#]],
    );
}
...
(let ((lexical-binding t))
  (macrolet ((double (x) (list '+ x x)))
    (let ((f (lambda (n) (double n))))
      (funcall f 21))))
"##,
        expect_test::expect![[r#""ERR (void-function macrolet)""#]],
    );
}
...
(progn
  ...
  (match-data))
"##,
        expect_test::expect![[r#""ERR (wrong-type-argument listp [0 0 0 0])""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (1 1 1 1 8 1 1 2 2 2 2 0 0 1)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (6 11 6 \"café世界\")""#]],
    );
}
...
(with-temp-buffer
  ...
  (list (window-start)
        ...
        (window-start)))
"##,
        expect_test::expect![[r#""OK (1 1 36 1)""#]],
    );
}
...
(with-temp-buffer
  ...
  (list (buffer-string)
        ...
        (get-char-property 4 'face)))
"##,
        expect_test::expect![[r#""OK (\"AAAAXYZBBBB\" 1 nil)""#]],
    );
}

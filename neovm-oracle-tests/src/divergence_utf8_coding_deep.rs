...
"#,
        expect_test::expect![[r#""OK (3 6 (239 187 191 97 98 99) 6)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (8 8 (239 187 191 99 97 102 195 169))""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (3 3 (97 98 99))""#]],
    );
}
...
(let ((e (encode-coding-string "AB" 'utf-16)))
  (list (length e) (string-bytes e) (append e nil)))
"#,
        expect_test::expect![[r#""OK (6 6 (254 255 0 65 0 66))""#]],
    );
}
...
(let ((e (encode-coding-string "AB" 'utf-16le)))
  (list (length e) (string-bytes e) (append e nil)))
"#,
        expect_test::expect![[r#""OK (4 4 (65 0 66 0))""#]],
    );
}
...
(let ((e (encode-coding-string "AB" 'utf-16be)))
  (list (length e) (string-bytes e) (append e nil)))
"#,
        expect_test::expect![[r#""OK (4 4 (0 65 0 66))""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (6 (254 255 216 61 222 0))""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (4 8 (4194176 4194177 4194248 4194303))""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (3 5 (97 4194248 233))""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (200 4194248 eight-bit)""#]],
    );
}

...
fn bidi_class() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (L R EN)""#]],
    );
}
...
fn char_script() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (latin han greek)""#]],
    );
}
...
fn char_width_scripts() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (1 2 1 0 1 4)""#]],
    );
}
...
fn decomposition() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK ((101 769) (65) (compat 102 105))""#]],
    );
}
...
fn general_category() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (Lu Ll Nd Zs Po)""#]],
    );
}
...
fn mirroring_canonical() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (41 0 230)""#]],
    );
}
...
fn numeric_value() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK (5 12 0.5)""#]],
    );
}

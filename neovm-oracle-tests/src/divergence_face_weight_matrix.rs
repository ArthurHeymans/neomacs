...
fn div_face_weight_bold_italic() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'bold-italic :weight)",
        expect_test::expect![[r#""OK bold""#]],
    );
}
...
fn div_face_weight_default() {
    ...
    crate::common::assert_oracle_parity_expect(
        ...
        expect_test::expect![[r#""OK normal""#]],
    );
}
...
fn div_face_weight_elisp_ampersand() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-ampersand :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_charset() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-charset :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_coding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-coding :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_condition() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-condition :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_constant() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-constant :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_defcoding() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defcoding :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_defface() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defface :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_deficon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-deficon :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_defmacro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defmacro :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_defun() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defun :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_defvar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-defvar :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_face() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-face :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_feature() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-feature :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_function() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-function :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_group() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-group :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_icon() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-icon :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_macro() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-macro :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_oclosure() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-oclosure :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_rx() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-rx :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_slot() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-slot :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_theme() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-theme :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_thing() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-thing :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_throw_tag() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-throw-tag :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_elisp_type() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'elisp-type :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_escape_glyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'escape-glyph :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_fixed_pitch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'fixed-pitch :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_glyphless_char() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'glyphless-char :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_header_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'header-line :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_highlight() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'highlight :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_homoglyph() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'homoglyph :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_internal_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'internal-border :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_isearch_fail() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-fail :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_isearch_group_1() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-group-1 :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_isearch_group_2() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'isearch-group-2 :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_lazy_highlight() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'lazy-highlight :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_line_number() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'line-number :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_link_visited() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'link-visited :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_mode_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'mode-line :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_next_error() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'next-error :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_nobreak_hyphen() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'nobreak-hyphen :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_nobreak_space() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'nobreak-space :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_query_replace() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'query-replace :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_scroll_bar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'scroll-bar :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_separator_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'separator-line :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_tab_bar_tab() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-bar-tab :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_tab_line() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_tab_line_active() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tab-line-active :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_tool_bar() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'tool-bar :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_underline() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'underline :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_variable_pitch() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'variable-pitch :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_vc_edited_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-edited-state :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_vc_locked_state() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-locked-state :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_vc_state_base() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vc-state-base :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_vertical_border() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'vertical-border :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}
...
fn div_face_weight_window_divider() {
    return_if_neovm_enable_oracle_proptest_not_set!();
    crate::common::assert_oracle_parity_expect(
        "(face-attribute 'window-divider :weight)",
        expect_test::expect![[r#""OK unspecified""#]],
    );
}

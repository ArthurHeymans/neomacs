...
"##,
        expect_test::expect![[r#""OK (\"M-x\" \"M-c\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"C-x\" \"C-c\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"S-a\" \"S-z\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"C-M-x\" \"C-M-c\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"H-x\" \"H-a\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"s-x\" \"s-a\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (\"A-x\" \"A-a\")""#]],
    );
}
...
"##,
        expect_test::expect![[r#""ERR (invalid-read-syntax \")\" 2 38)""#]],
    );
}
...
fn div_cx512_char_to_string_modifiers() {
    ...
    crate::common::assert_oracle_parity_expect(
      ...
      (char-to-string ?\s-x))
"##,
        expect_test::expect![[r#""ERR (wrong-type-argument characterp 134217848)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (120 (meta) 134217848)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (6 134217848 134217734)""#]],
    );
}

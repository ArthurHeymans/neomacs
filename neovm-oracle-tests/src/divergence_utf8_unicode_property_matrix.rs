...
"#,
        expect_test::expect![[r#""OK (nil nil nil nil nil nil nil nil nil nil)""#]],
    );
}
...
"#,
        expect_test::expect![[r#""OK (0 5 9 0 1 0 0 1 4)""#]],
    );
}
...
(list (mapcar (lambda (c) (get-char-code-property c 'simple-lowercase))
      ...
      (mapcar (lambda (c) (get-char-code-property c 'simple-uppercase))
              (list ?a ?é ?\x3b1 ?\x430)))
"#,
        expect_test::expect![[r#""OK ((nil nil nil nil) (nil nil nil nil))""#]],
    );
}

...
"##,
        expect_test::expect![[r#""OK (\"AAfile-contentB\" 3 18)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (4194304 args-out-of-range args-out-of-range)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (128 127 255 256 4194303 57344 63743)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (6 4194208 4194209 4194248 eight-bit eight-bit)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((99 . :child-override) (122 . :parent-single))""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (3 13 \"23456789AB\" nil 1)""#]],
    );
}
...
(progn
  ...
  (let (log)
    ...
    (car log)))
"##,
        expect_test::expect![[r#""OK :b-first""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK \"send-meB\"""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK (nil nil italic italic 18)""#]],
    );
}
...
"##,
        expect_test::expect![[r#""OK ((9 1) 5 60)""#]],
    );
}

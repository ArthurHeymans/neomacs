...
impl LoopMode {
    ...
    pub(crate) fn consume_replay(&mut self) -> bool {
        match *self {
            Self::Off => false,
            Self::Infinite => true,
...
impl VideoSampling {
    pub(crate) fn allocation_bytes(self, geometry: VideoGeometry) -> Result<usize, String> {
...
/// Command accepted by [`crate::VideoSystem`].
#[derive(Debug, Clone, PartialEq)]
...
impl FrameTransferPolicy {
    pub(crate) const fn permits(self, path: VideoTransferPath) -> bool {
        match self {

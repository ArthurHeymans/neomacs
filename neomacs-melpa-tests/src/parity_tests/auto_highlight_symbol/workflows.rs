...
fn auto_highlight_symbol_practical_lisp_highlight_navigate_and_rename_workflow_matches() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_practical_face_rules_highlight_code_but_ignore_comments_and_strings() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_two_buffers_keep_ranges_overlays_edits_and_mode_state_independent() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_definition_plugin_limits_real_highlighting_to_current_function() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_case_insensitive_highlight_and_navigation_preserve_case_variants() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_window_switch_rehighlight_workflow_uses_each_window_point() -> ParityBatchCase {
    ParityBatchCase::new(

...
use super::{assert_auto_highlight_symbol_autoload_parity, assert_auto_highlight_symbol_parity};
...
#[test]
fn auto_highlight_symbol_installed_payload_inventory_and_exact_hashes_match() {
    let elisp_form = r##"(let* ((descriptor
                                 (cadr
                                  (assq
                                   'auto-highlight-symbol
...
#[test]
fn auto_highlight_symbol_complete_prefixed_symbol_inventory_matches() {
...
#[test]
fn auto_highlight_symbol_faces_obsolete_alias_and_mode_map_bindings_match() {
...
#[test]
fn auto_highlight_symbol_generated_autoload_contract_and_real_activation_match() {
    let elisp_form = r##"(let* ((history
                                 (seq-find
                                  (lambda (entry)
                                    (and
    ...
    assert_auto_highlight_symbol_autoload_parity(elisp_form, expect);
}

#[test]
fn auto_highlight_symbol_exact_ht_and_dash_dependency_versions_are_loaded() {
    let elisp_form = r##"(mapcar
                           (lambda (package)
                             (let ((descriptor
                                    (cadr

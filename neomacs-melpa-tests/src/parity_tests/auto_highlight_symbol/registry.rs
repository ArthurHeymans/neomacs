...
use super::{ParityBatchCase, assert_auto_highlight_symbol_autoload_batch, assert_auto_highlight_symbol_batch};

fn auto_highlight_symbol_exact_package_descriptor_provenance_and_dependencies_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_public_commands_arglists_interactivity_docs_and_origins_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_custom_defaults_types_standard_values_and_locality_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_highlight_symbol_source_history_records_requires_plugins_definitions_and_feature() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_auto_highlight_symbol_batch() {
...
#[test]
fn registry_auto_highlight_symbol_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        auto_highlight_symbol_generated_autoload_contract_and_real_activation_match(),
    ];

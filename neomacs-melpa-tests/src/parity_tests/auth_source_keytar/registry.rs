...
use super::{ParityBatchCase, assert_auth_source_keytar_autoload_batch, assert_auth_source_keytar_batch};
...
fn auth_source_keytar_installed_payload_matches_exact_melpa_archive_files_and_hashes() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_keytar_complete_prefixed_symbol_inventory_records_every_public_and_private_surface() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_keytar_source_load_history_records_requires_definitions_and_feature() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_keytar_source_reload_redefines_functions_preserves_group_and_deduplicates_hook() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_keytar_generated_autoload_registers_enable_without_loading_runtime_dependencies() -> ParityBatchCase {
    ParityBatchCase::new(

...
use super::{assert_auth_source_keytar_autoload_parity, assert_auth_source_keytar_parity};

#[test]
fn auth_source_keytar_exact_package_descriptor_and_origin_contract_match() {
...
#[test]
fn auth_source_keytar_all_callable_arglists_commands_docs_and_sources_are_exact() {
...
#[test]
fn auth_source_keytar_custom_group_prefix_parent_and_documentation_are_exact() {
...
#[test]
fn auth_source_keytar_exact_runtime_dependency_pins_are_active_and_loaded() {
    let elisp_form = r##"(mapcar
          (lambda (package)
            (let ((descriptor
                   (cadr
...
fn auth_source_keytar_generated_autoload_registers_enable_without_loading_runtime_dependencies() {
    ...
    assert_auth_source_keytar_autoload_parity(elisp_form, expect);
}
    ...
    let elisp_form = r##"(let ((source
          ...
          (let ((reloaded-search
            ...
            (list
             ...
             (featurep
              'auth-source-keytar))))"##;
    let expect = expect![[r#"OK (nil nil "Keytar integration within auth-source." 1 t)"#]];

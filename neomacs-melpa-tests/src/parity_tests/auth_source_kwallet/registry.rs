...
use super::{ParityBatchCase, assert_auth_source_kwallet_autoload_batch, assert_auth_source_kwallet_batch};

fn auth_source_kwallet_exact_package_descriptor_origin_and_dependency_contract_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_kwallet_installed_payload_inventory_and_exact_archive_hashes_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_kwallet_source_reload_preserves_every_user_assignment_and_backend_state() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_kwallet_custom_setters_accept_runtime_configuration_and_restore_defaults() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auth_source_kwallet_generated_autoload_performs_real_package_activation_workflow() -> ParityBatchCase {
    ParityBatchCase::new(

...
use super::{assert_aider_helm_parity, assert_aider_parity};

#[test]
fn aider_markdown_safety_advice_contains_failures_only_inside_aider_mode() {
...
#[test]
fn aider_highlight_refinement_creates_and_clears_real_diff_overlays() {
...
#[test]
fn aider_git_branch_resolution_and_diff_parameter_workflows_match() {
...
#[test]
fn aider_real_git_staged_diff_generation_writes_expected_patch() {
    let elisp_form = r##"(let* ((root (expand-file-name "git-diff"
...
#[test]
fn aider_log_prompt_builders_cover_keyword_and_whole_repository_analysis() {
...
#[test]
fn aider_question_and_code_read_workflows_build_contextual_commands() {
    let elisp_form = r##"(let (calls)
         (cl-letf (((symbol-function 'aider-read-string)
...
fn aider_model_selection_sends_model_then_reasoning_effort_for_openai_models_only() {
    let elisp_form = r##"(let (sent messages answers)
...
#[test]
fn aider_helm_history_merges_cli_candidates_and_persists_latest_input() {
    ...
    assert_aider_helm_parity(elisp_form, expect);
}

...
fn auto_dim_other_buffers_every_callable_arglist_interactivity_doc_and_source_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_dim_other_buffers_every_custom_option_default_type_setter_and_source_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_dim_other_buffers_source_reload_preserves_configuration_and_runtime_state() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_dim_other_buffers_generated_autoload_exposes_mode_and_custom_metadata_before_activation() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_auto_dim_other_buffers_batch() {
...
#[test]
fn registry_auto_dim_other_buffers_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        auto_dim_other_buffers_generated_autoload_exposes_mode_and_custom_metadata_before_activation(),
    ];

...
#[test]
fn auto_dim_other_buffers_exact_descriptor_and_archive_payload_bytes_match() {
...
#[test]
fn auto_dim_other_buffers_complete_prefixed_symbol_inventory_matches() {
...
#[test]
fn auto_dim_other_buffers_customize_group_faces_and_obsolete_aliases_match() {
...
#[test]
fn auto_dim_other_buffers_internal_state_hook_advice_and_locality_metadata_match() {
    let elisp_form = r##"(mapcar
          (lambda (symbol)
            (list
             symbol
...
#[test]
fn auto_dim_other_buffers_source_load_history_records_complete_definition_order() {

...
use super::{assert_atom_dark_theme_autoload_batch, assert_atom_dark_theme_batch};

#[test]
fn registry_atom_dark_theme_batch() {
    assert_atom_dark_theme_batch(&[
        (
...
#[test]
fn registry_atom_dark_theme_autoload_batch() {
    assert_atom_dark_theme_autoload_batch(&[
        (

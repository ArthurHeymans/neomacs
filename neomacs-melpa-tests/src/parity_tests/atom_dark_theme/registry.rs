...
use super::{assert_atom_dark_theme_autoload_parity, assert_atom_dark_theme_parity};
...
fn atom_dark_theme_exact_package_descriptor_origin_dependency_and_feature_contract_match() {
    ...
    assert_atom_dark_theme_parity(elisp_form, expect);
}
...
#[test]
fn atom_dark_theme_registration_documentation_feature_and_initial_state_match() {
...
#[test]
fn atom_dark_theme_complete_callable_command_arglist_and_source_surface_matches() {
...
#[test]
fn atom_dark_theme_setting_inventory_has_exact_source_shape_order_and_uniqueness() {
...
fn atom_dark_theme_source_reloads_accumulate_settings_but_deduplicate_hook_and_load_path() {
    ...
    let expect = expect!["OK ((196 preserve-user-choice 1 1) (294 preserve-user-choice 1 1))"];
...
fn atom_dark_theme_generated_autoload_registers_paths_prefix_and_feature_without_loading_source() {
    ...
    assert_atom_dark_theme_autoload_parity(elisp_form, expect);
}

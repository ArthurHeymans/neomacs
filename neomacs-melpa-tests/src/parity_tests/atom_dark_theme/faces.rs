...
use super::assert_atom_dark_theme_parity;

#[test]
fn atom_dark_theme_basic_face_specs_match_every_selector_color_font_and_attribute() {
    let elisp_form = r##"(atom-dark-test-theme-specs
         '(button
           cursor
           default
           escape-glyph
...
#[test]
fn atom_dark_theme_font_lock_specs_match_every_literal_and_inheritance_edge() {
    let elisp_form = r##"(atom-dark-test-theme-specs
...
#[test]
fn atom_dark_theme_mode_line_search_and_ido_specs_match_all_display_fallbacks() {
    let elisp_form = r##"(atom-dark-test-theme-specs
         '(mode-line
           mode-line-buffer-id
           mode-line-emphasis
...
#[test]
fn atom_dark_theme_whitespace_specs_match_empty_trailing_and_all_derived_faces() {
    let elisp_form = r##"(atom-dark-test-theme-specs
         '(whitespace-empty
           whitespace-hspace
...
fn atom_dark_theme_palette_literals_and_inheritance_targets_are_complete_and_stable() {
    let elisp_form = r##"(let (colors inherits)
         (dolist
             (setting
              (get 'atom-dark 'theme-settings))
           (dolist

...
fn atom_dark_theme_basic_face_specs_match_every_selector_color_font_and_attribute() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atom_dark_theme_diff_dired_guide_key_and_flx_specs_match_optional_face_contracts() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atom_dark_theme_markdown_and_js2_specs_match_practical_language_face_contracts() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atom_dark_theme_minimap_powerline_realgud_and_speedbar_specs_match_ui_integrations() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atom_dark_theme_company_specs_match_preview_scrollbar_tooltip_and_selection_edges() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atom_dark_theme_all_ninety_eight_specs_have_nonempty_selectors_and_stable_attribute_shapes() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atom_dark_theme_palette_literals_and_inheritance_targets_are_complete_and_stable() -> ParityBatchCase {
    ParityBatchCase::new(

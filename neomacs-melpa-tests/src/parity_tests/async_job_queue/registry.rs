...
use super::{assert_async_job_queue_autoload_parity, assert_async_job_queue_parity};

#[test]
fn exact_archive_metadata_dependencies_and_source_identity_match_the_pin() {
    let elisp_form = r##"
(let* ((description
        (cadr
...
#[test]
fn every_declared_queue_callable_has_the_exact_kind_and_argument_list() {
    let elisp_form = r##"
(mapcar
 (lambda (symbol)
   (list
...
#[test]
fn table_struct_registry_covers_constructor_predicate_copy_and_every_accessor() {
    let elisp_form = r##"
(mapcar
 (lambda (symbol)
   (list
...
#[test]
fn queue_slot_and_job_struct_registries_cover_every_generated_callable() {
    let elisp_form = r##"
(mapcar
 (lambda (group)
   (mapcar
...
#[test]
fn customization_conditions_group_and_generated_autoload_state_are_exact() {
    let elisp_form = r##"
(let* ((standard-values
        (get

...
use super::{ParityBatchCase, assert_anti_zenburn_theme_batch};

fn editing_a_real_lisp_file_switches_to_anti_zenburn_and_restores_the_baseline_theme() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn completing_a_real_org_runbook_keeps_the_saved_document_and_visual_structure_exact() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn reviewing_a_real_patch_refines_changed_text_highlights_audit_notes_and_keeps_selection_state() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn reading_a_real_ansi_build_log_applies_diagnostics_without_overwriting_the_source_file() -> ParityBatchCase {
    ParityBatchCase::new(

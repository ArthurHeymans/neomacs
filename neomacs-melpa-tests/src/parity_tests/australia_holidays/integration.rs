...
fn australia_holidays_real_list_holidays_renders_victorian_multi_year_schedule_and_label() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_custom_january_label_flows_into_real_rendered_holiday_buffer() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_can_append_to_existing_calendar_rules_without_losing_order_or_collisions() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_calendar_list_holidays_builds_real_three_month_boundary_buffer() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_holiday_in_range_is_inclusive_for_single_day_and_cross_month_queries() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_every_region_keeps_christmas_related_rules_on_literal_weekend_dates() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_bad_rule_isolated_by_calendar_engine_while_valid_package_rules_still_render() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn integration_public_surface_batch() {

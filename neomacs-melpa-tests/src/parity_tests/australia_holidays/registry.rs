...
use super::{assert_australia_holidays_autoload_parity, assert_australia_holidays_parity};
...
#[test]
fn australia_holidays_installed_payload_inventory_and_exact_archive_hashes_match() {
...
#[test]
fn australia_holidays_complete_customization_defaults_and_metadata_match() {
...
#[test]
fn australia_holidays_all_national_state_and_territory_rule_forms_match_exactly() {
    let elisp_form = r##"(mapcar
                          (lambda (symbol)
                            (list
                             symbol
...
fn australia_holidays_regional_lists_preserve_exact_symbolic_and_shared_element_topology() {
    let elisp_form = r##"(let ((regional-symbols
                                '(australia-holidays-for-nsw
                                  australia-holidays-for-nt
                                  australia-holidays-for-qld
                                  australia-holidays-for-sa

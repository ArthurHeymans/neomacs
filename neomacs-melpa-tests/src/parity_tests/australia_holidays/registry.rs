...
use super::{ParityBatchCase, assert_australia_holidays_autoload_batch, assert_australia_holidays_batch};

fn australia_holidays_exact_package_descriptor_origin_and_dependency_contract_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_regional_lists_preserve_exact_symbolic_and_shared_element_topology() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_source_reload_preserves_every_user_assignment_and_feature_state() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn australia_holidays_generated_autoloads_define_all_options_and_rule_lists_without_loading_package() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_australia_holidays_batch() {
...
#[test]
fn registry_australia_holidays_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        australia_holidays_generated_autoloads_define_all_options_and_rule_lists_without_loading_package(),
    ];

...
use super::assert_australia_holidays_parity;
...
#[test]
fn australia_holidays_nsw_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_nt_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_qld_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_sa_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_tas_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_vic_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_wa_2025_calendar_matches_practical_full_year_schedule() {
    let elisp_form = r##"(australia-holidays-test-year
...
#[test]
fn australia_holidays_nsw_keeps_duplicate_anzac_rule_and_calendar_results() {
    let elisp_form = r##"(list
                          (seq-filter
                           (lambda (rule)
                             (equal
...
fn australia_holidays_act_tracks_reassigned_national_list_while_copied_state_lists_do_not() {
    let elisp_form = r##"(let ((original-national
                                (copy-tree
                                 australia-holidays))
                               (original-nsw-prefix
                                (seq-take
...
fn australia_holidays_mutating_shared_national_rule_object_updates_every_copied_state_list() {
    let elisp_form = r##"(let ((base-rule

...
use super::{assert_atcoder_tools_autoload_parity, assert_atcoder_tools_parity};

#[test]
fn atcoder_tools_descriptor_and_archive_sources_pin_exact_melpa_payload() {
...
#[test]
fn atcoder_tools_activates_exact_pinned_dependency_closure_and_source_digests() {
...
#[test]
fn atcoder_tools_complete_prefixed_symbol_inventory_records_every_surface() {
...
#[test]
fn atcoder_tools_all_functions_have_exact_call_and_documentation_contracts() {
...
#[test]
fn atcoder_tools_customization_schema_defaults_and_group_are_exact() {
...
#[test]
fn atcoder_tools_run_configuration_table_is_exact_and_independently_copyable() {
...
#[test]
fn atcoder_tools_generated_autoload_exposes_only_public_interactive_commands() {
    ...
    assert_atcoder_tools_autoload_parity(elisp_form, expect);
}

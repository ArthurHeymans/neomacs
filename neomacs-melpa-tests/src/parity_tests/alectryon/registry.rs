...
use super::{ParityBatchCase, assert_alectryon_autoload_batch, assert_alectryon_batch};
...
fn alectryon_installed_runtime_payload_is_minimal_exact_and_does_not_vendor_project_assets() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_alectryon_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        alectryon_autoloads_register_only_supported_programming_mode_hooks(),
    ];

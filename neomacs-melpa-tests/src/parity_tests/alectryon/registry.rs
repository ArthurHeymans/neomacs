...
use super::{assert_alectryon_autoload_parity, assert_alectryon_parity};

#[test]
fn alectryon_registers_its_complete_callable_surface_with_exact_signatures() {
...
#[test]
fn alectryon_registers_exact_configuration_constants_faces_and_custom_contract() {
...
#[test]
fn alectryon_keymaps_menu_and_flycheck_checker_form_one_practical_ui_contract() {
    let elisp_form = r##"(list
...
fn alectryon_installed_payload_is_minimal_exact_and_does_not_vendor_project_assets() {
  ...
  (list
   ...
   (seq-filter
    ...
    files)))"##;
    let expect = expect![[
        r#"OK (("README-elpa" "alectryon-autoloads.el" "alectryon-pkg.el" "alectryon-tests.el" "alectryon-tests.elc" "alectryon.el" "alectryon.elc") (("README-elpa" 1049 t) ("alectryon-autoloads.el" 1949 t) ("alectryon-pkg.el" 500 t) ("alectryon-tests.el" 16343 t) ("alectryon-tests.elc" 61366 t) ("alectryon.el" 29000 t) ("alectryon.elc" 35708 t)) nil)"#
    ]];
    assert_alectryon_parity(elisp_form, expect);
}

#[test]
fn alectryon_autoloads_register_only_supported_programming_mode_hooks() {
    let elisp_form = r##"(list
 (featurep 'alectryon)
 ...
 (featurep 'flycheck))"##;
    ...
    assert_alectryon_autoload_parity(elisp_form, expect);
}

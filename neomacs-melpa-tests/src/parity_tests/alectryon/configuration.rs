...
fn alectryon_exhaustively_maps_every_code_and_markup_pair_to_cli_frontends_and_backends() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn alectryon_configuration_exposes_exact_delimiters_annotations_lint_and_exit_hooks() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn alectryon_mode_setters_update_configuration_and_switch_the_current_view_when_needed() -> ParityBatchCase {
    ParityBatchCase::new(

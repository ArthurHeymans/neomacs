...
#[test]
fn real_emacs_lisp_font_lock_exercises_all_five_theme_highlighting_philosophies() {
    let elisp_form = r##"
(progn
...
#[test]
fn real_org_document_resolves_titles_todos_links_blocks_and_metadata_faces() {
    let elisp_form = r##"
(progn
  (require 'org)
  (mapc #'disable-theme custom-enabled-themes)
...
#[test]
fn real_diff_buffer_applies_file_hunk_added_removed_context_and_refined_faces() {
    let elisp_form = r##"
(progn
  (require 'diff-mode)
  (mapc #'disable-theme custom-enabled-themes)
...
#[test]
fn real_dired_listing_applies_directory_symlink_mark_and_flag_workflow_faces() {
    let elisp_form = r##"
(progn
  (require 'dired)
  (mapc #'disable-theme custom-enabled-themes)
...
#[test]
fn semantic_terminal_palette_drives_real_ansi_color_rendering_for_each_variant() {
    let elisp_form = r##"
(progn
  (require 'ansi-color)
  (mapc #'disable-theme custom-enabled-themes)

...
use super::{assert_alabaster_themes_autoload_batch, assert_alabaster_themes_batch};

#[test]
fn registry_alabaster_themes_batch() {
...
#[test]
fn registry_alabaster_themes_autoload_batch() {
    assert_alabaster_themes_autoload_batch(&[
        (

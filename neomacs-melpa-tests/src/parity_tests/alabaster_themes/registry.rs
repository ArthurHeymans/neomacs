...
use super::{assert_alabaster_themes_autoload_parity, assert_alabaster_themes_parity};

#[test]
fn exact_release_public_collections_commands_and_customization_surface() {
    let elisp_form = r##"
(let* ((descriptor
...
#[test]
fn every_theme_file_loads_without_enabling_and_registers_complete_metadata() {
    let elisp_form = r##"
...
#[test]
fn strengthened_upstream_smoke_contract_covers_all_variants_palettes_and_faces() {
    let elisp_form = r##"
(progn
  (mapc
   (lambda (theme)

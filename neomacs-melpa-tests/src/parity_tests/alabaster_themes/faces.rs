...
fn no_bold_customization_rebuilds_actual_theme_specs_without_residual_inheritance() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn face_spec_selection_distinguishes_low_color_and_256_color_terminals_and_graphics() -> ParityBatchCase {
    ParityBatchCase::new(

...
#[test]
fn every_palette_has_complete_unique_ordered_and_fingerprinted_entries() {
    let elisp_form = r##"
(progn
  (mapc
   (lambda (theme)
...
#[test]
fn semantic_palette_mappings_recursively_resolve_for_all_five_variants() {
    let elisp_form = r##"
(progn
  (mapc
   (lambda (theme)
...
#[test]
fn terminal_foreground_and_background_slots_resolve_to_practical_ansi_tables() {
    let elisp_form = r##"
(progn
  (mapc
   (lambda (theme)
...
#[test]
fn palette_lookup_handles_literals_nested_aliases_unspecified_and_missing_keys() {
    let elisp_form = r##"
(let ((palette
       '((literal "#123456")
         (alias literal)
...
#[test]
fn per_theme_overrides_precede_common_overrides_without_mutating_base_palette() {
    let elisp_form = r##"
(progn
...
#[test]
fn palette_preview_rows_preserve_mapping_status_values_and_color_properties() {
    let elisp_form = r##"
(progn
  (load-theme 'alabaster-themes-light t t)
  (let* ((all
...
#[test]
fn heading_customization_combines_fallbacks_weights_pitch_heights_and_no_bold() {
    let elisp_form = r##"
(let ((cases
       '((nil nil)
...
#[test]
fn font_option_helpers_cover_every_toggle_combination_without_hidden_state() {
    let elisp_form = r##"
(mapcar
 (lambda (case)

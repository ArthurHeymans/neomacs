...
fn auth_source_1password_search_builds_exact_default_cli_command_and_trims_secret() {
    let elisp_form = r##"(let (find-calls commands)
          (cl-letf
...
#[test]
fn auth_source_1password_search_trims_only_outer_whitespace_across_real_outputs() {
...
#[test]
fn auth_source_1password_search_empty_cli_output_is_a_present_empty_secret() {
            ...
            (list
             ...
             (equal
              (plist-get
               ...
               :secret)
              ""))))"##;
    let expect = expect![[r#"OK ((#1=(:user nil . #2=(:secret ""))) 1 #1# #2# t)"#]];
...
fn auth_source_1password_search_missing_executable_warns_once_and_skips_all_secret_work() {
    let elisp_form = r##"(let (events warnings)
          (let ((auth-source-1password-executable
                 "missing-op")
                (auth-source-1password-construct-secret-reference
...
#[test]
fn auth_source_1password_search_propagates_executable_lookup_and_shell_failures() {
...
#[test]
fn auth_source_1password_real_fake_cli_receives_read_and_one_reference_argument() {

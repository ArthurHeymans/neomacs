...
fn auto_read_only_entry_points_pin_interactive_arglist_and_documentation_contracts() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_read_only_reload_preserves_custom_values_mode_state_and_hook_registration() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_read_only_generated_autoloads_register_both_commands_without_loading_source() -> ParityBatchCase {
    ParityBatchCase::new(

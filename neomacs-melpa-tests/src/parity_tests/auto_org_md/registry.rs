...
use super::{assert_auto_org_md_autoload_parity, assert_auto_org_md_parity};

#[test]
fn auto_org_md_loads_exact_features_and_public_surface() {
...
#[test]
fn auto_org_md_public_arglists_and_interactive_contract_are_exact() {
...
#[test]
fn auto_org_md_minor_mode_variable_properties_are_exact() {
    let elisp_form = r##"(list
         auto-org-md-mode
...
#[test]
fn auto_org_md_mode_registry_has_exact_lighter_keymap_and_hook() {
    let elisp_form = r##"(list
    ...
    let expect = expect![[r#"OK ((auto-org-md-mode "org-md") nil nil nil t nil)"#]];
    assert_auto_org_md_parity(elisp_form, expect);
}

#[test]
fn auto_org_md_package_descriptor_matches_pinned_archive() {
    let elisp_form = r##"(let* ((entry (assq 'auto-org-md package-alist))
...
#[test]
fn auto_org_md_load_history_records_all_definitions_and_provide() {
    let elisp_form = r##"(let* ((entry
         ...
         (list
          ...
          (cl-count
           ...
           definitions
           :test #'equal)))"##;
    let expect = expect![[r#"OK ("auto-org-md.el" (nil nil nil nil nil) 1)"#]];
    assert_auto_org_md_parity(elisp_form, expect);
}

#[test]
fn auto_org_md_autoloads_expose_export_without_loading_runtime() {
    let elisp_form = r##"(list
         (featurep 'auto-org-md)
         (autoloadp
    ...
    assert_auto_org_md_autoload_parity(elisp_form, expect);
}

#[test]
fn auto_org_md_autoloads_expose_minor_mode_metadata_without_loading_runtime() {
    let elisp_form = r##"(list
         (featurep 'auto-org-md)
...
#[test]
fn auto_org_md_autoload_invocation_loads_runtime_and_installs_local_hook() {
             ...
             (cl-letf (((symbol-function 'message)
               ...
               (list
                ...
                (memq 'auto-org-md-export
                      after-save-hook)
                (nreverse messages))))))"##;
    let expect = expect![[r#"OK (t t t t (auto-org-md-export t) ("auto-org-md-mode is on."))"#]];
    assert_auto_org_md_autoload_parity(elisp_form, expect);
}

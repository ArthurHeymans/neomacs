...
use super::{ParityBatchCase, assert_asilea_autoload_batch, assert_asilea_batch};
...
fn asilea_generated_autoload_file_exposes_run_entrypoints_without_loading_feature() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_asilea_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        asilea_generated_autoload_file_exposes_run_entrypoints_without_loading_feature(),
    ];

...
#[test]
fn asilea_default_acceptance_always_accepts_lower_energy_for_unit_interval_draws() {
...
#[test]
fn asilea_default_acceptance_equal_energy_uses_strict_comparison_at_one() {
    let elisp_form = r##"(mapcar
         (lambda (draw)
           (list
            draw
    ...
    let expect = expect!["OK ((0.0 t) (0.5 t) (0.999999 t) (1.0 nil) (1.5 nil) (-1.0 t))"];
...
#[test]
fn asilea_default_acceptance_calls_random_function_once_with_float_limit() {

...
#[test]
fn loading_the_theme_enables_it_and_disabling_it_puts_the_editor_back() {
    let elisp_form = r##"
...
#[test]
fn on_a_display_below_eighty_nine_colours_only_the_ungated_faces_reach_the_user() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient-one-dark t)
  (list
...
#[test]
fn the_theme_registers_two_hundred_and_two_face_specs_and_fifteen_colours() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient-one-dark t)
...
#[test]
fn a_package_whose_faces_the_theme_styles_picks_them_up_when_it_is_loaded_later() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient-one-dark t)
...
#[test]
fn fontifying_a_real_emacs_lisp_buffer_uses_faces_the_theme_has_a_colour_for() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient-one-dark t)
  (with-temp-buffer
...
#[test]
fn five_specs_upstream_wrote_wrong_are_registered_exactly_as_written() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient-one-dark t)
  (list

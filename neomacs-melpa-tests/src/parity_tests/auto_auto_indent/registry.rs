...
use super::{assert_auto_auto_indent_autoload_parity, assert_auto_auto_indent_parity};

#[test]
fn auto_auto_indent_exact_package_descriptor_origin_and_dependencies_match() {
...
#[test]
fn auto_auto_indent_installed_payload_inventory_and_exact_archive_hashes_match() {
    let elisp_form = r##"(let* ((descriptor
                                 (cadr
                                  (assq
                                   'auto-auto-indent
...
#[test]
fn auto_auto_indent_complete_prefixed_symbol_inventory_matches() {
...
#[test]
fn auto_auto_indent_all_variable_defaults_aliases_and_locality_match() {
    let elisp_form = r##"(mapcar
          (lambda (symbol)
            (let ((value
                   (and
...
#[test]
fn auto_auto_indent_exact_es_lib_dependency_is_active_and_loaded() {
    let elisp_form = r##"(mapcar
          (lambda (package)
            (let ((descriptor
                   (cadr
...
fn auto_auto_indent_generated_autoload_exposes_only_mode_without_loading_dependencies() {
    ...
    assert_auto_auto_indent_autoload_parity(elisp_form, expect);
}

#[test]
fn auto_auto_indent_generated_autoload_performs_real_mode_activation_workflow() {

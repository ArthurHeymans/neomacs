...
use super::{ParityBatchCase, assert_auto_auto_indent_autoload_batch, assert_auto_auto_indent_batch};
...
fn auto_auto_indent_complete_callable_arglists_interactivity_docs_and_origins_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_auto_indent_source_load_history_records_requires_definitions_aliases_and_feature() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_auto_indent_generated_autoload_exposes_only_mode_without_loading_dependencies() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_auto_auto_indent_batch() {
...
#[test]
fn registry_auto_auto_indent_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        auto_auto_indent_generated_autoload_exposes_only_mode_without_loading_dependencies(),
        auto_auto_indent_generated_autoload_performs_real_mode_activation_workflow(),
    ];

...
use super::{assert_asx_autoload_parity, assert_asx_parity};

#[test]
fn asx_exact_package_descriptor_origin_dependency_and_feature_contract_match() {
...
#[test]
fn asx_installed_payload_inventory_sizes_and_content_digests_match() {
    let elisp_form = r##"(let* ((descriptor
                  (cadr
                   (assq 'asx package-alist)))
                 (directory
...
#[test]
fn asx_complete_callable_command_arglist_and_source_surface_matches() {
...
#[test]
fn asx_complete_declared_variable_defaults_custom_and_source_surface_matches() {
...
#[test]
fn asx_custom_group_members_types_defaults_and_documentation_match() {

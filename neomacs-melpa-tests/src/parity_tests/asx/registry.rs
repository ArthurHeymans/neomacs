...
use super::{ParityBatchCase, assert_asx_autoload_batch, assert_asx_batch};
...
fn asx_generated_autoload_registers_only_the_primary_command_without_loading_source() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_asx_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        asx_generated_autoload_registers_only_the_primary_command_without_loading_source(),
    ];

...
use super::{ParityBatchCase, assert_auto_complete_clang_async_autoload_batch, assert_auto_complete_clang_async_batch};

fn auto_complete_clang_async_exact_descriptor_provenance_and_manual_dependencies_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_complete_clang_async_every_callable_arglist_interactivity_documentation_and_origin_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_complete_clang_async_custom_and_internal_defaults_types_locality_and_sources_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_complete_clang_async_source_reload_preserves_user_state_but_redefines_functions_and_sources() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_complete_clang_async_generated_autoload_contains_only_package_metadata_and_provide() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_auto_complete_clang_async_batch() {
...
#[test]
fn registry_auto_complete_clang_async_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        auto_complete_clang_async_generated_autoload_contains_only_package_metadata_and_provide(),
    ];

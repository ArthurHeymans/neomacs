...
#[test]
fn configures_a_real_anki_model_from_the_server_catalog() {
...
#[test]
fn selected_prose_becomes_a_complete_contextual_vocabulary_note_with_audio() {
    let elisp_form = r##"(let ((anki-vocabulary-deck-name "Language::English")

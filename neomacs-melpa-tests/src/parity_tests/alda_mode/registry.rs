...
use super::{assert_alda_mode_autoload_batch, assert_alda_mode_batch};

#[test]
fn registry_alda_mode_batch() {
...
#[test]
fn registry_alda_mode_autoload_batch() {
    assert_alda_mode_autoload_batch(&[
        (

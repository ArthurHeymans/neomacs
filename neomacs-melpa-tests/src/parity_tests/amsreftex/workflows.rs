...
fn turning_amsreftex_on_takes_over_reftexs_citation_machinery_and_off_leaves_one_override() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn an_amsrefs_document_is_recognised_and_each_named_database_is_located_or_dropped() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn citing_from_an_amsrefs_database_offers_the_matches_and_inserts_the_selected_key() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn the_selection_carries_every_amsrefs_field_translated_into_the_bibtex_names_reftex_reads() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn sorting_a_bibliography_orders_the_records_by_the_configured_fields_and_name_parts() -> ParityBatchCase {
    ParityBatchCase::new(

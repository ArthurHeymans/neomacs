...
#[test]
fn viewing_the_crossref_of_a_citation_pops_to_the_amsrefs_record_and_echoes_it() {
    let elisp_form = r##"
(progn
  (amsreftex-turn-on)
  (amsref-test-write
...
#[test]
fn a_bibtex_document_still_gets_vanilla_reftex_behaviour_while_amsreftex_is_on() {
    let elisp_form = r##"
(progn
  (amsreftex-turn-on)
  (amsref-test-write

...
use super::assert_apel_source_batch;

#[test]
fn workflows_calist_batch() {
    assert_apel_source_batch("calist.el",&[
        (
...
fn workflows_path_util_batch() {
    assert_apel_source_batch("path-util.el",&[
        (
...
fn workflows_product_batch() {
    assert_apel_source_batch("product.el",&[
        (
...
fn workflows_mcharset_batch() {
    assert_apel_source_batch("mcharset.el",&[
        (
...
fn workflows_richtext_batch() {
    assert_apel_source_batch("richtext.el",&[
        (
...
fn workflows_pym_batch() {
    assert_apel_source_batch("pym.el",&[
        (
...
fn workflows_pccl_batch() {
    assert_apel_source_batch("pccl.el",&[
        (

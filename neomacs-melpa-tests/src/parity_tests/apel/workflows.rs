...
#[test]
fn apel_routes_incoming_mail_and_persists_a_safe_delivery_index() {
    let elisp_form = r####"
(progn
  (require 'filename)
  (let* ((root
...
#[test]
fn apel_selects_loads_and_runs_the_latest_installed_legacy_extension() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apel_registers_a_legacy_client_suite_and_builds_its_user_agent() {
    let elisp_form = r####"
...
#[test]
fn apel_archives_multilingual_attachments_with_safe_names_and_wire_encodings() {
    let elisp_form = r####"
(progn
  (require 'filename)
  (require 'pces)
...
#[test]
fn apel_decodes_edits_and_reencodes_a_richtext_incident_message() {
    let elisp_form = r####"
(with-temp-buffer
  (let ((fill-column 72)
...
#[test]
fn apel_byte_compiles_a_portable_plugin_with_a_broken_host_api_fallback() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apel_transcodes_a_binary_device_packet_through_a_portable_ccl_codec() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name

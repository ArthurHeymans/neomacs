...
#[test]
fn aria2_opens_a_live_dashboard_with_active_paused_and_failed_transfers() {
...
#[test]
fn aria2_resumes_reprioritizes_and_removes_a_transfer_from_the_live_list() {
    let elisp_form = r##"(save-window-excursion
         (neomacs-aria2-test-cleanup)
         (let* ((aria2-executable
                 (executable-find "true"))
...
#[test]
fn aria2_selects_a_real_torrent_and_imports_its_exact_payload() {
    let elisp_form = r##"(save-window-excursion
         (neomacs-aria2-test-cleanup)
         (let* ((torrent
                 (expand-file-name
...
#[test]
fn aria2_reports_the_public_setup_failure_when_aria2c_is_not_installed() {
    let elisp_form = r##"(save-window-excursion
         (neomacs-aria2-test-cleanup)
         (let* ((aria2-executable
                 (expand-file-name

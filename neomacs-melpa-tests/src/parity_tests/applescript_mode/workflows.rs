...
#[test]
fn applescript_mode_authors_comments_navigates_and_saves_a_real_script() {
...
#[test]
fn applescript_mode_preserves_previous_results_and_exposes_a_failed_rerun() {
    let elisp_form = r##"(save-window-excursion
           (let ((source
                  (generate-new-buffer
                   "*invoice-source*"))
...
#[test]
fn applescript_mode_runs_a_one_off_script_and_displays_its_result() {
    let elisp_form = r##"(save-window-excursion

...
fn applescript_mode_executes_a_selected_japanese_script_through_the_real_command_path() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn applescript_mode_parses_realistic_osascript_structured_results_for_application_code() -> ParityBatchCase {
    ParityBatchCase::new(

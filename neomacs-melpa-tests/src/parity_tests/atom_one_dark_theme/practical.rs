...
#[test]
fn atom_one_dark_theme_three_variable_settings_preserve_exact_forms_and_order() {
...
#[test]
fn atom_one_dark_theme_real_emacs_lisp_font_lock_tokens_resolve_to_theme_palette() {
...
#[test]
fn atom_one_dark_theme_ansi_color_variable_drives_real_escape_sequence_rendering() {
...
#[test]
fn atom_one_dark_theme_real_org_buffer_and_org_faces_use_practical_theme_values() {
    let elisp_form = r##"(progn
         (require 'org)
         (unwind-protect
             (progn
...
#[test]
fn atom_one_dark_theme_mode_line_tab_bar_and_tab_line_rendering_attributes_match() {
    let elisp_form = r##"(progn
         (dolist
             (face
              '(mode-line

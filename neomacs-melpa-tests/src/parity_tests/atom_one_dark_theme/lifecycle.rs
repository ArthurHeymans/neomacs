...
fn atom_one_dark_theme_enable_applies_faces_and_values_then_disable_restores_deterministic_base() {
    let elisp_form = r##"(let ((base 'atom-one-dark-parity-base)
               (old-fci
                (and
...
#[test]
fn atom_one_dark_theme_enable_disable_enable_is_stable_and_idempotent() {
    let elisp_form = r##"(let (first repeated disabled second)
         (set-default
          'fci-rule-color
          "fixture-rule")
         (cl-labels
...
#[test]
fn atom_one_dark_theme_repeated_load_theme_does_not_grow_settings() {
...
#[test]
fn atom_one_dark_theme_optional_faces_defined_before_enable_receive_exact_values() {
...
#[test]
fn atom_one_dark_theme_enabled_specs_apply_to_optional_faces_defined_late() {
    let elisp_form = r##"(let ((faces
...
#[test]
fn atom_one_dark_theme_stacks_over_base_theme_and_reveals_it_after_disable() {
...
#[test]
fn atom_one_dark_theme_duplicate_helm_grep_finish_resolves_later_source_setting() {
...
#[test]
fn atom_one_dark_theme_nested_realgud_arrow_spec_enable_behavior_matches() {
    let elisp_form = r##"(progn
         (dolist
             (face
...
#[test]
fn atom_one_dark_theme_malformed_lifecycle_requests_preserve_registered_settings() {

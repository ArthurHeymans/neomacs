...
#[test]
fn atom_one_dark_theme_complete_palette_key_order_values_and_uniqueness_match() {
...
#[test]
fn atom_one_dark_theme_color_macro_binds_all_thirty_symbols_without_leaking_them() {
...
#[test]
fn atom_one_dark_theme_color_macro_uses_palette_present_when_form_is_expanded() {
    let elisp_form = r##"(let ((original
         ...
         (unwind-protect
           ...
           (setq atom-one-dark-colors-alist
                 original)))"##;
    let expect = expect![[r##"OK (("#010203" "#111213" "#282C34") "#010203")"##]];
...
fn atom_one_dark_theme_color_macro_duplicate_palette_keys_follow_let_binding_order() {
    let elisp_form = r##"(let ((atom-one-dark-colors-alist
...
#[test]
fn atom_one_dark_theme_color_macro_malformed_palette_entries_signal_exact_errors() {

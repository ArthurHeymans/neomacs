...
#[test]
fn real_acp_session_boots_submits_markdown_and_cleans_up_its_process() {
    let elisp_form = r##"
(let* ((root
...
#[test]
fn real_provider_turn_renders_thought_tool_diff_and_streamed_markdown() {
    let elisp_form = r##"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn real_prompt_and_usage_notifications_accumulate_into_visible_session_totals() {
    let elisp_form = r##"
(let* ((root
        (file-name-as-directory
         (expand-file-name

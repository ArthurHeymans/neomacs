...
use super::{ParityBatchCase, assert_asdf_vm_autoload_batch, assert_asdf_vm_batch};
...
fn asdf_vm_complete_public_callable_surface_has_exact_command_and_arglist_contract() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asdf_vm_features_groups_faces_errors_and_default_keymaps_are_registered_exactly() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asdf_vm_generated_autoloads_expose_exact_user_commands_without_loading_runtime() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_asdf_vm_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        asdf_vm_generated_autoloads_expose_exact_user_commands_without_loading_runtime(),
    ];

...
#[test]
fn asdf_vm_message_prefixes_format_and_forwards_arguments_exactly() {
...
#[test]
fn asdf_vm_parse_skip_list_line_handles_real_current_output_and_whitespace() {

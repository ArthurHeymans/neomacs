...
use super::{assert_auto_complete_sage_autoload_parity, assert_auto_complete_sage_parity};

#[test]
fn auto_complete_sage_exact_descriptor_provenance_and_dependency_graph_match() {
...
#[test]
fn auto_complete_sage_installed_payload_inventory_and_exact_hashes_match() {
...
#[test]
fn auto_complete_sage_complete_target_symbol_inventory_matches() {
...
#[test]
fn auto_complete_sage_custom_alias_cache_keyword_and_source_contracts_match() {
...
#[test]
fn auto_complete_sage_load_history_records_complete_contract_and_side_effects() {
...
fn auto_complete_sage_source_reload_reapplies_side_effects_without_overwriting_user_defvars() {
    let elisp_form = r##"(let ((ac-sage-show-quick-help
                                'user-quick-help)
                               (ac-source-sage-methods
                                'user-source)
                               (sage-shell:completion-function
...
fn auto_complete_sage_generated_autoload_contains_only_setup_and_feature_contract() {
    ...
    assert_auto_complete_sage_autoload_parity(elisp_form, expect);
}

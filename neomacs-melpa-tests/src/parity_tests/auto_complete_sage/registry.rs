...
use super::{ParityBatchCase, assert_auto_complete_sage_autoload_batch, assert_auto_complete_sage_batch};
...
fn auto_complete_sage_every_callable_arglist_interactivity_documentation_and_origin_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_complete_sage_source_reload_reapplies_side_effects_without_overwriting_user_defvars() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn auto_complete_sage_generated_autoload_contains_only_setup_and_feature_contract() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_auto_complete_sage_batch() {
...
#[test]
fn registry_auto_complete_sage_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        auto_complete_sage_generated_autoload_contains_only_setup_and_feature_contract(),
    ];

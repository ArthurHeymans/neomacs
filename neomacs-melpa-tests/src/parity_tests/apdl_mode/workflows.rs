...
#[test]
fn apdl_mode_authors_and_navigates_a_structural_analysis_model() {
    let elisp_form = r####"
(let* ((root
...
#[test]
fn apdl_mode_inspects_workbench_mesh_data_and_control_flow() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apdl_mode_completes_documents_and_inserts_a_previewed_code_template() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apdl_mode_runs_a_saved_model_and_opens_real_solver_artifacts() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apdl_mode_routes_contextual_commands_elements_and_topics_to_exact_help_pages() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apdl_mode_repairs_an_incomplete_model_and_preserves_existing_content() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apdl_mode_drives_an_interactive_solver_then_falls_back_to_copying_code() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apdl_mode_filters_real_license_manager_output_for_operators() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name

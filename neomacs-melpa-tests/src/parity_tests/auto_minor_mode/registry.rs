...
use super::{assert_auto_minor_mode_autoload_parity, assert_auto_minor_mode_parity};

#[test]
fn auto_minor_mode_exact_descriptor_and_archive_payload_match() {
...
#[test]
fn auto_minor_mode_complete_target_symbol_inventory_matches() {
...
#[test]
fn auto_minor_mode_callable_signatures_docs_interactivity_and_origins_match() {
...
#[test]
fn auto_minor_mode_variable_defaults_docs_locality_and_origins_match() {
    let elisp_form = r##"(mapcar
                           (lambda (symbol)
                             (list
                              symbol
...
#[test]
fn auto_minor_mode_feature_advice_and_load_history_contract_matches() {
...
fn auto_minor_mode_generated_autoload_contract_installs_variables_function_and_advice() {
    let elisp_form = r##"(list
                           ...
                           (let ((origin
                             ...
                             (and origin
                                  (file-name-base origin))))"##;
    let expect = expect![[r#"OK (nil t nil t nil t t t "auto-minor-mode")"#]];

    assert_auto_minor_mode_autoload_parity(elisp_form, expect);
}

#[test]
fn auto_minor_mode_enabled_predicate_distinguishes_registered_state_and_errors() {
    let elisp_form = r##"(let ((auto-minor-mode-test-alpha-mode nil)

...
#[test]
fn app_monochrome_dark_supports_a_real_edit_build_and_error_navigation_session() {
    let elisp_form = r####"
(let* ((root
...
#[test]
fn app_monochrome_light_supports_reviewing_folding_and_updating_a_real_org_plan() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name

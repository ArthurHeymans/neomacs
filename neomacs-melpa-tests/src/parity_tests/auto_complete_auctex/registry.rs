...
#[test]
fn auto_complete_auctex_complete_public_and_private_symbol_surface_matches() {
...
#[test]
fn auto_complete_auctex_every_callable_arglist_and_source_match() {
...
#[test]
fn auto_complete_auctex_argument_lookup_table_exact_keys_values_and_digest_match() {
...
#[test]
fn auto_complete_auctex_generated_sources_have_exact_completion_contracts() {
    let elisp_form = r##"(mapcar
          (lambda (source)
            (list
             source
...
#[test]
fn auto_complete_auctex_load_registers_feature_mode_and_auctex_hook_exactly_once() {
    let elisp_form = r##"(list

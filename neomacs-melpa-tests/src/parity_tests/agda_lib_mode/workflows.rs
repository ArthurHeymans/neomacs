...
#[test]
fn agda_lib_mode_opens_edits_and_saves_a_library_file_through_its_autoload() {
...
#[test]
fn agda_lib_mode_repairs_comments_and_refontifies_a_real_library_document() {
...
#[test]
fn agda_lib_mode_fills_and_round_trips_documentation_comments() {
    let elisp_form = r##"(with-temp-buffer
                           (insert
...
#[test]
fn agda_lib_mode_highlights_fields_flags_and_comments_in_a_complete_document() {
    let elisp_form = r##"(with-temp-buffer
                           (insert
                            "name: standard-library\n"
                            "include: src\n"

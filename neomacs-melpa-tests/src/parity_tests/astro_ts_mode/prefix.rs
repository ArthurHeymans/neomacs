...
#[test]
fn prefix_font_lock_features_preserves_language_override_and_rule_payload() {
    let elisp_form = r##"(let* ((capture '((identifier) @font-lock-variable-name-face))
              (settings
               (list
                (list 'tsx
...
#[test]
fn prefix_font_lock_features_handles_empty_and_partial_settings_exactly() {
...
#[test]
fn real_typescript_settings_gain_only_tsx_feature_prefixes() {
...
#[test]
fn real_css_settings_gain_only_css_feature_prefixes() {
    let elisp_form = r##"(let ((prefixed
                (astro-ts-mode--prefix-font-lock-features
...
#[test]
fn distinct_prefixes_keep_colliding_embedded_feature_names_disjoint() {
...
#[test]
fn repeated_prefixing_is_explicit_compositional_and_nonmutating() {
    let elisp_form = r##"(let* ((settings

...
use super::{assert_auto_complete_pcmp_autoload_batch, assert_auto_complete_pcmp_batch};

#[test]
fn registry_auto_complete_pcmp_batch() {
...
fn registry_auto_complete_pcmp_autoload_batch() {
    assert_auto_complete_pcmp_autoload_batch(&[
        (

...
use super::assert_s_parity;

#[test]
fn parsing_a_pasted_spreadsheet_export_into_records() {
    let elisp_form = r##"
...
#[test]
fn laying_out_a_report_column_counts_characters_not_display_width() {
    let elisp_form = r##"
...
#[test]
fn filling_a_message_template_from_the_parsed_record() {
    let elisp_form = r##"
...
#[test]
fn turning_typed_headings_into_slugs_and_titles() {
    let elisp_form = r##"
...
#[test]
fn extracting_fields_from_log_lines_with_capture_groups() {
    let elisp_form = r##"
...
#[test]
fn deciding_whether_a_submitted_field_counts_as_filled_in() {
    let elisp_form = r##"
...
#[test]
fn matching_prefixes_suffixes_and_shared_edges_of_a_sku() {
    let elisp_form = r##"

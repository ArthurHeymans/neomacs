...
#[test]
fn ac_sly_case_correcting_completions_downcase_lookup_and_mutate_matched_collection_strings() {
...
#[test]
fn ac_sly_case_correcting_completions_cover_empty_no_match_and_exact_names() {
...
#[test]
fn ac_sly_case_correcting_completions_surface_unicode_replacement_signal() {
    let elisp_form = r##"(ac-source-sly-case-correcting-completions
              "Å"
              '("åland"
                "älg"
                "other"))"##;
...
#[test]
fn ac_sly_case_correcting_completions_preserve_name_properties_on_replaced_prefix() {
...
#[test]
fn ac_sly_case_correcting_completions_propagate_invalid_collection_signals() {
    let elisp_form = r##"(ac-source-sly-case-correcting-completions
              "FO"
              17)"##;
...
#[test]
fn ac_sly_case_correcting_completions_reject_non_string_name_before_collection_lookup() {
    let elisp_form = r##"(ac-source-sly-case-correcting-completions
              'not-a-string
              '("alpha"
                "beta"))"##;
...
#[test]
fn ac_sly_documentation_strips_properties_and_forwards_exact_swank_request() {
...
#[test]
fn ac_sly_documentation_propagates_sly_eval_signals_with_exact_request() {
...
#[test]
fn ac_sly_documentation_rejects_non_strings_before_contacting_sly() {
...
#[test]
fn ac_sly_init_clears_the_current_dynamic_documentation_slot_and_returns_nil() {
    let elisp_form = r##"(let ((ac-sly-current-doc
                    (list
                     'old
                     "documentation")))
               (list

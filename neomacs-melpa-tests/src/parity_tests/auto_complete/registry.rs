...
use super::{assert_auto_complete_autoload_parity, assert_auto_complete_parity};

#[test]
fn auto_complete_exact_package_descriptor_dependency_and_provenance_match() {
...
#[test]
fn auto_complete_autoloads_preserve_commands_modes_and_customization_contract() {
    ...
    assert_auto_complete_autoload_parity(elisp_form, expect);
}

#[test]
fn auto_complete_builtin_source_definitions_and_generated_commands_match_exactly() {
...
#[test]
fn auto_complete_custom_defaults_types_standard_values_and_aliases_match() {
    let elisp_form = r##"(list
                          (mapcar
                           (lambda (symbol)
                             (list
...
#[test]
fn auto_complete_command_maps_expose_exact_editing_navigation_and_help_bindings() {
    let elisp_form = r##"(mapcar
                          (lambda (map)
                            (list
                             (car map)

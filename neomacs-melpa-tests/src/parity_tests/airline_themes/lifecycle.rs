...
#[test]
fn airline_themes_enable_switch_disable_workflow_applies_and_restores_real_faces() {
...
#[test]
fn airline_themes_reload_is_idempotent_for_settings_modeline_and_enabled_state() {
    let elisp_form = r##"(let (snapshots first-settings)
         (dotimes (iteration 3)
...
#[test]
fn airline_themes_cursor_customization_drives_all_evil_state_cursor_shapes() {
...
fn airline_themes_eshell_customization_preserves_or_installs_a_real_prompt_function() {
    let elisp_form = r##"(let ((sentinel (lambda () "sentinel prompt")))
...
#[test]
fn airline_themes_set_modeline_replaces_global_and_local_formats_consistently() {

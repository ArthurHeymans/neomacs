...
fn airline_themes_light_dark_transparent_palettes_resolve_distinct_practical_colors() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn airline_themes_helm_face_customization_controls_the_complete_palette_extension() -> ParityBatchCase {
    ParityBatchCase::new(

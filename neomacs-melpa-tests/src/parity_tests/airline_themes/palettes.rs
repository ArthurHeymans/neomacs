...
#[test]
fn airline_themes_doom_one_preserves_every_state_and_inactive_face_spec() {
...
#[test]
fn airline_themes_sparse_upstream_palettes_apply_normal_state_fallbacks_exactly() {
    let elisp_form = r##"(let ((themes
                '(airline-angr
                  airline-blood_red
                  airline-bubblegum
...
#[test]
fn airline_themes_base16_gui_palette_is_derived_from_real_current_face_colors() {
    let elisp_form = r##"(progn
...
#[test]
fn airline_themes_base16_shell_palette_obeys_terminal_and_graphical_workflows() {
    let elisp_form = r##"(let (terminal graphical)
...
fn airline_themes_helm_face_customization_controls_the_complete_palette_extension() {
    let elisp_form = r##"(let (enabled disabled)

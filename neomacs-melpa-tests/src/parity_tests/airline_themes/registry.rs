...
use super::{ParityBatchCase, assert_airline_themes_autoload_batch, assert_airline_themes_batch};
...
fn airline_themes_installed_theme_manifest_is_complete_and_content_addressed_in_chunks() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn airline_themes_runtime_has_no_hidden_asset_dependency_and_locates_every_entrypoint() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn airline_themes_autoloads_register_the_installed_directory_without_loading_runtime() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_airline_themes_batch() {
...
#[test]
fn registry_airline_themes_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        airline_themes_autoloads_register_the_installed_directory_without_loading_runtime(),
    ];

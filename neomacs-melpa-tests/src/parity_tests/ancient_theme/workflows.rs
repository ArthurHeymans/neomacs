...
#[test]
fn the_theme_registers_two_hundred_and_thirty_six_specs_over_its_palette() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient t)
  (list
...
#[test]
fn fontifying_a_real_emacs_lisp_buffer_shows_the_themes_own_colours() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient t)
  (with-temp-buffer
...
#[test]
fn layering_another_theme_on_top_only_changes_what_its_display_clause_allows() {
    let elisp_form = r##"
(progn
  (load-theme 'ancient t)

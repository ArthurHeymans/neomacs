...
use super::{ParityBatchCase, assert_ancient_theme_batch};
...
fn every_one_of_the_two_hundred_and_thirty_six_specs_applies_on_a_monochrome_display() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn loading_dired_org_flymake_and_pulse_brings_in_the_faces_the_theme_already_styles() -> ParityBatchCase {
    ParityBatchCase::new(

...
#[test]
fn opening_the_menu_refreshes_real_decks_models_and_fields_before_rendering() {
...
#[test]
fn authors_a_basic_card_with_math_and_sends_the_complete_ankiconnect_note() {
    let elisp_form = r##"(let ((anki-mode--decks '("Computer Science"))
      (anki-mode--card-types
       '(("Basic" "Front" "Back")
         ("Cloze" "Text" "Extra")))
      (anki-mode--previous-deck nil)
...
#[test]
fn creates_sequential_clozes_and_sends_the_edited_card_fields() {
    let elisp_form = r##"(let ((anki-mode--decks '("Biology"))

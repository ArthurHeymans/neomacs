...
use super::{ParityBatchCase, assert_acme_theme_batch};
...
fn completing_a_real_org_release_checklist_keeps_the_document_and_its_acme_styling_exact() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn reviewing_a_real_patch_and_listing_its_matches_uses_acmes_diff_and_match_colours() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn the_black_foreground_option_rewrites_every_derived_face_on_the_next_load_theme() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn stacking_acme_over_a_dark_user_theme_and_disabling_it_restores_the_previous_appearance() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn acme_registers_its_installed_directory_and_reloading_the_theme_changes_nothing() -> ParityBatchCase {
    ParityBatchCase::new(

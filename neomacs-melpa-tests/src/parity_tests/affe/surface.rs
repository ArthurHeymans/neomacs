...
use super::{assert_affe_backend_parity, assert_affe_parity};

#[test]
fn affe_exact_pin_dependency_features_and_custom_group_match() {
...
#[test]
fn affe_custom_variables_and_histories_preserve_defaults_metadata_and_values() {
...
#[test]
fn affe_function_surface_reports_arities_docs_and_interactive_commands() {
...
#[test]
fn affe_backend_surface_initializes_every_state_variable_hook_and_runtime_tuning() {
    let elisp_form = r##"(list

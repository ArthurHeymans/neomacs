...
use super::{assert_audio_notes_mode_autoload_batch, assert_audio_notes_mode_batch};

#[test]
fn registry_audio_notes_mode_batch() {
...
fn registry_audio_notes_mode_autoload_batch() {
    assert_audio_notes_mode_autoload_batch(&[
        (

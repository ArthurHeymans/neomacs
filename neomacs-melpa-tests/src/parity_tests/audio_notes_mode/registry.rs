...
use super::{assert_audio_notes_mode_autoload_parity, assert_audio_notes_mode_parity};
...
#[test]
fn audio_notes_mode_installed_payload_inventory_and_exact_archive_hashes_match() {
...
#[test]
fn audio_notes_mode_complete_callable_command_and_alias_surface_matches() {
...
#[test]
fn audio_notes_mode_complete_customization_defaults_and_metadata_match() {
    let elisp_form = r##"(let ((symbols
...
#[test]
fn audio_notes_mode_constants_runtime_state_and_documentation_contract_match() {
...
#[test]
fn audio_notes_mode_global_minor_mode_metadata_and_initial_keymap_match() {
    let elisp_form = r##"(list
                          audio-notes-mode
                          (get
                           'audio-notes-mode

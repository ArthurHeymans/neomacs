...
#[test]
fn ac_math_completes_a_backslash_name_into_the_unicode_character() {
    let elisp_form = r##"(ac-math-test-in-buffer
...
#[test]
fn ac_math_completes_latex_control_words_from_the_command_source() {
    let elisp_form = r##"(ac-math-test-in-buffer
...
#[test]
fn ac_math_switches_sources_between_math_and_prose_by_the_face_at_point() {
    let elisp_form = r##"(ac-math-test-in-buffer
 ...
 (let ((in-prose (progn (goto-char 13)
   ...
   (list in-prose in-math unicode-allowed ac-math-unicode-in-math-p)))"##;
    let expect = expect!["OK ((nil nil t) (t t nil) t nil)"];

    assert_ac_math_parity(elisp_form, expect);
}

#[test]
fn ac_math_keeps_the_latex_command_when_completing_inside_a_math_environment() {
    let elisp_form = r##"(ac-math-test-in-buffer
...
#[test]
fn ac_math_honours_a_customized_prefix_regexp() {
    let elisp_form = r##"(ac-math-test-in-buffer
 (setq ac-sources '(ac-source-math-unicode))
...
#[test]
fn ac_math_candidate_tables_pair_every_name_with_its_character() {
...
#[test]
fn ac_math_offers_nothing_for_plain_prose_and_leaves_the_buffer_alone() {
    let elisp_form = r##"(ac-math-test-in-buffer

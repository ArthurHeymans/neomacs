...
#[test]
fn ascii_table_exact_pin_descriptor_dependency_origin_and_feature_contract_match() {
...
#[test]
fn ascii_table_installed_payload_inventory_sizes_and_content_digests_match() {
    let elisp_form = r##"(let* ((descriptor
                  (cadr
...
#[test]
fn ascii_table_complete_callable_command_arglist_doc_and_source_surface_matches() {
...
#[test]
fn ascii_table_variables_defaults_mutability_scope_docs_and_source_match() {
    let elisp_form = r##"(mapcar
         (lambda (symbol)
           (list
            symbol
...
#[test]
fn ascii_table_mode_map_parent_bindings_commands_and_reverse_lookup_match() {
...
#[test]
fn ascii_table_derived_mode_registry_and_initial_buffer_contract_match() {

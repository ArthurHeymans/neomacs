...
fn ascii_table_generated_autoload_registers_public_command_without_loading_feature() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_ascii_table_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        ascii_table_generated_autoload_registers_public_command_without_loading_feature(),
    ];

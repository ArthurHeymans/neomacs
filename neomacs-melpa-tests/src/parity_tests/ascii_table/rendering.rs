...
#[test]
fn ascii_table_overlay_runs_cover_every_code_and_name_cell_with_exact_faces() {
    let elisp_form = r##"(let* ((render
                  (ascii-table-test-render
                   200
                   16
...
#[test]
fn ascii_table_revert_replaces_text_and_collapses_old_overlays_at_buffer_start() {
             ...
             (let ((first
               ...
               (let ((second
                 ...
                 (list
                  ...
                  major-mode
                  buffer-read-only))))))"##;
    let expect = expect![[r#"OK (1 1 1 "ASCII Table (hex)" ascii-table-mode t)"#]];

    assert_ascii_table_parity(elisp_form, expect);
}

#[test]
fn ascii_table_revert_rejects_wrong_major_mode_and_file_visiting_buffers() {
...
#[test]
fn ascii_table_width_limit_uses_current_window_width_when_ascii_buffer_is_absent() {
...
fn ascii_table_width_limit_selects_narrowest_live_ascii_window_and_ignores_others() {
    let elisp_form = r##"(let ((ascii-buffer
...
#[test]
fn ascii_table_layout_selection_obeys_strict_width_boundary_for_every_candidate() {
...
#[test]
fn ascii_table_narrow_widths_switch_from_header_only_to_single_column_table() {
...
#[test]
fn ascii_table_mode_hook_observes_initialized_special_mode_before_rendering() {

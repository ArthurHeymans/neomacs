...
fn ascii_table_wide_hex_render_has_exact_practical_table_text_structure_and_digest() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_binary_caret_render_preserves_full_content_at_realistic_terminal_width() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_decimal_escape_render_uses_escapes_only_where_defined_and_real_characters_elsewhere() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_revert_accepts_revert_protocol_arguments_and_resets_point_to_start() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_width_limit_selects_narrowest_live_ascii_window_and_ignores_others() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_revert_preserves_read_only_mode_and_uses_inhibit_read_only_internally() -> ParityBatchCase {
    ParityBatchCase::new(

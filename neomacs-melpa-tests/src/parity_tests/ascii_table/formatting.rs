...
#[test]
fn ascii_table_character_class_covers_full_ascii_domain_and_outside_boundaries() {
    let elisp_form = r##"(let ((inputs
...
#[test]
fn ascii_table_class_face_maps_every_class_and_unknown_value_exactly() {
    let elisp_form = r##"(mapcar
         (lambda (class)
           (list
            class
...
#[test]
fn ascii_table_all_supported_row_counts_preserve_layout_size_order_and_content() {
    let elisp_form = r##"(mapcar
...
#[test]
fn ascii_table_table_invalid_radix_control_and_row_counts_signal_exact_errors() {
    let elisp_form = r##"(let (results)
         (dolist (spec
                  '((3 nil nil 8)
                    (nil nil nil 8)
...
#[test]
fn ascii_table_column_widths_compute_real_table_and_irregular_fixture_maxima() {

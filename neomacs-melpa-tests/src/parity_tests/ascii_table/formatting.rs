...
fn ascii_table_binary_formats_every_ascii_codepoint_at_fixed_width_without_collisions() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_binary_rejects_out_of_range_and_non_integer_inputs_with_exact_signals() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_control_caret_names_cover_all_controls_and_reject_printable_characters() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_control_escape_covers_c_escape_range_escape_and_non_escape_controls() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_default_hex_table_places_every_codepoint_once_with_exact_contents_and_faces() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_table_configuration_matrix_changes_radix_control_and_escape_precedence() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_column_widths_handles_empty_tables_missing_cells_and_invalid_columns() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_table_character_faces_match_classification_for_all_ascii_codepoints() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn ascii_table_printable_names_round_trip_to_original_characters_across_all_layouts() -> ParityBatchCase {
    ParityBatchCase::new(

...
use super::{assert_auto_indent_mode_autoload_parity, assert_auto_indent_mode_parity};

#[test]
fn auto_indent_mode_registers_feature_modes_and_public_commands() {
...
#[test]
fn auto_indent_mode_core_custom_defaults_are_exact() {
...
#[test]
fn auto_indent_mode_editing_policy_defaults_are_exact() {
    let elisp_form = r##"(mapcar
         (lambda (symbol)
...
#[test]
fn auto_indent_mode_initial_keymap_and_saved_key_specs_are_consistent() {
    let elisp_form = r##"(list
    ...
    let expect = expect![[r#"OK (t "" "" nil nil 1 1)"#]];
    assert_auto_indent_mode_parity(elisp_form, expect);
}
...
#[test]
fn auto_indent_mode_global_hooks_are_installed_by_source_load() {
    let elisp_form = r##"(let ((registrations
...
#[test]
fn auto_indent_mode_load_history_records_selected_full_surface_definitions() {
...
#[test]
fn auto_indent_mode_setup_map_rebuilds_exact_configured_bindings() {
    let elisp_form = r##"(let ((auto-indent-key-for-end-of-line-then-newline
                                "M-RET")
...
#[test]
fn auto_indent_mode_generated_autoloads_expose_commands_without_loading_runtime() {
    let elisp_form = r##"(list
         (featurep 'auto-indent-mode)
         (mapcar
          (lambda (symbol)
    ...
    assert_auto_indent_mode_autoload_parity(elisp_form, expect);
}

...
#[test]
fn opening_and_converting_a_real_ansi_art_file_visits_the_exported_png() {
...
#[test]
fn converting_an_unsaved_art_buffer_exports_png_and_removes_the_staged_text_file() {
    let elisp_form = r##"(let* ((root
         (file-name-as-directory
          (expand-file-name

...
#[test]
fn cli_wrappers_construct_complete_launch_specs_at_external_boundary() {
    let elisp_form = r##"
(progn
  (mapc
   #'require
...
#[test]
fn mcp_capable_wrappers_forward_environment_multiline_and_prepare_hooks() {
    let elisp_form = r##"
(progn
  (mapc
   #'require
...
#[test]
fn resume_commands_append_backend_specific_flags_and_open_pickers_when_required() {
    let elisp_form = r##"
(progn
  (mapc
   #'require
...
#[test]
fn backend_send_switch_and_escape_commands_route_labels_prefixes_and_payloads() {
    let elisp_form = r##"
(progn
  (mapc
   #'require
...
#[test]
fn kiro_command_builder_orders_chat_trust_agent_and_user_switches() {
    let elisp_form = r##"
(progn

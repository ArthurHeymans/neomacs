...
use super::{assert_auth_source_gopass_autoload_parity, assert_auth_source_gopass_parity};

#[test]
fn auth_source_gopass_descriptor_and_sources_pin_exact_melpa_payload() {
...
#[test]
fn auth_source_gopass_feature_and_definition_origins_are_exact() {
...
#[test]
fn auth_source_gopass_public_functions_have_exact_callable_contracts() {
...
#[test]
fn auth_source_gopass_custom_options_have_exact_schema_and_defaults() {
    let elisp_form = r##"(mapcar
         (lambda (symbol)
           (list
            symbol
...
#[test]
fn auth_source_gopass_load_history_records_public_definitions_and_provide() {
...
#[test]
fn auth_source_gopass_generated_autoload_registers_enable_command() {
    let elisp_form = r##"(let* ((file
                 (locate-library
    ...
    assert_auth_source_gopass_autoload_parity(elisp_form, expect);
}

#[test]
fn auth_source_gopass_reload_preserves_custom_values_and_single_parser_hook() {
    ...
    let expect = expect![[r#"OK ("custom" "::" "company-gopass" identity 1)"#]];
    assert_auth_source_gopass_parity(elisp_form, expect);
}

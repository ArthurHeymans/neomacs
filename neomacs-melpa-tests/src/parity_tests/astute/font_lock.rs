...
fn astute_empty_or_unknown_transform_configuration_leaves_practical_text_unmodified() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn astute_custom_prefix_exceptions_apply_case_insensitively_during_real_fontification() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn astute_refontification_after_insertions_updates_new_typography_and_keeps_existing_text() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn astute_fontification_preserves_help_echo_and_custom_properties_while_face_stays_font_lock_managed() -> ParityBatchCase {
    ParityBatchCase::new(

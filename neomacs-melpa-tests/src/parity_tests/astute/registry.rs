...
use super::{ParityBatchCase, assert_astute_autoload_batch, assert_astute_batch};
...
fn astute_complete_declared_variable_defaults_scope_custom_and_source_surface_matches() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_astute_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        astute_generated_autoload_registers_mode_without_eagerly_loading_package(),
    ];

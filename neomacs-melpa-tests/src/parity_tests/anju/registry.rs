...
use super::{assert_anju_autoload_parity, assert_anju_parity};

#[test]
fn anju_exact_pin_dependency_graph_and_features_match() {
...
#[test]
fn anju_public_and_internal_command_surface_is_callable() {
...
#[test]
fn anju_installed_payload_inventory_is_exact_and_unvendored() {
    let elisp_form = r##"(let* ((descriptor
                  (cadr (assq 'anju package-alist)))
...
#[test]
fn anju_source_and_customization_inventory_matches() {
...
#[test]
fn anju_autoload_registers_only_the_initialization_command() {
    let elisp_form = r##"(list
         (featurep 'anju)
    ...
    assert_anju_autoload_parity(elisp_form, expect);
}

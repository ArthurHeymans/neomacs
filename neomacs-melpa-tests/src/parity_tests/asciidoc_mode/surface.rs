...
use super::{ParityBatchCase, assert_asciidoc_mode_autoload_batch, assert_asciidoc_mode_batch};
...
fn complete_public_callable_surface_preserves_arguments_commands_and_source_ownership() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn surface_asciidoc_mode_batch() {
...
#[test]
fn surface_asciidoc_mode_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        generated_autoloads_register_only_the_two_commands_and_both_file_extensions(),
    ];

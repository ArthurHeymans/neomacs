...
fn typing_a_paragraph_key_by_key_wraps_it_while_the_user_types_and_undo_takes_it_back() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn inserting_words_inside_a_filled_paragraph_reflows_it_and_leaves_point_after_the_typed_space() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn only_the_configured_fill_keys_refill_and_a_second_whitespace_character_suppresses_it() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn a_user_supplied_suppression_predicate_protects_marker_lines_while_prose_still_wraps() -> ParityBatchCase {
    ParityBatchCase::new(

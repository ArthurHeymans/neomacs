...
#[test]
fn checkdoc_complaints_in_a_real_elisp_file_are_repaired_in_the_buffer() {
    let elisp_form = r##"
...
#[test]
fn the_footer_repair_copies_checkdocs_curly_quote_and_leaves_the_file_unreadable() {
    let elisp_form = r##"
...
#[test]
fn a_lone_repair_is_applied_without_asking_and_several_are_offered_by_name() {
    let elisp_form = r##"
(list
...
#[test]
fn the_command_reports_exactly_which_thing_is_missing() {
    let elisp_form = r##"
(list
...
#[test]
fn the_latex_fixer_rewrites_the_buffer_while_it_is_only_supposed_to_list_options() {
    let elisp_form = r##"
(list
...
#[test]
fn every_elisp_rule_turns_its_message_into_a_named_repair() {
    let elisp_form = r##"
(mapcar
 (lambda (case)
   (cons (car case)

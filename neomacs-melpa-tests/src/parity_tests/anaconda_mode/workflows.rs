...
#[test]
fn starting_the_server_builds_the_documented_command_line_and_binds_its_port() {
    let elisp_form = r##"
...
#[test]
fn moving_the_server_to_another_address_and_virtualenv_restarts_it() {
    let elisp_form = r##"
...
#[test]
fn completing_an_attribute_posts_the_whole_buffer_and_inserts_the_candidate() {
    let elisp_form = r##"
...
#[test]
fn navigating_to_a_definition_an_assignment_and_every_reference() {
    let elisp_form = r##"
...
#[test]
fn the_synchronous_xref_backend_answers_or_reports_that_it_timed_out() {
    let elisp_form = r##"
...
#[test]
fn reading_documentation_renders_the_anaconda_buffer_or_says_there_is_none() {
    let elisp_form = r##"
...
#[test]
fn eldoc_highlights_the_argument_under_point_and_trims_to_one_line_on_request() {
    let elisp_form = r##"
...
#[test]
fn a_malformed_body_a_server_error_and_a_closed_listener_each_reach_the_user() {
    let elisp_form = r##"

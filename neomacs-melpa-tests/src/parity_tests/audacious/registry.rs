...
use super::{assert_audacious_autoload_parity, assert_audacious_parity};

#[test]
fn audacious_descriptor_and_archive_sources_pin_exact_melpa_payload() {
...
#[test]
fn audacious_complete_callable_command_interactive_and_arglist_surface_matches() {
...
#[test]
fn audacious_all_function_documentation_contracts_are_exact_and_readable() {
    let elisp_form = r##"(mapcar
         (lambda (symbol)
           (list
            symbol
...
#[test]
fn audacious_declared_variables_custom_schema_defaults_and_sources_are_exact() {
...
#[test]
fn audacious_exact_runtime_dependency_pin_is_activated_without_loading_real_helm() {
    let elisp_form = r##"(let ((audacious-descriptor
...
#[test]
fn audacious_generated_autoload_registers_only_prefix_and_feature() {
    ...
    assert_audacious_autoload_parity(elisp_form, expect);
}

#[test]
fn audacious_source_reload_preserves_runtime_state_and_customized_command() {

...
#[test]
fn aidermacs_model_identity_and_price_matching_cover_provider_version_fallbacks() {
    let elisp_form = r##"(let ((prices
                           '(("openai/gpt-4o" .
...
#[test]
fn aidermacs_litellm_json_reader_filters_metadata_and_caches_real_prices() {
...
#[test]
fn aidermacs_model_ranking_and_annotations_handle_ties_missing_prices_and_limits() {
    let elisp_form = r##"(let* ((models
                           '(((id . "expensive")
...
fn aidermacs_available_model_workflow_parses_cli_output_prices_and_invokes_callback() {
    let elisp_form = r##"(let ((aidermacs--cached-models nil)
...
#[test]
fn aidermacs_model_selection_updates_main_weak_and_architect_editor_sessions() {
    let elisp_form = r##"(let ((aidermacs--cached-models
                           '(((id . "cheap/model")
                              (price-str . "($0.10/$0.20/M)"))
                             ((id . "smart/model")

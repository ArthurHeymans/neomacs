...
fn asm_blox_upstream_wat_gameboard_scenarios_execute_stack_send_and_receive_workflows() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_real_arithmetic_pipeline_obeys_operand_order_integer_math_and_wraparound() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_comparison_and_boolean_instructions_cover_negative_zero_and_positive_truth_tables() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_stack_program_exercises_get_set_inc_dec_dup_drop_and_clear_with_real_state_changes() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_stack_limits_and_bad_indices_surface_runtime_errors_without_hiding_partial_state() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_send_backpressure_keeps_stack_and_program_counter_blocked_until_port_clears() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_compiled_nested_loop_runs_a_countdown_and_branches_to_the_correct_targets() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_direction_coordinates_mirroring_bounds_and_outside_cells_cover_every_board_edge() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_board_runs_code_cells_before_custom_cells_and_captures_thrown_runtime_errors() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn asm_blox_current_instruction_empty_program_wraparound_and_label_skipping_contracts_match() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn runtime_public_surface_batch() {

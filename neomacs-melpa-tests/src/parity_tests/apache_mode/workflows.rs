...
#[test]
fn apache_mode_formats_comments_and_deploys_a_tls_virtual_host() {
    let elisp_form = r####"
(let* ((root
...
#[test]
fn apache_mode_maintains_an_authenticated_https_htaccess_policy() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name
...
#[test]
fn apache_mode_clones_and_customizes_a_reverse_proxy_configuration() {
    let elisp_form = r####"
(let* ((root
        (file-name-as-directory
         (expand-file-name

...
use super::{assert_agda_editor_tactics_autoload_batch, assert_agda_editor_tactics_batch};

#[test]
fn registry_agda_editor_tactics_batch() {
...
fn registry_agda_editor_tactics_autoload_batch() {
    assert_agda_editor_tactics_autoload_batch(&[
        (

...
use super::{assert_agda_editor_tactics_autoload_parity, assert_agda_editor_tactics_parity};

#[test]
fn agda_editor_tactics_registry_metadata_and_defaults_match() {
...
#[test]
fn agda_editor_tactics_complete_callable_surface_matches() {
...
#[test]
fn agda_editor_tactics_version_command_emits_the_installed_version() {
    let elisp_form = r##"(let ((captured nil))
         (cl-letf (((symbol-function 'message)
           ...
           (list
            ...
            captured
            agda-editor-tactics-version)))"##;
    let expect = expect![[r#"OK ("20211024.2357" ("20211024.2357") "20211024.2357")"#]];
    assert_agda_editor_tactics_parity(elisp_form, expect);
}

#[test]
fn agda_editor_tactics_autoload_registry_exposes_the_minor_mode() {
    ...
    assert_agda_editor_tactics_autoload_parity(elisp_form, expect);
}

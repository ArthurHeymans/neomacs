...
#[test]
fn agda_editor_tactics_documented_record_parses_and_renders_end_to_end() {
...
#[test]
fn agda_editor_tactics_realistic_monoid_record_preserves_computed_locals() {
    let elisp_form = r##"(let* ((source
...
#[test]
fn agda_editor_tactics_dependent_family_workflow_keeps_binder_dependencies() {
    let elisp_form = r##"(let* ((source
...
#[test]
fn agda_editor_tactics_custom_naming_applies_to_declaration_and_definition() {
    let elisp_form = r##"(let* ((agda-editor-tactics-format-Σ-naming "%s-SigmaView")
        (source
...
#[test]
fn agda_editor_tactics_transforms_a_batch_of_distinct_record_shapes() {
...
#[test]
fn agda_editor_tactics_editor_buffer_workflow_replaces_a_selected_record() {

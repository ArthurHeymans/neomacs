...
use super::{assert_auto_complete_distel_autoload_batch, assert_auto_complete_distel_batch};

#[test]
fn registry_auto_complete_distel_batch() {
...
fn registry_auto_complete_distel_autoload_batch() {
    assert_auto_complete_distel_autoload_batch(&[
        (

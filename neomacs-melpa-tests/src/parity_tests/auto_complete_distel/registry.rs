...
use super::{assert_auto_complete_distel_autoload_parity, assert_auto_complete_distel_parity};

#[test]
fn auto_complete_distel_exact_descriptor_and_companion_dependency_match() {
...
#[test]
fn auto_complete_distel_exact_installed_payload_bytes_match_melpa_archives() {
    let elisp_form = r##"(mapcar
          (lambda (fixture)
            (let* ((package
                    (car fixture))
...
#[test]
fn auto_complete_distel_complete_target_symbol_surface_matches() {
...
#[test]
fn auto_complete_distel_callable_and_variable_contracts_match() {
...
#[test]
fn auto_complete_distel_load_history_records_the_complete_target_contract() {
...
#[test]
fn auto_complete_distel_companion_library_surface_and_defaults_match() {
...
#[test]
fn auto_complete_distel_generated_autoload_contains_only_feature_contract() {
    let elisp_form = r##"(let* ((file
                                 (locate-library
          ...
          (list
           ...
           (seq-filter
            ...
            history)))"##;
    let expect = expect!["OK (t nil nil nil ((provide . auto-complete-distel-autoloads)))"];

    assert_auto_complete_distel_autoload_parity(elisp_form, expect);
}

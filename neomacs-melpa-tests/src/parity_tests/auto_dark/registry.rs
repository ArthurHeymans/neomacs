...
#[test]
fn auto_dark_exact_descriptor_activation_and_payload_bytes_match() {
...
#[test]
fn auto_dark_complete_prefixed_symbol_inventory_matches() {
...
#[test]
fn auto_dark_every_callable_arglist_command_doc_and_source_match() {
...
#[test]
fn auto_dark_custom_group_and_every_option_contract_match() {
...
#[test]
fn auto_dark_mode_hook_timer_listener_and_state_variable_metadata_match() {
    let elisp_form = r##"(mapcar
          (lambda (symbol)
            (list
             symbol
...
#[test]
fn auto_dark_source_load_history_records_complete_definition_order() {
...
#[test]
fn auto_dark_generated_autoload_exposes_only_global_mode_before_activation() {
    let elisp_form = r##"(let* ((history
                                 (seq-find
                                  (lambda (entry)
                                    (and
...
#[test]
fn auto_dark_source_reload_preserves_custom_values_and_mode_state() {
    let elisp_form = r##"(let ((source
          ...
          (cl-letf
            ...
            (list
             ...
             auto-dark-mode
             (featurep 'auto-dark))))"##;
    let expect = expect!["OK (17 t t manual nil dark t t)"];

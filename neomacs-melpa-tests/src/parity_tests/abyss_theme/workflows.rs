...
use super::{ParityBatchCase, assert_abyss_theme_batch};
...
fn loading_abyss_repaints_a_real_elisp_editing_session_with_its_documented_palette() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn reading_a_real_build_log_paints_compilation_diagnostics_with_the_abyss_status_palette() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn switching_from_a_light_theme_to_abyss_and_back_restores_the_previous_appearance() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn the_abyss_theme_command_enables_the_installed_theme_and_reloading_it_changes_nothing() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn packages_loaded_after_abyss_adopt_its_faces_and_recover_their_own_when_it_is_disabled() -> ParityBatchCase {
    ParityBatchCase::new(

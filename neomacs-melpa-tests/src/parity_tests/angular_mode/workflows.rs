...
#[test]
fn opening_a_controller_highlights_the_angular_api_and_keeps_javascript_editing() {
    let elisp_form = r##"
...
#[test]
fn directive_properties_and_test_blocks_carry_the_type_face() {
    let elisp_form = r##"
...
#[test]
fn the_keyword_lists_match_substrings_so_unrelated_identifiers_are_highlighted() {
    let elisp_form = r##"
...
#[test]
fn editing_behaviour_comes_from_the_parent_modes() {
    let elisp_form = r##"

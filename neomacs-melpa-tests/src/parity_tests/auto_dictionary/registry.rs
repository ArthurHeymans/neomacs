...
use super::{ParityBatchCase, assert_auto_dictionary_autoload_batch, assert_auto_dictionary_batch};
...
fn auto_dictionary_source_load_history_records_data_functions_aliases_and_provider() -> ParityBatchCase {
    ParityBatchCase::new(

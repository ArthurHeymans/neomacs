...
use super::{ParityBatchCase, assert_atomic_chrome_autoload_batch, assert_atomic_chrome_batch};
...
fn atomic_chrome_all_functions_have_exact_call_interactive_documentation_and_source_contracts() -> ParityBatchCase {
    ParityBatchCase::new(
...
fn atomic_chrome_generated_autoload_preserves_feature_history_prefix_and_command_contracts() -> ParityBatchCase {
    ParityBatchCase::new(
...
#[test]
fn registry_atomic_chrome_batch() {
...
#[test]
fn registry_atomic_chrome_autoload_batch() {
    let cases: Vec<ParityBatchCase> = vec![
        atomic_chrome_generated_autoload_preserves_feature_history_prefix_and_command_contracts(),
    ];

...
## 109. `window-scroll-functions` existed but nothing on the scroll path ever ran it -- FIXED
...
## 110. Helm's exit-time source resolution diverges in a multi-source session -- OPEN

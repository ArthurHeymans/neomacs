...
## 90. `insert` discarded the arguments it had already converted -- FIXED
...
## 91. `call-process-region` resolved the program before applying DELETE -- FIXED
...
## 92. `minibuffer-default` was never bound during a minibuffer read -- FIXED
